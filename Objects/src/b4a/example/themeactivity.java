...
RDebugUtils.currentLine=35192832;
 //BA.debugLineNum = 35192832;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=35192834;
 //BA.debugLineNum = 35192834;BA.debugLine="Select Starter.themeNumber";
switch (BA.switchObjectToInt(mostCurrent._starter._themenumber /*int*/ ,(int) (0),(int) (1),(int) (2))) {
case 0: {
RDebugUtils.currentLine=35192836;
 //BA.debugLineNum = 35192836;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=35192837;
 //BA.debugLineNum = 35192837;BA.debugLine="Activity.LoadLayout(\"themeLayout\")";
mostCurrent._activity.LoadLayout("themeLayout",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=35192839;
 //BA.debugLineNum = 35192839;BA.debugLine="Activity.LoadLayout(\"themeLayoutDark\")";
mostCurrent._activity.LoadLayout("themeLayoutDark",mostCurrent.activityBA);
 };
 break; }
case 1: {
RDebugUtils.currentLine=35192842;
 //BA.debugLineNum = 35192842;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=35192843;
 //BA.debugLineNum = 35192843;BA.debugLine="Activity.LoadLayout(\"themeLayout2\")";
mostCurrent._activity.LoadLayout("themeLayout2",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=35192845;
 //BA.debugLineNum = 35192845;BA.debugLine="Activity.LoadLayout(\"themeLayoutDark2\")";
mostCurrent._activity.LoadLayout("themeLayoutDark2",mostCurrent.activityBA);
 };
 break; }
case 2: {
RDebugUtils.currentLine=35192848;
 //BA.debugLineNum = 35192848;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=35192849;
 //BA.debugLineNum = 35192849;BA.debugLine="Activity.LoadLayout(\"themeLayout3\")";
mostCurrent._activity.LoadLayout("themeLayout3",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=35192851;
 //BA.debugLineNum = 35192851;BA.debugLine="Activity.LoadLayout(\"themeLayoutDark3\")";
...
RDebugUtils.currentLine=35192855;
 //BA.debugLineNum = 35192855;BA.debugLine="showThemePage(0)";
_showthemepage((int) (0));
RDebugUtils.currentLine=35192856;
 //BA.debugLineNum = 35192856;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=35389440;
 //BA.debugLineNum = 35389440;BA.debugLine="Sub showThemePage(page As Int)";
RDebugUtils.currentLine=35389442;
 //BA.debugLineNum = 35389442;BA.debugLine="themePage = page";
_themepage = _page;
RDebugUtils.currentLine=35389444;
 //BA.debugLineNum = 35389444;BA.debugLine="Select page";
switch (_page) {
case 0: {
RDebugUtils.currentLine=35389446;
 //BA.debugLineNum = 35389446;BA.debugLine="titleLbl.Text = \"Default Theme\"";
mostCurrent._titlelbl.setText(BA.ObjectToCharSequence("Default Theme"));
RDebugUtils.currentLine=35389447;
 //BA.debugLineNum = 35389447;BA.debugLine="theme1.Bitmap = xui.LoadBitmapResize(File.DirAss";
...
RDebugUtils.currentLine=35389448;
 //BA.debugLineNum = 35389448;BA.debugLine="theme2.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=35389450;
 //BA.debugLineNum = 35389450;BA.debugLine="titleLbl.Text = \"Y2K Aero\"";
mostCurrent._titlelbl.setText(BA.ObjectToCharSequence("Y2K Aero"));
RDebugUtils.currentLine=35389451;
 //BA.debugLineNum = 35389451;BA.debugLine="theme1.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=35389452;
 //BA.debugLineNum = 35389452;BA.debugLine="theme2.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=35389454;
 //BA.debugLineNum = 35389454;BA.debugLine="titleLbl.Text = \"Pixelated Rustic\"";
mostCurrent._titlelbl.setText(BA.ObjectToCharSequence("Pixelated Rustic"));
RDebugUtils.currentLine=35389455;
 //BA.debugLineNum = 35389455;BA.debugLine="theme1.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=35389456;
 //BA.debugLineNum = 35389456;BA.debugLine="theme2.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=35389458;
 //BA.debugLineNum = 35389458;BA.debugLine="backBtn.Enabled = (page > 0)";
mostCurrent._backbtn.setEnabled((_page>0));
RDebugUtils.currentLine=35389459;
 //BA.debugLineNum = 35389459;BA.debugLine="nextBtn.Enabled = (page < 2)";
...
RDebugUtils.currentLine=35323904;
 //BA.debugLineNum = 35323904;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=35258368;
 //BA.debugLineNum = 35258368;BA.debugLine="Sub Activity_Resume";
...
RDebugUtils.currentLine=35651584;
 //BA.debugLineNum = 35651584;BA.debugLine="Sub applyBtn_Click";
RDebugUtils.currentLine=35651585;
 //BA.debugLineNum = 35651585;BA.debugLine="If themePage = 0 Then";
if (_themepage==0) { 
RDebugUtils.currentLine=35651586;
 //BA.debugLineNum = 35651586;BA.debugLine="Starter.themeNumber = 0";
mostCurrent._starter._themenumber /*int*/  = (int) (0);
RDebugUtils.currentLine=35651587;
 //BA.debugLineNum = 35651587;BA.debugLine="Starter.themeChanged = True";
mostCurrent._starter._themechanged /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 }else 
{RDebugUtils.currentLine=35651588;
 //BA.debugLineNum = 35651588;BA.debugLine="Else If themePage = 1 Then";
if (_themepage==1) { 
RDebugUtils.currentLine=35651589;
 //BA.debugLineNum = 35651589;BA.debugLine="Starter.themeNumber = 1";
mostCurrent._starter._themenumber /*int*/  = (int) (1);
RDebugUtils.currentLine=35651590;
 //BA.debugLineNum = 35651590;BA.debugLine="Starter.themeChanged = True";
mostCurrent._starter._themechanged /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 }else 
{RDebugUtils.currentLine=35651591;
 //BA.debugLineNum = 35651591;BA.debugLine="Else If themePage = 2 Then";
if (_themepage==2) { 
RDebugUtils.currentLine=35651592;
 //BA.debugLineNum = 35651592;BA.debugLine="Starter.themeNumber = 2";
mostCurrent._starter._themenumber /*int*/  = (int) (2);
RDebugUtils.currentLine=35651593;
 //BA.debugLineNum = 35651593;BA.debugLine="Starter.themeChanged = True";
mostCurrent._starter._themechanged /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 }}}
;
RDebugUtils.currentLine=35651595;
 //BA.debugLineNum = 35651595;BA.debugLine="ToastMessageShow(\"Theme changed!\", False)";
...
RDebugUtils.currentLine=35651596;
 //BA.debugLineNum = 35651596;BA.debugLine="MainActivity.kvsPref.Put(\"themeNumber\", Starter.t";
...
RDebugUtils.currentLine=35520512;
 //BA.debugLineNum = 35520512;BA.debugLine="Sub backBtn_Click";
RDebugUtils.currentLine=35520513;
 //BA.debugLineNum = 35520513;BA.debugLine="If themePage > 0 Then";
if (_themepage>0) { 
RDebugUtils.currentLine=35520514;
 //BA.debugLineNum = 35520514;BA.debugLine="showThemePage(themePage - 1)";
...
RDebugUtils.currentLine=35586048;
 //BA.debugLineNum = 35586048;BA.debugLine="Sub closeHelp_Click";
RDebugUtils.currentLine=35586049;
 //BA.debugLineNum = 35586049;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentLine=35454976;
 //BA.debugLineNum = 35454976;BA.debugLine="Sub nextBtn_Click";
RDebugUtils.currentLine=35454977;
 //BA.debugLineNum = 35454977;BA.debugLine="If themePage < 2 Then";
if (_themepage<2) { 
RDebugUtils.currentLine=35454978;
 //BA.debugLineNum = 35454978;BA.debugLine="showThemePage(themePage + 1)";
_showthemepage((int) (_themepage+1));
 };
