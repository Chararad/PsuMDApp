...
RDebugUtils.currentLine=29425664;
 //BA.debugLineNum = 29425664;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=29425666;
 //BA.debugLineNum = 29425666;BA.debugLine="Select Starter.themeNumber";
switch (BA.switchObjectToInt(mostCurrent._starter._themenumber /*int*/ ,(int) (0),(int) (1),(int) (2))) {
case 0: {
RDebugUtils.currentLine=29425668;
 //BA.debugLineNum = 29425668;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=29425669;
 //BA.debugLineNum = 29425669;BA.debugLine="Activity.LoadLayout(\"themeLayout\")";
mostCurrent._activity.LoadLayout("themeLayout",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=29425671;
 //BA.debugLineNum = 29425671;BA.debugLine="Activity.LoadLayout(\"themeLayoutDark\")";
mostCurrent._activity.LoadLayout("themeLayoutDark",mostCurrent.activityBA);
 };
 break; }
case 1: {
RDebugUtils.currentLine=29425674;
 //BA.debugLineNum = 29425674;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=29425675;
 //BA.debugLineNum = 29425675;BA.debugLine="Activity.LoadLayout(\"themeLayout2\")";
mostCurrent._activity.LoadLayout("themeLayout2",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=29425677;
 //BA.debugLineNum = 29425677;BA.debugLine="Activity.LoadLayout(\"themeLayoutDark2\")";
mostCurrent._activity.LoadLayout("themeLayoutDark2",mostCurrent.activityBA);
 };
 break; }
case 2: {
RDebugUtils.currentLine=29425680;
 //BA.debugLineNum = 29425680;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=29425681;
 //BA.debugLineNum = 29425681;BA.debugLine="Activity.LoadLayout(\"themeLayout3\")";
mostCurrent._activity.LoadLayout("themeLayout3",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=29425683;
 //BA.debugLineNum = 29425683;BA.debugLine="Activity.LoadLayout(\"themeLayoutDark3\")";
mostCurrent._activity.LoadLayout("themeLayoutDark3",mostCurrent.activityBA);
 };
 break; }
}
;
RDebugUtils.currentLine=29425687;
 //BA.debugLineNum = 29425687;BA.debugLine="showThemePage(0)";
_showthemepage((int) (0));
RDebugUtils.currentLine=29425688;
 //BA.debugLineNum = 29425688;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=29622272;
 //BA.debugLineNum = 29622272;BA.debugLine="Sub showThemePage(page As Int)";
RDebugUtils.currentLine=29622274;
 //BA.debugLineNum = 29622274;BA.debugLine="themePage = page";
_themepage = _page;
RDebugUtils.currentLine=29622276;
 //BA.debugLineNum = 29622276;BA.debugLine="Select page";
switch (_page) {
case 0: {
RDebugUtils.currentLine=29622278;
 //BA.debugLineNum = 29622278;BA.debugLine="titleLbl.Text = \"Default Theme\"";
mostCurrent._titlelbl.setText(BA.ObjectToCharSequence("Default Theme"));
RDebugUtils.currentLine=29622279;
 //BA.debugLineNum = 29622279;BA.debugLine="theme1.Bitmap = xui.LoadBitmapResize(File.DirAss";
...
RDebugUtils.currentLine=29622280;
 //BA.debugLineNum = 29622280;BA.debugLine="theme2.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=29622282;
 //BA.debugLineNum = 29622282;BA.debugLine="titleLbl.Text = \"Y2K Aero\"";
mostCurrent._titlelbl.setText(BA.ObjectToCharSequence("Y2K Aero"));
RDebugUtils.currentLine=29622283;
 //BA.debugLineNum = 29622283;BA.debugLine="theme1.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=29622284;
 //BA.debugLineNum = 29622284;BA.debugLine="theme2.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=29622286;
 //BA.debugLineNum = 29622286;BA.debugLine="titleLbl.Text = \"Pixelated Rustic\"";
mostCurrent._titlelbl.setText(BA.ObjectToCharSequence("Pixelated Rustic"));
RDebugUtils.currentLine=29622287;
 //BA.debugLineNum = 29622287;BA.debugLine="theme1.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=29622288;
 //BA.debugLineNum = 29622288;BA.debugLine="theme2.Bitmap = xui.LoadBitmapResize(File.DirAs";
...
RDebugUtils.currentLine=29622290;
 //BA.debugLineNum = 29622290;BA.debugLine="backBtn.Enabled = (page > 0)";
mostCurrent._backbtn.setEnabled((_page>0));
RDebugUtils.currentLine=29622291;
 //BA.debugLineNum = 29622291;BA.debugLine="nextBtn.Enabled = (page < 2)";
mostCurrent._nextbtn.setEnabled((_page<2));
RDebugUtils.currentLine=29622292;
 //BA.debugLineNum = 29622292;BA.debugLine="End Sub";
return "";
}
public static String  _activity_pause(boolean _userclosed) throws Exception{
RDebugUtils.currentModule="themeactivity";
RDebugUtils.currentLine=29556736;
 //BA.debugLineNum = 29556736;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=29491200;
 //BA.debugLineNum = 29491200;BA.debugLine="Sub Activity_Resume";
...
RDebugUtils.currentLine=29884416;
 //BA.debugLineNum = 29884416;BA.debugLine="Sub applyBtn_Click";
RDebugUtils.currentLine=29884417;
 //BA.debugLineNum = 29884417;BA.debugLine="If themePage = 0 Then";
if (_themepage==0) { 
RDebugUtils.currentLine=29884418;
 //BA.debugLineNum = 29884418;BA.debugLine="Starter.themeNumber = 0";
mostCurrent._starter._themenumber /*int*/  = (int) (0);
RDebugUtils.currentLine=29884419;
 //BA.debugLineNum = 29884419;BA.debugLine="Starter.themeChanged = True";
mostCurrent._starter._themechanged /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 }else 
{RDebugUtils.currentLine=29884420;
 //BA.debugLineNum = 29884420;BA.debugLine="Else If themePage = 1 Then";
if (_themepage==1) { 
RDebugUtils.currentLine=29884421;
 //BA.debugLineNum = 29884421;BA.debugLine="Starter.themeNumber = 1";
mostCurrent._starter._themenumber /*int*/  = (int) (1);
RDebugUtils.currentLine=29884422;
 //BA.debugLineNum = 29884422;BA.debugLine="Starter.themeChanged = True";
mostCurrent._starter._themechanged /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 }else 
{RDebugUtils.currentLine=29884423;
 //BA.debugLineNum = 29884423;BA.debugLine="Else If themePage = 2 Then";
if (_themepage==2) { 
RDebugUtils.currentLine=29884424;
 //BA.debugLineNum = 29884424;BA.debugLine="Starter.themeNumber = 2";
mostCurrent._starter._themenumber /*int*/  = (int) (2);
RDebugUtils.currentLine=29884425;
 //BA.debugLineNum = 29884425;BA.debugLine="Starter.themeChanged = True";
mostCurrent._starter._themechanged /*boolean*/  = anywheresoftware.b4a.keywords.Common.True;
 }}}
;
RDebugUtils.currentLine=29884427;
 //BA.debugLineNum = 29884427;BA.debugLine="ToastMessageShow(\"Theme changed!\", False)";
...
RDebugUtils.currentLine=29884428;
 //BA.debugLineNum = 29884428;BA.debugLine="MainActivity.kvsPref.Put(\"themeNumber\", Starter.t";
...
RDebugUtils.currentLine=29753344;
 //BA.debugLineNum = 29753344;BA.debugLine="Sub backBtn_Click";
RDebugUtils.currentLine=29753345;
 //BA.debugLineNum = 29753345;BA.debugLine="If themePage > 0 Then";
if (_themepage>0) { 
RDebugUtils.currentLine=29753346;
 //BA.debugLineNum = 29753346;BA.debugLine="showThemePage(themePage - 1)";
...
RDebugUtils.currentLine=29818880;
 //BA.debugLineNum = 29818880;BA.debugLine="Sub closeHelp_Click";
RDebugUtils.currentLine=29818881;
 //BA.debugLineNum = 29818881;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentLine=29687808;
 //BA.debugLineNum = 29687808;BA.debugLine="Sub nextBtn_Click";
RDebugUtils.currentLine=29687809;
 //BA.debugLineNum = 29687809;BA.debugLine="If themePage < 2 Then";
if (_themepage<2) { 
RDebugUtils.currentLine=29687810;
 //BA.debugLineNum = 29687810;BA.debugLine="showThemePage(themePage + 1)";
_showthemepage((int) (_themepage+1));
 };
