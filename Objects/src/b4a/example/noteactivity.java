...
RDebugUtils.currentLine=25690112;
 //BA.debugLineNum = 25690112;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=25690113;
 //BA.debugLineNum = 25690113;BA.debugLine="Select Starter.themeNumber";
switch (BA.switchObjectToInt(mostCurrent._starter._themenumber /*int*/ ,(int) (0),(int) (1),(int) (2))) {
case 0: {
RDebugUtils.currentLine=25690115;
 //BA.debugLineNum = 25690115;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=25690116;
 //BA.debugLineNum = 25690116;BA.debugLine="Activity.LoadLayout(\"notepadLayout\")";
mostCurrent._activity.LoadLayout("notepadLayout",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=25690118;
 //BA.debugLineNum = 25690118;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark\")";
mostCurrent._activity.LoadLayout("notepadLayoutDark",mostCurrent.activityBA);
 };
 break; }
case 1: {
RDebugUtils.currentLine=25690121;
 //BA.debugLineNum = 25690121;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=25690122;
 //BA.debugLineNum = 25690122;BA.debugLine="Activity.LoadLayout(\"notepadLayout2\")";
mostCurrent._activity.LoadLayout("notepadLayout2",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=25690124;
 //BA.debugLineNum = 25690124;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark2\")";
mostCurrent._activity.LoadLayout("notepadLayoutDark2",mostCurrent.activityBA);
 };
 break; }
case 2: {
RDebugUtils.currentLine=25690127;
 //BA.debugLineNum = 25690127;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=25690128;
 //BA.debugLineNum = 25690128;BA.debugLine="Activity.LoadLayout(\"notepadLayout3\")";
mostCurrent._activity.LoadLayout("notepadLayout3",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=25690130;
 //BA.debugLineNum = 25690130;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark3\")";
...
RDebugUtils.currentLine=25821184;
 //BA.debugLineNum = 25821184;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=25755648;
 //BA.debugLineNum = 25755648;BA.debugLine="Sub Activity_Resume";
RDebugUtils.currentLine=25755649;
 //BA.debugLineNum = 25755649;BA.debugLine="RefreshList(\"\")";
_refreshlist("");
...
RDebugUtils.currentLine=26017792;
 //BA.debugLineNum = 26017792;BA.debugLine="Sub RefreshList(SearchQuery As String)";
RDebugUtils.currentLine=26017793;
 //BA.debugLineNum = 26017793;BA.debugLine="noteClv.Clear";
mostCurrent._noteclv._clear();
RDebugUtils.currentLine=26017794;
 //BA.debugLineNum = 26017794;BA.debugLine="Dim AllNotes As List";
_allnotes = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=26017795;
 //BA.debugLineNum = 26017795;BA.debugLine="AllNotes.Initialize";
_allnotes.Initialize();
RDebugUtils.currentLine=26017797;
 //BA.debugLineNum = 26017797;BA.debugLine="Dim keys As List = MainActivity.kvs.ListKeys";
...
RDebugUtils.currentLine=26017799;
 //BA.debugLineNum = 26017799;BA.debugLine="For Each k As String In keys";
{
...
RDebugUtils.currentLine=26017800;
 //BA.debugLineNum = 26017800;BA.debugLine="If k.StartsWith(\"N_\") Then";
if (_k.startsWith("N_")) { 
RDebugUtils.currentLine=26017801;
 //BA.debugLineNum = 26017801;BA.debugLine="Dim N As MyNote = MainActivity.kvs.Get(k)";
...
RDebugUtils.currentLine=26017802;
 //BA.debugLineNum = 26017802;BA.debugLine="Dim query As String = SearchQuery.ToLowerCase";
_query = _searchquery.toLowerCase();
RDebugUtils.currentLine=26017803;
 //BA.debugLineNum = 26017803;BA.debugLine="If query = \"\" Then";
if ((_query).equals("")) { 
RDebugUtils.currentLine=26017804;
 //BA.debugLineNum = 26017804;BA.debugLine="AllNotes.Add(N)";
_allnotes.Add((Object)(_n));
 }else {
RDebugUtils.currentLine=26017806;
 //BA.debugLineNum = 26017806;BA.debugLine="If N.Tags.ToLowerCase.Contains(query) Or N.Tit";
...
RDebugUtils.currentLine=26017807;
 //BA.debugLineNum = 26017807;BA.debugLine="AllNotes.Add(N)";
_allnotes.Add((Object)(_n));
 };
 };
 };
...
RDebugUtils.currentLine=26017813;
 //BA.debugLineNum = 26017813;BA.debugLine="AllNotes.SortType(\"Title\", True)";
_allnotes.SortType("Title",anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=26017815;
 //BA.debugLineNum = 26017815;BA.debugLine="For Each n As MyNote In AllNotes";
{
...
RDebugUtils.currentLine=26017816;
 //BA.debugLineNum = 26017816;BA.debugLine="noteClv.AddTextItem(n.Title & CRLF & n.Tags, n)";
...
RDebugUtils.currentLine=26017819;
 //BA.debugLineNum = 26017819;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=26148864;
 //BA.debugLineNum = 26148864;BA.debugLine="Sub addBtn_Click";
RDebugUtils.currentLine=26148865;
 //BA.debugLineNum = 26148865;BA.debugLine="StartActivity(editnote)";
...
RDebugUtils.currentLine=25886720;
 //BA.debugLineNum = 25886720;BA.debugLine="Sub noteClv_ItemClick (Index As Int, Value As Obje";
RDebugUtils.currentLine=25886722;
 //BA.debugLineNum = 25886722;BA.debugLine="Dim selectedNote As MyNote = Value";
_selectednote = (b4a.example.main._mynote)(_value);
RDebugUtils.currentLine=25886725;
 //BA.debugLineNum = 25886725;BA.debugLine="editnote.ActiveNote = selectedNote";
mostCurrent._editnote._activenote /*b4a.example.main._mynote*/  = _selectednote;
RDebugUtils.currentLine=25886727;
 //BA.debugLineNum = 25886727;BA.debugLine="StartActivity(editnote)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._editnote.getObject()));
...
RDebugUtils.currentLine=25952257;
 //BA.debugLineNum = 25952257;BA.debugLine="Dim n As MyNote = Value";
_n = (b4a.example.main._mynote)(_value);
RDebugUtils.currentLine=25952259;
 //BA.debugLineNum = 25952259;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete '\"";
...
RDebugUtils.currentLine=25952260;
 //BA.debugLineNum = 25952260;BA.debugLine="Wait For Msgbox_Result (res As Int)";
...
RDebugUtils.currentLine=25952261;
 //BA.debugLineNum = 25952261;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
if (true) break;
...
RDebugUtils.currentLine=25952262;
 //BA.debugLineNum = 25952262;BA.debugLine="MainActivity.kvs.Remove(\"N_\" & n.noteID)";
...
RDebugUtils.currentLine=25952263;
 //BA.debugLineNum = 25952263;BA.debugLine="RefreshList(\"\")";
_refreshlist("");
RDebugUtils.currentLine=25952264;
 //BA.debugLineNum = 25952264;BA.debugLine="ToastMessageShow(\"Note deleted\", False)";
...
RDebugUtils.currentLine=26214400;
 //BA.debugLineNum = 26214400;BA.debugLine="Sub noteCvl_ItemClick (Index As Int, Value As Obje";
RDebugUtils.currentLine=26214401;
 //BA.debugLineNum = 26214401;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=26083328;
 //BA.debugLineNum = 26083328;BA.debugLine="Sub searchTxt_TextChanged (Old As String, New As S";
RDebugUtils.currentLine=26083329;
 //BA.debugLineNum = 26083329;BA.debugLine="RefreshList(New)";
_refreshlist(_new);
