...
RDebugUtils.currentLine=31522817;
 //BA.debugLineNum = 31522817;BA.debugLine="Select Starter.themeNumber";
switch (BA.switchObjectToInt(mostCurrent._starter._themenumber /*int*/ ,(int) (0),(int) (1),(int) (2))) {
case 0: {
RDebugUtils.currentLine=31522819;
 //BA.debugLineNum = 31522819;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=31522820;
 //BA.debugLineNum = 31522820;BA.debugLine="Activity.LoadLayout(\"notepadLayout\")";
mostCurrent._activity.LoadLayout("notepadLayout",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=31522822;
 //BA.debugLineNum = 31522822;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark\")";
mostCurrent._activity.LoadLayout("notepadLayoutDark",mostCurrent.activityBA);
 };
 break; }
case 1: {
RDebugUtils.currentLine=31522825;
 //BA.debugLineNum = 31522825;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=31522826;
 //BA.debugLineNum = 31522826;BA.debugLine="Activity.LoadLayout(\"notepadLayout2\")";
mostCurrent._activity.LoadLayout("notepadLayout2",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=31522828;
 //BA.debugLineNum = 31522828;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark2\")";
mostCurrent._activity.LoadLayout("notepadLayoutDark2",mostCurrent.activityBA);
 };
 break; }
case 2: {
RDebugUtils.currentLine=31522831;
 //BA.debugLineNum = 31522831;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=31522832;
 //BA.debugLineNum = 31522832;BA.debugLine="Activity.LoadLayout(\"notepadLayout3\")";
mostCurrent._activity.LoadLayout("notepadLayout3",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=31522834;
 //BA.debugLineNum = 31522834;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark3\")";
...
RDebugUtils.currentLine=31522838;
 //BA.debugLineNum = 31522838;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=31588353;
 //BA.debugLineNum = 31588353;BA.debugLine="RefreshList(\"\")";
_refreshlist("");
...
RDebugUtils.currentLine=31850496;
 //BA.debugLineNum = 31850496;BA.debugLine="Sub RefreshList(SearchQuery As String)";
RDebugUtils.currentLine=31850497;
 //BA.debugLineNum = 31850497;BA.debugLine="noteClv.Clear";
mostCurrent._noteclv._clear();
RDebugUtils.currentLine=31850498;
 //BA.debugLineNum = 31850498;BA.debugLine="Dim AllNotes As List";
_allnotes = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=31850499;
 //BA.debugLineNum = 31850499;BA.debugLine="AllNotes.Initialize";
_allnotes.Initialize();
RDebugUtils.currentLine=31850501;
 //BA.debugLineNum = 31850501;BA.debugLine="Dim keys As List = MainActivity.kvs.ListKeys";
...
RDebugUtils.currentLine=31850503;
 //BA.debugLineNum = 31850503;BA.debugLine="For Each k As String In keys";
{
...
RDebugUtils.currentLine=31850504;
 //BA.debugLineNum = 31850504;BA.debugLine="If k.StartsWith(\"N_\") Then";
if (_k.startsWith("N_")) { 
RDebugUtils.currentLine=31850505;
 //BA.debugLineNum = 31850505;BA.debugLine="Dim N As MyNote = MainActivity.kvs.Get(k)";
...
RDebugUtils.currentLine=31850506;
 //BA.debugLineNum = 31850506;BA.debugLine="Dim query As String = SearchQuery.ToLowerCase";
_query = _searchquery.toLowerCase();
RDebugUtils.currentLine=31850507;
 //BA.debugLineNum = 31850507;BA.debugLine="If query = \"\" Then";
if ((_query).equals("")) { 
RDebugUtils.currentLine=31850508;
 //BA.debugLineNum = 31850508;BA.debugLine="AllNotes.Add(N)";
_allnotes.Add((Object)(_n));
 }else {
RDebugUtils.currentLine=31850510;
 //BA.debugLineNum = 31850510;BA.debugLine="If N.Tags.ToLowerCase.Contains(query) Or N.Tit";
...
RDebugUtils.currentLine=31850511;
 //BA.debugLineNum = 31850511;BA.debugLine="AllNotes.Add(N)";
_allnotes.Add((Object)(_n));
 };
 };
 };
...
RDebugUtils.currentLine=31850517;
 //BA.debugLineNum = 31850517;BA.debugLine="AllNotes.SortType(\"Title\", True)";
_allnotes.SortType("Title",anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=31850519;
 //BA.debugLineNum = 31850519;BA.debugLine="For Each n As MyNote In AllNotes";
{
...
RDebugUtils.currentLine=31850520;
 //BA.debugLineNum = 31850520;BA.debugLine="noteClv.AddTextItem(n.Title & CRLF & n.Tags, n)";
...
RDebugUtils.currentLine=31850523;
 //BA.debugLineNum = 31850523;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=31981568;
 //BA.debugLineNum = 31981568;BA.debugLine="Sub addBtn_Click";
RDebugUtils.currentLine=31981569;
 //BA.debugLineNum = 31981569;BA.debugLine="StartActivity(editnote)";
...
RDebugUtils.currentLine=31719424;
 //BA.debugLineNum = 31719424;BA.debugLine="Sub noteClv_ItemClick (Index As Int, Value As Obje";
RDebugUtils.currentLine=31719426;
 //BA.debugLineNum = 31719426;BA.debugLine="Dim selectedNote As MyNote = Value";
_selectednote = (b4a.example.main._mynote)(_value);
RDebugUtils.currentLine=31719429;
 //BA.debugLineNum = 31719429;BA.debugLine="editnote.ActiveNote = selectedNote";
mostCurrent._editnote._activenote /*b4a.example.main._mynote*/  = _selectednote;
RDebugUtils.currentLine=31719431;
 //BA.debugLineNum = 31719431;BA.debugLine="StartActivity(editnote)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._editnote.getObject()));
...
RDebugUtils.currentLine=31784961;
 //BA.debugLineNum = 31784961;BA.debugLine="Dim n As MyNote = Value";
_n = (b4a.example.main._mynote)(_value);
RDebugUtils.currentLine=31784963;
 //BA.debugLineNum = 31784963;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete '\"";
...
RDebugUtils.currentLine=31784964;
 //BA.debugLineNum = 31784964;BA.debugLine="Wait For Msgbox_Result (res As Int)";
...
RDebugUtils.currentLine=31784965;
 //BA.debugLineNum = 31784965;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
if (true) break;
...
RDebugUtils.currentLine=31784966;
 //BA.debugLineNum = 31784966;BA.debugLine="MainActivity.kvs.Remove(\"N_\" & n.noteID)";
...
RDebugUtils.currentLine=31784967;
 //BA.debugLineNum = 31784967;BA.debugLine="RefreshList(\"\")";
_refreshlist("");
RDebugUtils.currentLine=31784968;
 //BA.debugLineNum = 31784968;BA.debugLine="ToastMessageShow(\"Note deleted\", False)";
...
RDebugUtils.currentLine=32047104;
 //BA.debugLineNum = 32047104;BA.debugLine="Sub noteCvl_ItemClick (Index As Int, Value As Obje";
RDebugUtils.currentLine=32047105;
 //BA.debugLineNum = 32047105;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=31916032;
 //BA.debugLineNum = 31916032;BA.debugLine="Sub searchTxt_TextChanged (Old As String, New As S";
RDebugUtils.currentLine=31916033;
 //BA.debugLineNum = 31916033;BA.debugLine="RefreshList(New)";
_refreshlist(_new);
