...
RDebugUtils.currentLine=26607616;
 //BA.debugLineNum = 26607616;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=26607617;
 //BA.debugLineNum = 26607617;BA.debugLine="Select Starter.themeNumber";
switch (BA.switchObjectToInt(mostCurrent._starter._themenumber /*int*/ ,(int) (0),(int) (1),(int) (2))) {
case 0: {
RDebugUtils.currentLine=26607619;
 //BA.debugLineNum = 26607619;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=26607620;
 //BA.debugLineNum = 26607620;BA.debugLine="Activity.LoadLayout(\"notepadLayout\")";
mostCurrent._activity.LoadLayout("notepadLayout",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=26607622;
 //BA.debugLineNum = 26607622;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark\")";
mostCurrent._activity.LoadLayout("notepadLayoutDark",mostCurrent.activityBA);
 };
 break; }
case 1: {
RDebugUtils.currentLine=26607625;
 //BA.debugLineNum = 26607625;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=26607626;
 //BA.debugLineNum = 26607626;BA.debugLine="Activity.LoadLayout(\"notepadLayout2\")";
mostCurrent._activity.LoadLayout("notepadLayout2",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=26607628;
 //BA.debugLineNum = 26607628;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark2\")";
mostCurrent._activity.LoadLayout("notepadLayoutDark2",mostCurrent.activityBA);
 };
 break; }
case 2: {
RDebugUtils.currentLine=26607631;
 //BA.debugLineNum = 26607631;BA.debugLine="If Starter.darkMode = False Then";
if (mostCurrent._starter._darkmode /*boolean*/ ==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=26607632;
 //BA.debugLineNum = 26607632;BA.debugLine="Activity.LoadLayout(\"notepadLayout3\")";
mostCurrent._activity.LoadLayout("notepadLayout3",mostCurrent.activityBA);
 }else {
RDebugUtils.currentLine=26607634;
 //BA.debugLineNum = 26607634;BA.debugLine="Activity.LoadLayout(\"notepadLayoutDark3\")";
...
RDebugUtils.currentLine=26738688;
 //BA.debugLineNum = 26738688;BA.debugLine="Sub Activity_Pause (UserClosed As Boolean)";
...
RDebugUtils.currentLine=26673152;
 //BA.debugLineNum = 26673152;BA.debugLine="Sub Activity_Resume";
RDebugUtils.currentLine=26673153;
 //BA.debugLineNum = 26673153;BA.debugLine="RefreshList(\"\")";
_refreshlist("");
...
RDebugUtils.currentLine=26935296;
 //BA.debugLineNum = 26935296;BA.debugLine="Sub RefreshList(SearchQuery As String)";
RDebugUtils.currentLine=26935297;
 //BA.debugLineNum = 26935297;BA.debugLine="noteClv.Clear";
mostCurrent._noteclv._clear();
RDebugUtils.currentLine=26935298;
 //BA.debugLineNum = 26935298;BA.debugLine="Dim AllNotes As List";
_allnotes = new anywheresoftware.b4a.objects.collections.List();
RDebugUtils.currentLine=26935299;
 //BA.debugLineNum = 26935299;BA.debugLine="AllNotes.Initialize";
_allnotes.Initialize();
RDebugUtils.currentLine=26935301;
 //BA.debugLineNum = 26935301;BA.debugLine="Dim keys As List = MainActivity.kvs.ListKeys";
...
RDebugUtils.currentLine=26935303;
 //BA.debugLineNum = 26935303;BA.debugLine="For Each k As String In keys";
{
...
RDebugUtils.currentLine=26935304;
 //BA.debugLineNum = 26935304;BA.debugLine="If k.StartsWith(\"N_\") Then";
if (_k.startsWith("N_")) { 
RDebugUtils.currentLine=26935305;
 //BA.debugLineNum = 26935305;BA.debugLine="Dim N As MyNote = MainActivity.kvs.Get(k)";
...
RDebugUtils.currentLine=26935306;
 //BA.debugLineNum = 26935306;BA.debugLine="Dim query As String = SearchQuery.ToLowerCase";
_query = _searchquery.toLowerCase();
RDebugUtils.currentLine=26935307;
 //BA.debugLineNum = 26935307;BA.debugLine="If query = \"\" Then";
if ((_query).equals("")) { 
RDebugUtils.currentLine=26935308;
 //BA.debugLineNum = 26935308;BA.debugLine="AllNotes.Add(N)";
_allnotes.Add((Object)(_n));
 }else {
RDebugUtils.currentLine=26935310;
 //BA.debugLineNum = 26935310;BA.debugLine="If N.Tags.ToLowerCase.Contains(query) Or N.Tit";
...
RDebugUtils.currentLine=26935311;
 //BA.debugLineNum = 26935311;BA.debugLine="AllNotes.Add(N)";
_allnotes.Add((Object)(_n));
 };
 };
 };
...
RDebugUtils.currentLine=26935317;
 //BA.debugLineNum = 26935317;BA.debugLine="AllNotes.SortType(\"Title\", True)";
_allnotes.SortType("Title",anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=26935319;
 //BA.debugLineNum = 26935319;BA.debugLine="For Each n As MyNote In AllNotes";
{
...
RDebugUtils.currentLine=26935320;
 //BA.debugLineNum = 26935320;BA.debugLine="noteClv.AddTextItem(n.Title & CRLF & n.Tags, n)";
...
RDebugUtils.currentLine=27066368;
 //BA.debugLineNum = 27066368;BA.debugLine="Sub addBtn_Click";
RDebugUtils.currentLine=27066369;
 //BA.debugLineNum = 27066369;BA.debugLine="StartActivity(editnote)";
...
RDebugUtils.currentLine=26804224;
 //BA.debugLineNum = 26804224;BA.debugLine="Sub noteClv_ItemClick (Index As Int, Value As Obje";
RDebugUtils.currentLine=26804226;
 //BA.debugLineNum = 26804226;BA.debugLine="Dim selectedNote As MyNote = Value";
_selectednote = (b4a.example.main._mynote)(_value);
RDebugUtils.currentLine=26804229;
 //BA.debugLineNum = 26804229;BA.debugLine="editnote.ActiveNote = selectedNote";
mostCurrent._editnote._activenote /*b4a.example.main._mynote*/  = _selectednote;
RDebugUtils.currentLine=26804231;
 //BA.debugLineNum = 26804231;BA.debugLine="StartActivity(editnote)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._editnote.getObject()));
...
RDebugUtils.currentLine=26869761;
 //BA.debugLineNum = 26869761;BA.debugLine="Dim n As MyNote = Value";
_n = (b4a.example.main._mynote)(_value);
RDebugUtils.currentLine=26869763;
 //BA.debugLineNum = 26869763;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete '\"";
...
RDebugUtils.currentLine=26869764;
 //BA.debugLineNum = 26869764;BA.debugLine="Wait For Msgbox_Result (res As Int)";
...
RDebugUtils.currentLine=26869765;
 //BA.debugLineNum = 26869765;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
if (true) break;
...
RDebugUtils.currentLine=26869766;
 //BA.debugLineNum = 26869766;BA.debugLine="MainActivity.kvs.Remove(\"N_\" & n.noteID)";
...
RDebugUtils.currentLine=26869767;
 //BA.debugLineNum = 26869767;BA.debugLine="RefreshList(\"\")";
_refreshlist("");
RDebugUtils.currentLine=26869768;
 //BA.debugLineNum = 26869768;BA.debugLine="ToastMessageShow(\"Note deleted\", False)";
...
RDebugUtils.currentLine=27131904;
 //BA.debugLineNum = 27131904;BA.debugLine="Sub noteCvl_ItemClick (Index As Int, Value As Obje";
RDebugUtils.currentLine=27131905;
 //BA.debugLineNum = 27131905;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=27000832;
 //BA.debugLineNum = 27000832;BA.debugLine="Sub searchTxt_TextChanged (Old As String, New As S";
RDebugUtils.currentLine=27000833;
 //BA.debugLineNum = 27000833;BA.debugLine="RefreshList(New)";
_refreshlist(_new);
