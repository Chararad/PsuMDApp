...
RDebugUtils.currentLine=9306154;
 //BA.debugLineNum = 9306154;BA.debugLine="pomoTxt.TextColor = Colors.White";
mostCurrent._pomotxt.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
...
RDebugUtils.currentLine=9306164;
 //BA.debugLineNum = 9306164;BA.debugLine="shortTxt.TextColor = Colors.White";
mostCurrent._shorttxt.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
...
RDebugUtils.currentLine=9306174;
 //BA.debugLineNum = 9306174;BA.debugLine="longTxt.TextColor = Colors.White";
mostCurrent._longtxt.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
...
RDebugUtils.currentLine=9306220;
 //BA.debugLineNum = 9306220;BA.debugLine="saveBtn.TextColor = Colors.White";
_savebtn.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.White);
RDebugUtils.currentLine=9306221;
 //BA.debugLineNum = 9306221;BA.debugLine="saveBtn.Color = Colors.Black";
_savebtn.setColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 }else {
RDebugUtils.currentLine=9306223;
 //BA.debugLineNum = 9306223;BA.debugLine="saveBtn.TextColor = Colors.Black";
_savebtn.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
RDebugUtils.currentLine=9306224;
 //BA.debugLineNum = 9306224;BA.debugLine="saveBtn.Color = Colors.White";
_savebtn.setColor(anywheresoftware.b4a.keywords.Common.Colors.White);
 };
 break; }
case 1: {
...
RDebugUtils.currentLine=9306240;
 //BA.debugLineNum = 9306240;BA.debugLine="saveBtn.Color = Colors.RGB(139,155,180)";
_savebtn.setColor(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (139),(int) (155),(int) (180)));
 };
 break; }
}
;
