...
RDebugUtils.currentLine=8781825;
 //BA.debugLineNum = 8781825;BA.debugLine="Activity.LoadLayout(\"tutoriallayout\")";
mostCurrent._activity.LoadLayout("tutoriallayout",mostCurrent.activityBA);
RDebugUtils.currentLine=8781826;
 //BA.debugLineNum = 8781826;BA.debugLine="showTutorialPage(0)";
...
RDebugUtils.currentLine=8978432;
 //BA.debugLineNum = 8978432;BA.debugLine="Sub showTutorialPage(page As Int)";
RDebugUtils.currentLine=8978433;
 //BA.debugLineNum = 8978433;BA.debugLine="tutorialPage = page";
_tutorialpage = _page;
RDebugUtils.currentLine=8978435;
 //BA.debugLineNum = 8978435;BA.debugLine="Select page";
switch (_page) {
case 0: {
RDebugUtils.currentLine=8978437;
 //BA.debugLineNum = 8978437;BA.debugLine="headerLbl.Text = \"Welcome to Athena!\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Welcome to Athena!"));
RDebugUtils.currentLine=8978438;
 //BA.debugLineNum = 8978438;BA.debugLine="bodyLbl.Text = \"In legend, Athena is the goddes";
...
RDebugUtils.currentLine=8978442;
 //BA.debugLineNum = 8978442;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978445;
 //BA.debugLineNum = 8978445;BA.debugLine="headerLbl.Text = \"Home Screen  (1/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Home Screen  (1/2)"));
RDebugUtils.currentLine=8978446;
 //BA.debugLineNum = 8978446;BA.debugLine="bodyLbl.Text = \"This is your central hub — beau";
...
RDebugUtils.currentLine=8978457;
 //BA.debugLineNum = 8978457;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978460;
 //BA.debugLineNum = 8978460;BA.debugLine="headerLbl.Text = \"Home Screen  (2/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Home Screen  (2/2)"));
RDebugUtils.currentLine=8978461;
 //BA.debugLineNum = 8978461;BA.debugLine="bodyLbl.Text = \"The home screen is alive — subt";
...
RDebugUtils.currentLine=8978467;
 //BA.debugLineNum = 8978467;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978470;
 //BA.debugLineNum = 8978470;BA.debugLine="headerLbl.Text = \"Navigation & Help\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Navigation & Help"));
RDebugUtils.currentLine=8978471;
 //BA.debugLineNum = 8978471;BA.debugLine="bodyLbl.Text = \"Navigation Button — your quick-";
...
RDebugUtils.currentLine=8978478;
 //BA.debugLineNum = 8978478;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978481;
 //BA.debugLineNum = 8978481;BA.debugLine="headerLbl.Text = \"Leaderboard\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Leaderboard"));
RDebugUtils.currentLine=8978482;
 //BA.debugLineNum = 8978482;BA.debugLine="bodyLbl.Text = \"Navigation Button — your rankin";
mostCurrent._bodylbl.setText(BA.ObjectToCharSequence("Navigation Button — your ranking board for flashcard progress."+anywheresoftware.b4a.keywords.Common.CRLF+"Tap the star button for to see every player's XP, streak, and their ranking!"+anywheresoftware.b4a.keywords.Common.CRLF+"Daily, Weekly, All-Time — pick your battleground. Tap any TAB To switch views."+"Top card — the #1 spot, front and center."+"The current leader gets the big card up top. That could be you."+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+"Ranking — XP wins, streak breaks ties. More XP = higher rank. Same XP?"+"Longer streak goes first. Still tied? Better correct rate wins."));
RDebugUtils.currentLine=8978489;
 //BA.debugLineNum = 8978489;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpnav.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 5: {
RDebugUtils.currentLine=8978492;
 //BA.debugLineNum = 8978492;BA.debugLine="headerLbl.Text = \"Lamp — Dark / Light Mode\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Lamp — Dark / Light Mode"));
RDebugUtils.currentLine=8978493;
 //BA.debugLineNum = 8978493;BA.debugLine="bodyLbl.Text = \"Tap the Lamp to instantly switc";
...
RDebugUtils.currentLine=8978498;
 //BA.debugLineNum = 8978498;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978501;
 //BA.debugLineNum = 8978501;BA.debugLine="headerLbl.Text = \"Music Player  (1/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Music Player  (1/2)"));
RDebugUtils.currentLine=8978502;
 //BA.debugLineNum = 8978502;BA.debugLine="bodyLbl.Text = \"Tap the record player and lo-fi";
...
RDebugUtils.currentLine=8978509;
 //BA.debugLineNum = 8978509;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978512;
 //BA.debugLineNum = 8978512;BA.debugLine="headerLbl.Text = \"Music Player  (2/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Music Player  (2/2)"));
RDebugUtils.currentLine=8978513;
 //BA.debugLineNum = 8978513;BA.debugLine="bodyLbl.Text = \"Athena's music library has grow";
...
RDebugUtils.currentLine=8978517;
 //BA.debugLineNum = 8978517;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpmusic.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 8: {
RDebugUtils.currentLine=8978520;
 //BA.debugLineNum = 8978520;BA.debugLine="headerLbl.Text = \"Clock & Pomodoro  (1/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Clock & Pomodoro  (1/2)"));
RDebugUtils.currentLine=8978521;
 //BA.debugLineNum = 8978521;BA.debugLine="bodyLbl.Text = \"The Clock is more than a timepi";
...
RDebugUtils.currentLine=8978529;
 //BA.debugLineNum = 8978529;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpclock.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 9: {
RDebugUtils.currentLine=8978532;
 //BA.debugLineNum = 8978532;BA.debugLine="headerLbl.Text = \"Clock & Pomodoro  (2/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Clock & Pomodoro  (2/2)"));
RDebugUtils.currentLine=8978533;
 //BA.debugLineNum = 8978533;BA.debugLine="bodyLbl.Text = \"Controls:\" & CRLF & _";
...
RDebugUtils.currentLine=8978540;
 //BA.debugLineNum = 8978540;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpclock.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 10: {
RDebugUtils.currentLine=8978543;
 //BA.debugLineNum = 8978543;BA.debugLine="headerLbl.Text = \"Flashcards  (1/3)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Flashcards  (1/3)"));
RDebugUtils.currentLine=8978544;
 //BA.debugLineNum = 8978544;BA.debugLine="bodyLbl.Text = \"Tap the Books to open Flashcard";
...
RDebugUtils.currentLine=8978550;
 //BA.debugLineNum = 8978550;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
...
RDebugUtils.currentLine=8978553;
 //BA.debugLineNum = 8978553;BA.debugLine="headerLbl.Text = \"Flashcards  (2/3)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Flashcards  (2/3)"));
RDebugUtils.currentLine=8978554;
 //BA.debugLineNum = 8978554;BA.debugLine="bodyLbl.Text = \"Reviewing a deck:\" & CRLF & _";
...
RDebugUtils.currentLine=8978562;
 //BA.debugLineNum = 8978562;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpflashcard.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 12: {
RDebugUtils.currentLine=8978565;
 //BA.debugLineNum = 8978565;BA.debugLine="headerLbl.Text = \"Flashcards  (3/3)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Flashcards  (3/3)"));
RDebugUtils.currentLine=8978566;
 //BA.debugLineNum = 8978566;BA.debugLine="bodyLbl.Text = \"Athena's AI can do the heavy li";
...
RDebugUtils.currentLine=8978571;
 //BA.debugLineNum = 8978571;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpflashcard.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 13: {
RDebugUtils.currentLine=8978574;
 //BA.debugLineNum = 8978574;BA.debugLine="headerLbl.Text = \"Calendar  (1/3)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Calendar  (1/3)"));
RDebugUtils.currentLine=8978575;
 //BA.debugLineNum = 8978575;BA.debugLine="bodyLbl.Text = \"Tap the Calendar to open your p";
...
RDebugUtils.currentLine=8978581;
 //BA.debugLineNum = 8978581;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpcalendar.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 14: {
RDebugUtils.currentLine=8978584;
 //BA.debugLineNum = 8978584;BA.debugLine="headerLbl.Text = \"Calendar  (2/3)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Calendar  (2/3)"));
RDebugUtils.currentLine=8978585;
 //BA.debugLineNum = 8978585;BA.debugLine="bodyLbl.Text = \"Adding events:\" & CRLF & _";
...
RDebugUtils.currentLine=8978594;
 //BA.debugLineNum = 8978594;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpcalendar.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 15: {
RDebugUtils.currentLine=8978597;
 //BA.debugLineNum = 8978597;BA.debugLine="headerLbl.Text = \"Calendar  (3/3)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Calendar  (3/3)"));
RDebugUtils.currentLine=8978598;
 //BA.debugLineNum = 8978598;BA.debugLine="bodyLbl.Text = \"Schedules are no longer just pe";
...
RDebugUtils.currentLine=8978603;
 //BA.debugLineNum = 8978603;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpcalendar.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 16: {
RDebugUtils.currentLine=8978606;
 //BA.debugLineNum = 8978606;BA.debugLine="headerLbl.Text = \"To-Do List  (1/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("To-Do List  (1/2)"));
RDebugUtils.currentLine=8978607;
 //BA.debugLineNum = 8978607;BA.debugLine="bodyLbl.Text = \"Tap the PC Screen to open the T";
...
RDebugUtils.currentLine=8978614;
 //BA.debugLineNum = 8978614;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helptodo.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 17: {
RDebugUtils.currentLine=8978617;
 //BA.debugLineNum = 8978617;BA.debugLine="headerLbl.Text = \"To-Do List  (2/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("To-Do List  (2/2)"));
RDebugUtils.currentLine=8978618;
 //BA.debugLineNum = 8978618;BA.debugLine="bodyLbl.Text = \"Progress tracker:\" & CRLF & _";
...
RDebugUtils.currentLine=8978625;
 //BA.debugLineNum = 8978625;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helptodo.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 18: {
RDebugUtils.currentLine=8978628;
 //BA.debugLineNum = 8978628;BA.debugLine="headerLbl.Text = \"Notepad  (1/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Notepad  (1/2)"));
RDebugUtils.currentLine=8978629;
 //BA.debugLineNum = 8978629;BA.debugLine="bodyLbl.Text = \"Tap the Notepad to capture the";
...
RDebugUtils.currentLine=8978637;
 //BA.debugLineNum = 8978637;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpnotepad.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 19: {
RDebugUtils.currentLine=8978640;
 //BA.debugLineNum = 8978640;BA.debugLine="headerLbl.Text = \"Notepad  (2/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Notepad  (2/2)"));
RDebugUtils.currentLine=8978641;
 //BA.debugLineNum = 8978641;BA.debugLine="bodyLbl.Text = \"Athena's AI can summarize for y";
...
RDebugUtils.currentLine=8978646;
 //BA.debugLineNum = 8978646;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpnotepad.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 20: {
RDebugUtils.currentLine=8978649;
 //BA.debugLineNum = 8978649;BA.debugLine="headerLbl.Text = \"Corkboard  (1/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Corkboard  (1/2)"));
RDebugUtils.currentLine=8978650;
 //BA.debugLineNum = 8978650;BA.debugLine="bodyLbl.Text = \"Tap the Corkboard — your digita";
...
RDebugUtils.currentLine=8978655;
 //BA.debugLineNum = 8978655;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpcorkboard.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 21: {
RDebugUtils.currentLine=8978658;
 //BA.debugLineNum = 8978658;BA.debugLine="headerLbl.Text = \"Corkboard  (2/2)\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Corkboard  (2/2)"));
RDebugUtils.currentLine=8978659;
 //BA.debugLineNum = 8978659;BA.debugLine="bodyLbl.Text = \"The Corkboard is where organiza";
...
RDebugUtils.currentLine=8978663;
 //BA.debugLineNum = 8978663;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpcorkboard.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 22: {
RDebugUtils.currentLine=8978666;
 //BA.debugLineNum = 8978666;BA.debugLine="headerLbl.Text = \"Themes\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("Themes"));
RDebugUtils.currentLine=8978667;
 //BA.debugLineNum = 8978667;BA.debugLine="bodyLbl.Text = \"Your workspace should feel like";
...
RDebugUtils.currentLine=8978675;
 //BA.debugLineNum = 8978675;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helptheme.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
case 23: {
RDebugUtils.currentLine=8978678;
 //BA.debugLineNum = 8978678;BA.debugLine="headerLbl.Text = \"You're All Set!\"";
mostCurrent._headerlbl.setText(BA.ObjectToCharSequence("You're All Set!"));
RDebugUtils.currentLine=8978679;
 //BA.debugLineNum = 8978679;BA.debugLine="bodyLbl.Text = \"That is everything Athena has t";
...
RDebugUtils.currentLine=8978686;
 //BA.debugLineNum = 8978686;BA.debugLine="tutorialImg.Bitmap = xui.LoadBitmapResize(File.";
mostCurrent._tutorialimg.setBitmap((android.graphics.Bitmap)(_xui.LoadBitmapResize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"helpwreath.png",mostCurrent._tutorialimg.getWidth(),mostCurrent._tutorialimg.getHeight(),anywheresoftware.b4a.keywords.Common.True).getObject()));
 break; }
}
;
RDebugUtils.currentLine=8978690;
 //BA.debugLineNum = 8978690;BA.debugLine="pageIndicator.Text = (page + 1) & \" / 24\"";
mostCurrent._pageindicator.setText(BA.ObjectToCharSequence(BA.NumberToString((_page+1))+" / 24"));
RDebugUtils.currentLine=8978693;
 //BA.debugLineNum = 8978693;BA.debugLine="chkDontShow.Visible = (page = 23)";
mostCurrent._chkdontshow.setVisible((_page==23));
RDebugUtils.currentLine=8978696;
 //BA.debugLineNum = 8978696;BA.debugLine="btnBack.Enabled = (page > 0)";
mostCurrent._btnback.setEnabled((_page>0));
RDebugUtils.currentLine=8978699;
 //BA.debugLineNum = 8978699;BA.debugLine="If page = 23 Then";
if (_page==23) { 
RDebugUtils.currentLine=8978700;
 //BA.debugLineNum = 8978700;BA.debugLine="btnNext.Text = \"Finish\"";
mostCurrent._btnnext.setText(BA.ObjectToCharSequence("Finish"));
 }else {
RDebugUtils.currentLine=8978702;
 //BA.debugLineNum = 8978702;BA.debugLine="btnNext.Text = \"Next\"";
mostCurrent._btnnext.setText(BA.ObjectToCharSequence("Next"));
 };
RDebugUtils.currentLine=8978704;
 //BA.debugLineNum = 8978704;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=9109504;
 //BA.debugLineNum = 9109504;BA.debugLine="Sub btnBack_Click";
RDebugUtils.currentLine=9109505;
 //BA.debugLineNum = 9109505;BA.debugLine="If tutorialPage > 0 Then";
if (_tutorialpage>0) { 
RDebugUtils.currentLine=9109506;
 //BA.debugLineNum = 9109506;BA.debugLine="showTutorialPage(tutorialPage - 1)";
...
RDebugUtils.currentLine=9043968;
 //BA.debugLineNum = 9043968;BA.debugLine="Sub btnNext_Click";
RDebugUtils.currentLine=9043969;
 //BA.debugLineNum = 9043969;BA.debugLine="If tutorialPage < 23 Then";
if (_tutorialpage<23) { 
RDebugUtils.currentLine=9043970;
 //BA.debugLineNum = 9043970;BA.debugLine="showTutorialPage(tutorialPage + 1)";
_showtutorialpage((int) (_tutorialpage+1));
 }else {
RDebugUtils.currentLine=9043972;
 //BA.debugLineNum = 9043972;BA.debugLine="If chkDontShow.Checked Then";
if (mostCurrent._chkdontshow.getChecked()) { 
RDebugUtils.currentLine=9043973;
 //BA.debugLineNum = 9043973;BA.debugLine="Starter.prefKvs.Put(\"skipTutorial\", True)";
...
RDebugUtils.currentLine=9043975;
 //BA.debugLineNum = 9043975;BA.debugLine="StartActivity(MainActivity)";
...
RDebugUtils.currentLine=9043976;
 //BA.debugLineNum = 9043976;BA.debugLine="Activity.Finish";
