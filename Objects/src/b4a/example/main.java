...
vis = vis | (tutorialactivity.mostCurrent != null);
vis = vis | (leaderboard.mostCurrent != null);
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 ...
 {
            Activity __a = null;
            if (tutorialactivity.previousOne != null) {
				__a = tutorialactivity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(tutorialactivity.mostCurrent == null ? null : tutorialactivity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (leaderboard.previousOne != null) {
				__a = leaderboard.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(leaderboard.mostCurrent == null ? null : leaderboard.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (home_activity.previousOne != null) {
				__a = home_activity.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(home_activity.mostCurrent == null ? null : home_activity.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=4784137;
 //BA.debugLineNum = 4784137;BA.debugLine="StartActivity(Home_Activity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(parent.mostCurrent._home_activity.getObject()));
RDebugUtils.currentLine=4784138;
 //BA.debugLineNum = 4784138;BA.debugLine="Activity.Finish";
parent.mostCurrent._activity.Finish();
RDebugUtils.currentLine=4784139;
 //BA.debugLineNum = 4784139;BA.debugLine="Return True";
if (true) {
