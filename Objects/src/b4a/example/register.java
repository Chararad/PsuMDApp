...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Please enter all fields"),anywheresoftware.b4a.keywords.Common.False);
 }else if(_email.endsWith("@gmail.com")==anywheresoftware.b4a.keywords.Common.False) { 
...
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Password must be at least 8 characters"),anywheresoftware.b4a.keywords.Common.False);
 }else if((_password).equals(_confirm) == false) { 
...
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._mainactivity.getObject()));
			...
			processBA.setLastException(e23); //BA.debugLineNum = 73;BA.debugLine="ToastMessageShow(\"Registration failed: Account";
...
mostCurrent._txtpassword_regis = new anywheresoftware.b4a.objects.EditTextWrapper();
...
mostCurrent._btneyes_regis = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private btnconfirm_pass As Button";
mostCurrent._btnconfirm_pass = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private txtconfirm_password As EditText";
mostCurrent._txtconfirm_password = new anywheresoftware.b4a.objects.EditTextWrapper();
