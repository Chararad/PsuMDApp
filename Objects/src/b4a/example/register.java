...
RDebugUtils.currentLine=8388610;
 //BA.debugLineNum = 8388610;BA.debugLine="Activity.LoadLayout(\"Register_layout\")";
mostCurrent._activity.LoadLayout("Register_layout",mostCurrent.activityBA);
RDebugUtils.currentLine=8388612;
 //BA.debugLineNum = 8388612;BA.debugLine="txtpassword_regis.PasswordMode = True";
mostCurrent._txtpassword_regis.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=8388613;
 //BA.debugLineNum = 8388613;BA.debugLine="btneyes_regis.SetBackgroundImage(LoadBitmap(File.";
...
RDebugUtils.currentLine=8781824;
 //BA.debugLineNum = 8781824;BA.debugLine="Private Sub btnback_Click";
...
RDebugUtils.currentLine=8847360;
 //BA.debugLineNum = 8847360;BA.debugLine="Private Sub btnconfirm_pass_Click";
RDebugUtils.currentLine=8847361;
 //BA.debugLineNum = 8847361;BA.debugLine="btnconfirm_pass.Height = 30dip";
mostCurrent._btnconfirm_pass.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=8847362;
 //BA.debugLineNum = 8847362;BA.debugLine="btnconfirm_pass.Width = 30dip";
mostCurrent._btnconfirm_pass.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=8847364;
 //BA.debugLineNum = 8847364;BA.debugLine="If isPasswordHidden Then";
if (_ispasswordhidden) { 
RDebugUtils.currentLine=8847365;
 //BA.debugLineNum = 8847365;BA.debugLine="txtconfirm_password.PasswordMode = False";
mostCurrent._txtconfirm_password.setPasswordMode(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=8847366;
 //BA.debugLineNum = 8847366;BA.debugLine="btnconfirm_pass.SetBackgroundImage(LoadBitmap(Fi";
...
RDebugUtils.currentLine=8847367;
 //BA.debugLineNum = 8847367;BA.debugLine="isPasswordHidden = False";
_ispasswordhidden = anywheresoftware.b4a.keywords.Common.False;
 }else {
RDebugUtils.currentLine=8847370;
 //BA.debugLineNum = 8847370;BA.debugLine="txtconfirm_password.PasswordMode = True";
...
RDebugUtils.currentLine=8847371;
 //BA.debugLineNum = 8847371;BA.debugLine="btnconfirm_pass.SetBackgroundImage(LoadBitmap(Fi";
...
RDebugUtils.currentLine=8847372;
 //BA.debugLineNum = 8847372;BA.debugLine="isPasswordHidden = True";
...
RDebugUtils.currentLine=8716288;
 //BA.debugLineNum = 8716288;BA.debugLine="Private Sub btneyes_regis_Click";
RDebugUtils.currentLine=8716289;
 //BA.debugLineNum = 8716289;BA.debugLine="btneyes_regis.Height = 30dip";
mostCurrent._btneyes_regis.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=8716290;
 //BA.debugLineNum = 8716290;BA.debugLine="btneyes_regis.Width = 30dip";
mostCurrent._btneyes_regis.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=8716292;
 //BA.debugLineNum = 8716292;BA.debugLine="If isPasswordHidden Then";
if (_ispasswordhidden) { 
RDebugUtils.currentLine=8716293;
 //BA.debugLineNum = 8716293;BA.debugLine="txtpassword_regis.PasswordMode = False";
mostCurrent._txtpassword_regis.setPasswordMode(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=8716294;
 //BA.debugLineNum = 8716294;BA.debugLine="btneyes_regis.SetBackgroundImage(LoadBitmap(File";
...
RDebugUtils.currentLine=8716295;
 //BA.debugLineNum = 8716295;BA.debugLine="isPasswordHidden = False";
_ispasswordhidden = anywheresoftware.b4a.keywords.Common.False;
 }else {
RDebugUtils.currentLine=8716298;
 //BA.debugLineNum = 8716298;BA.debugLine="txtpassword_regis.PasswordMode = True";
mostCurrent._txtpassword_regis.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=8716299;
 //BA.debugLineNum = 8716299;BA.debugLine="btneyes_regis.SetBackgroundImage(LoadBitmap(File";
mostCurrent._btneyes_regis.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"close-eye.png").getObject()));
RDebugUtils.currentLine=8716300;
 //BA.debugLineNum = 8716300;BA.debugLine="isPasswordHidden = True";
_ispasswordhidden = anywheresoftware.b4a.keywords.Common.True;
 };
...
RDebugUtils.currentLine=8650752;
 //BA.debugLineNum = 8650752;BA.debugLine="Private Sub btnlogin_Click";
RDebugUtils.currentLine=8650753;
 //BA.debugLineNum = 8650753;BA.debugLine="StartActivity(LogIn)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._login.getObject()));
RDebugUtils.currentLine=8650754;
 //BA.debugLineNum = 8650754;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
...
RDebugUtils.currentLine=8585216;
 //BA.debugLineNum = 8585216;BA.debugLine="Private Sub btnregister_Click";
RDebugUtils.currentLine=8585217;
 //BA.debugLineNum = 8585217;BA.debugLine="Dim email As String = txtemail.Text.Trim";
_email = mostCurrent._txtemail.getText().trim();
RDebugUtils.currentLine=8585218;
 //BA.debugLineNum = 8585218;BA.debugLine="Dim password As String = txtpassword_regis.Text.T";
_password = mostCurrent._txtpassword_regis.getText().trim();
RDebugUtils.currentLine=8585219;
 //BA.debugLineNum = 8585219;BA.debugLine="Dim name As String = txtname.Text.Trim";
_name = mostCurrent._txtname.getText().trim();
RDebugUtils.currentLine=8585220;
 //BA.debugLineNum = 8585220;BA.debugLine="Dim confirm As String = txtconfirm_password.Text.";
_confirm = mostCurrent._txtconfirm_password.getText().trim();
RDebugUtils.currentLine=8585222;
 //BA.debugLineNum = 8585222;BA.debugLine="If email = \"\" Or password = \"\" Or name = \"\" Or co";
if ((_email).equals("") || (_password).equals("") || (_name).equals("") || (_confirm).equals("")) { 
RDebugUtils.currentLine=8585223;
 //BA.debugLineNum = 8585223;BA.debugLine="ToastMessageShow(\"Please enter all fields\", Fals";
...
{RDebugUtils.currentLine=8585225;
 //BA.debugLineNum = 8585225;BA.debugLine="Else If email.EndsWith(\"@gmail.com\") = False Then";
if (_email.endsWith("@gmail.com")==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=8585226;
 //BA.debugLineNum = 8585226;BA.debugLine="ToastMessageShow(\"Email must be a Gmail address\"";
...
{RDebugUtils.currentLine=8585228;
 //BA.debugLineNum = 8585228;BA.debugLine="Else If password.Length < 8 Then";
if (_password.length()<8) { 
RDebugUtils.currentLine=8585229;
 //BA.debugLineNum = 8585229;BA.debugLine="ToastMessageShow(\"Password must be at least 8 ch";
...
{RDebugUtils.currentLine=8585231;
 //BA.debugLineNum = 8585231;BA.debugLine="Else If password <> confirm Then";
if ((_password).equals(_confirm) == false) { 
RDebugUtils.currentLine=8585232;
 //BA.debugLineNum = 8585232;BA.debugLine="ToastMessageShow(\"Passwords do not match\", False";
...
RDebugUtils.currentLine=8585235;
 //BA.debugLineNum = 8585235;BA.debugLine="Try";
try {RDebugUtils.currentLine=8585236;
 //BA.debugLineNum = 8585236;BA.debugLine="Starter.SQL1.ExecNonQuery2(\"INSERT INTO users (";
...
RDebugUtils.currentLine=8585238;
 //BA.debugLineNum = 8585238;BA.debugLine="ToastMessageShow(\"Registration successful\", Fal";
...
RDebugUtils.currentLine=8585250;
 //BA.debugLineNum = 8585250;BA.debugLine="If skipTutorial Then";
if (_skiptutorial) { 
RDebugUtils.currentLine=8585251;
 //BA.debugLineNum = 8585251;BA.debugLine="StartActivity(MainActivity)";
...
RDebugUtils.currentLine=8585253;
 //BA.debugLineNum = 8585253;BA.debugLine="StartActivity(tutorialActivity)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._tutorialactivity.getObject()));
 };
 } 
       catch (Exception e31) {
			processBA.setLastException(e31);RDebugUtils.currentLine=8585256;
 //BA.debugLineNum = 8585256;BA.debugLine="ToastMessageShow(\"Registration failed: Account";
