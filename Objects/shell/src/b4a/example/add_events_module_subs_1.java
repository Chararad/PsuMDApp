...
public class add_events_module_subs_1 {
...
try {
		Debug.PushSubsStack("Activity_Pause (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,64);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,52);
...
try {
		Debug.PushSubsStack("birthdayrb_CheckedChange (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,129);
...
try {
		Debug.PushSubsStack("eventrb_CheckedChange (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,133);
...
try {
		Debug.PushSubsStack("MapInitializer (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,81);
...
try {
		Debug.PushSubsStack("ooorb_CheckedChange (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,125);
...
try {
		Debug.PushSubsStack("save_btn_Click (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,99);
...
try {
		Debug.PushSubsStack("SaveCalendar (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,77);
...
try {
		Debug.PushSubsStack("taskrb_CheckedChange (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,137);
...
try {
		Debug.PushSubsStack("x_btn_Click (add_events_module) ","add_events_module",13,add_events_module.mostCurrent.activityBA,add_events_module.mostCurrent,73);
