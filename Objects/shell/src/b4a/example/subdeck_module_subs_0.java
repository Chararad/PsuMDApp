...
try {
		Debug.PushSubsStack("activerecall_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,182);
...
RemoteObject _flashacards = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 182;BA.debugLine="Private Sub activerecall_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 185;BA.debugLine="number_of_cards = 0";
Debug.ShouldStop(16777216);
subdeck_module._number_of_cards = BA.numberCast(int.class, 0);
 BA.debugLineNum = 187;BA.debugLine="Dim chosendeck As Map = alldecks.Get(selecteddeck";
...
_chosendeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._alldecks.runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._selecteddeck))));Debug.locals.put("chosendeck", _chosendeck);Debug.locals.put("chosendeck", _chosendeck);
 BA.debugLineNum = 189;BA.debugLine="For Each deckName As String In chosendeck.keys";
...
Debug.locals.put("deckName", _deckname);
 BA.debugLineNum = 190;BA.debugLine="Dim flashacards As List = chosendeck.Get(deckNam";
...
_flashacards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _chosendeck.runMethod(false,"Get",(Object)((_deckname))));Debug.locals.put("flashacards", _flashacards);Debug.locals.put("flashacards", _flashacards);
 BA.debugLineNum = 191;BA.debugLine="number_of_cards = number_of_cards + flashacards.";
...
;
 BA.debugLineNum = 194;BA.debugLine="AR_confirmationpanel.Visible = True";
Debug.ShouldStop(2);
subdeck_module.mostCurrent._ar_confirmationpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 195;BA.debugLine="confirmlabel.Text = \"You got \" & number_of_cards";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("Activity_Create (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,43);
...
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="Select Starter.themeNumber";
...
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,subdeck_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"Subdeck_ModuleLayout\")";
...
subdeck_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Subdeck_ModuleLayout")),subdeck_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 49;BA.debugLine="Activity.LoadLayout(\"Subdeck_ModuleLayoutDark\"";
...
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,subdeck_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 53;BA.debugLine="Activity.LoadLayout(\"Subdeck_ModuleLayout2\")";
...
subdeck_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Subdeck_ModuleLayout2")),subdeck_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 55;BA.debugLine="Activity.LoadLayout(\"Subdeck_ModuleLayoutDark2";
...
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,subdeck_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 59;BA.debugLine="Activity.LoadLayout(\"Subdeck_ModuleLayout3\")";
Debug.ShouldStop(67108864);
subdeck_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Subdeck_ModuleLayout3")),subdeck_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 61;BA.debugLine="Activity.LoadLayout(\"Subdeck_ModuleLayoutDark3";
Debug.ShouldStop(268435456);
...
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,subdeck_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 67;BA.debugLine="LVSubdecks.SingleLineLayout.Label.textColor = Co";
Debug.ShouldStop(4);
...
subdeck_module.mostCurrent._cc.runVoidMethod ("Initialize",(Object)(RemoteObject.createImmutable("CC")));
 BA.debugLineNum = 74;BA.debugLine="Dim radius As Int = Addbtn.Width/2";
...
_radius = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {subdeck_module.mostCurrent._addbtn.runMethod(true,"getWidth"),RemoteObject.createImmutable(2)}, "/",0, 0));Debug.locals.put("radius", _radius);Debug.locals.put("radius", _radius);
 BA.debugLineNum = 75;BA.debugLine="Dim cd As ColorDrawable";
Debug.ShouldStop(1024);
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 76;BA.debugLine="cd.Initialize(Colors.Gray, radius)";
Debug.ShouldStop(2048);
_cd.runVoidMethod ("Initialize",(Object)(subdeck_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Gray")),(Object)(_radius));
 BA.debugLineNum = 77;BA.debugLine="Addbtn.Background = cd";
Debug.ShouldStop(4096);
subdeck_module.mostCurrent._addbtn.runMethod(false,"setBackground",(_cd.getObject()));
 BA.debugLineNum = 80;BA.debugLine="decknamelabel.Text = selecteddeck";
...
subdeck_module.mostCurrent._decknamelabel.runMethod(true,"setText",BA.ObjectToCharSequence(subdeck_module.mostCurrent._selecteddeck));
 BA.debugLineNum = 83;BA.debugLine="Refresh";
...
try {
		Debug.PushSubsStack("Activity_Pause (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,110);
...
try {
		Debug.PushSubsStack("Activity_Resume (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,102);
...
Debug.ShouldStop(32);
 BA.debugLineNum = 103;BA.debugLine="If all_active_recall.praise = True Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._all_active_recall._praise /*RemoteObject*/ ,subdeck_module.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 104;BA.debugLine="all_active_recall.praise = False";
Debug.ShouldStop(128);
subdeck_module.mostCurrent._all_active_recall._praise /*RemoteObject*/  = subdeck_module.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 105;BA.debugLine="MsgboxAsync(\"You Finished Your Deck\", \"Congratul";
...
subdeck_module.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("You Finished Your Deck")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Congratulations"))),subdeck_module.processBA);
 ...
 BA.debugLineNum = 107;BA.debugLine="AR_confirmationpanel.Visible = False";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("Addbtn_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,115);
if (RapidSub.canDelegate("addbtn_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","addbtn_click");}
 BA.debugLineNum = 115;BA.debugLine="Private Sub Addbtn_Click";
Debug.ShouldStop(262144);
 BA.debugLineNum = 117;BA.debugLine="If addpanel2.Visible = False Then";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("addcard_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,125);
...
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 125;BA.debugLine="Private Sub addcard_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 127;BA.debugLine="Dim tappeddeck As Map = FlashcardActivity.deck.Ge";
Debug.ShouldStop(1073741824);
...
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 128;BA.debugLine="If tappeddeck.Size = 0 Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",_tappeddeck.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 129;BA.debugLine="MsgboxAsync(\"Create A Sub-Deck first\", \"Error\")";
Debug.ShouldStop(1);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 132;BA.debugLine="StartActivity(Add_card_module)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("addsub_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,135);
if (RapidSub.canDelegate("addsub_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","addsub_click");}
 BA.debugLineNum = 135;BA.debugLine="Private Sub addsub_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 137;BA.debugLine="addpanel.Visible = True";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("AI_cards_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,285);
if (RapidSub.canDelegate("ai_cards_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","ai_cards_click");}
 BA.debugLineNum = 285;BA.debugLine="Private Sub AI_cards_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 286;BA.debugLine="If topic_panel.Visible = True Then";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._topic_panel.runMethod(true,"getVisible"),subdeck_module.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 287;BA.debugLine="topic_panel.visible = False";
Debug.ShouldStop(1073741824);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 290;BA.debugLine="topic_panel.Visible = True";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("backbtn_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,219);
if (RapidSub.canDelegate("backbtn_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","backbtn_click");}
 BA.debugLineNum = 219;BA.debugLine="Private Sub backbtn_Click";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("cancel_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,140);
if (RapidSub.canDelegate("cancel_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancel_click");}
 BA.debugLineNum = 140;BA.debugLine="Private Sub cancel_Click";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("cancelalter_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,233);
if (RapidSub.canDelegate("cancelalter_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancelalter_click");}
 BA.debugLineNum = 233;BA.debugLine="Private Sub cancelalter_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 234;BA.debugLine="alterpanel.Visible = False";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("cancelconfirmation_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,207);
if (RapidSub.canDelegate("cancelconfirmation_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancelconfirmation_click");}
 BA.debugLineNum = 207;BA.debugLine="Private Sub cancelconfirmation_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 209;BA.debugLine="AR_confirmationpanel.Visible = False";
Debug.ShouldStop(65536);
subdeck_module.mostCurrent._ar_confirmationpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("canceldelete_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,281);
if (RapidSub.canDelegate("canceldelete_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","canceldelete_click");}
 BA.debugLineNum = 281;BA.debugLine="Private Sub canceldelete_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 282;BA.debugLine="deleteconfirmation.Visible = False";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("cancelrename_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,242);
if (RapidSub.canDelegate("cancelrename_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","cancelrename_click");}
 BA.debugLineNum = 242;BA.debugLine="Private Sub cancelrename_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 243;BA.debugLine="renamepanel.Visible = False";
Debug.ShouldStop(262144);
subdeck_module.mostCurrent._renamepanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 244;BA.debugLine="renameet.Text = \"\"";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("confirmdelete_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,273);
...
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 273;BA.debugLine="Private Sub confirmdelete_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 274;BA.debugLine="Dim tappeddeck As Map = FlashcardActivity.deck.ge";
Debug.ShouldStop(131072);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 275;BA.debugLine="tappeddeck.Remove(selectedsubdeck)";
Debug.ShouldStop(262144);
_tappeddeck.runVoidMethod ("Remove",(Object)((subdeck_module._selectedsubdeck)));
 BA.debugLineNum = 276;BA.debugLine="SaveDecks";
Debug.ShouldStop(524288);
_savedecks();
 BA.debugLineNum = 277;BA.debugLine="Refresh";
Debug.ShouldStop(1048576);
_refresh();
 BA.debugLineNum = 278;BA.debugLine="deleteconfirmation.Visible = False";
Debug.ShouldStop(2097152);
subdeck_module.mostCurrent._deleteconfirmation.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("confirmrename_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,247);
...
RemoteObject _names = RemoteObject.createImmutable("");
 BA.debugLineNum = 247;BA.debugLine="Private Sub confirmrename_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 249;BA.debugLine="Dim getsubdeck As List";
Debug.ShouldStop(16777216);
...
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 251;BA.debugLine="If renameet.Text = \"\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._renameet.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 252;BA.debugLine="MsgboxAsync(\"New Name must have a name\", \"Error\"";
Debug.ShouldStop(134217728);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 255;BA.debugLine="For Each names As String In tappeddeck.keys";
Debug.ShouldStop(1073741824);
{
...
Debug.locals.put("names", _names);
 BA.debugLineNum = 256;BA.debugLine="getsubdeck = tappeddeck.Get(selectedsubdeck)";
Debug.ShouldStop(-2147483648);
_getsubdeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((subdeck_module._selectedsubdeck))));Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 257;BA.debugLine="If renameet.Text = names Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._renameet.runMethod(true,"getText"),_names)) { 
 BA.debugLineNum = 258;BA.debugLine="MsgboxAsync(\"Sub Deck Name Already Exist\", \"Err";
Debug.ShouldStop(2);
...
;
 BA.debugLineNum = 262;BA.debugLine="tappeddeck.Remove(selectedsubdeck)";
Debug.ShouldStop(32);
_tappeddeck.runVoidMethod ("Remove",(Object)((subdeck_module._selectedsubdeck)));
 BA.debugLineNum = 263;BA.debugLine="tappeddeck.Put(renameet.Text, getsubdeck)";
Debug.ShouldStop(64);
_tappeddeck.runVoidMethod ("Put",(Object)((subdeck_module.mostCurrent._renameet.runMethod(true,"getText"))),(Object)((_getsubdeck.getObject())));
 BA.debugLineNum = 264;BA.debugLine="renameet.text = \"\"";
Debug.ShouldStop(128);
subdeck_module.mostCurrent._renameet.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 265;BA.debugLine="SaveDecks";
Debug.ShouldStop(256);
_savedecks();
 BA.debugLineNum = 266;BA.debugLine="Refresh";
Debug.ShouldStop(512);
_refresh();
 BA.debugLineNum = 267;BA.debugLine="renamepanel.Visible = False";
Debug.ShouldStop(1024);
subdeck_module.mostCurrent._renamepanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 268;BA.debugLine="renamepanel.Visible = False";
Debug.ShouldStop(2048);
subdeck_module.mostCurrent._renamepanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("create_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,146);
...
RemoteObject _name = RemoteObject.declareNull("Object");
 BA.debugLineNum = 146;BA.debugLine="Private Sub create_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 149;BA.debugLine="Dim tappeddeck As Map = alldecks.Get(selecteddeck";
Debug.ShouldStop(1048576);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._alldecks.runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._selecteddeck))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 150;BA.debugLine="Dim flashcards As List";
Debug.ShouldStop(2097152);
_flashcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("flashcards", _flashcards);
 BA.debugLineNum = 152;BA.debugLine="flashcards.initialize";
Debug.ShouldStop(8388608);
_flashcards.runVoidMethod ("Initialize");
 BA.debugLineNum = 155;BA.debugLine="For Each name In tappeddeck.Keys";
Debug.ShouldStop(67108864);
{
...
Debug.locals.put("name", _name);
 BA.debugLineNum = 156;BA.debugLine="If et1.Text = name Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._et1.runMethod(true,"getText"),BA.ObjectToString(_name))) { 
 BA.debugLineNum = 157;BA.debugLine="MsgboxAsync(\"Sub-Deck Already Exist\", \"Error\")";
Debug.ShouldStop(268435456);
...
;
 BA.debugLineNum = 163;BA.debugLine="If et1.Text = \"\" Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._et1.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 164;BA.debugLine="MsgboxAsync(\"Sub-Deck must have a name\", \"Error\"";
Debug.ShouldStop(8);
subdeck_module.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Sub-Deck must have a name")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),subdeck_module.processBA);
 ...
 BA.debugLineNum = 167;BA.debugLine="addpanel.Visible = False";
Debug.ShouldStop(64);
subdeck_module.mostCurrent._addpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 168;BA.debugLine="LVSubdecks.AddSingleLine(et1.Text)";
Debug.ShouldStop(128);
subdeck_module.mostCurrent._lvsubdecks.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(subdeck_module.mostCurrent._et1.runMethod(true,"getText"))));
 BA.debugLineNum = 169;BA.debugLine="tappeddeck.Put(et1.Text, flashcards)";
Debug.ShouldStop(256);
_tappeddeck.runVoidMethod ("Put",(Object)((subdeck_module.mostCurrent._et1.runMethod(true,"getText"))),(Object)((_flashcards.getObject())));
 BA.debugLineNum = 170;BA.debugLine="SaveDecks";
Debug.ShouldStop(512);
_savedecks();
 BA.debugLineNum = 172;BA.debugLine="et1.Text = \"\"";
Debug.ShouldStop(2048);
subdeck_module.mostCurrent._et1.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 };
...
try {
		Debug.PushSubsStack("deletesubdeck_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,223);
if (RapidSub.canDelegate("deletesubdeck_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","deletesubdeck_click");}
 BA.debugLineNum = 223;BA.debugLine="Private Sub deletesubdeck_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 224;BA.debugLine="alterpanel.Visible = False";
Debug.ShouldStop(-2147483648);
subdeck_module.mostCurrent._alterpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 225;BA.debugLine="deleteconfirmation.Visible = True";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("GenerateFlashCards (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,323);
...
Debug.locals.put("Topic", _topic);
 BA.debugLineNum = 323;BA.debugLine="Sub GenerateFlashCards(Topic As String)";
Debug.ShouldStop(4);
 BA.debugLineNum = 325;BA.debugLine="Dim URL As String = \"https://generativelanguage.g";
Debug.ShouldStop(16);
...
_job = RemoteObject.createNew ("b4a.example.httpjob");Debug.locals.put("Job", _job);
 BA.debugLineNum = 328;BA.debugLine="Job.Initialize(\"Gemini\", Me)";
Debug.ShouldStop(128);
_job.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,subdeck_module.processBA,(Object)(BA.ObjectToString("Gemini")),(Object)(subdeck_module.getObject()));
 BA.debugLineNum = 330;BA.debugLine="Dim prompt As String = _ 	\"Create flashcards from";
Debug.ShouldStop(512);
...
_contentitem = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("contentItem", _contentitem);
 BA.debugLineNum = 355;BA.debugLine="contentItem.Initialize";
Debug.ShouldStop(4);
_contentitem.runVoidMethod ("Initialize");
 BA.debugLineNum = 357;BA.debugLine="Dim parts As List";
Debug.ShouldStop(16);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 358;BA.debugLine="parts.Initialize";
Debug.ShouldStop(32);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 360;BA.debugLine="Dim textPart As Map";
Debug.ShouldStop(128);
_textpart = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("textPart", _textpart);
 BA.debugLineNum = 361;BA.debugLine="textPart.Initialize";
Debug.ShouldStop(256);
_textpart.runVoidMethod ("Initialize");
 BA.debugLineNum = 363;BA.debugLine="textPart.Put(\"text\", prompt)";
Debug.ShouldStop(1024);
_textpart.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("text"))),(Object)((_prompt)));
 BA.debugLineNum = 364;BA.debugLine="parts.Add(textPart)";
Debug.ShouldStop(2048);
_parts.runVoidMethod ("Add",(Object)((_textpart.getObject())));
 BA.debugLineNum = 366;BA.debugLine="contentItem.Put(\"parts\", parts)";
Debug.ShouldStop(8192);
_contentitem.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("parts"))),(Object)((_parts.getObject())));
 BA.debugLineNum = 367;BA.debugLine="contents.Add(contentItem)";
Debug.ShouldStop(16384);
_contents.runVoidMethod ("Add",(Object)((_contentitem.getObject())));
 BA.debugLineNum = 368;BA.debugLine="root.Put(\"contents\", contents)";
Debug.ShouldStop(32768);
_root.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("contents"))),(Object)((_contents.getObject())));
 BA.debugLineNum = 370;BA.debugLine="Dim gen As JSONGenerator";
Debug.ShouldStop(131072);
_gen = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator");Debug.locals.put("gen", _gen);
 BA.debugLineNum = 371;BA.debugLine="gen.Initialize(root)";
Debug.ShouldStop(262144);
_gen.runVoidMethod ("Initialize",(Object)(_root));
 BA.debugLineNum = 373;BA.debugLine="Dim json As String = gen.ToString";
Debug.ShouldStop(1048576);
_json = _gen.runMethod(true,"ToString");Debug.locals.put("json", _json);Debug.locals.put("json", _json);
 BA.debugLineNum = 375;BA.debugLine="Log(\"REQUEST: \")";
Debug.ShouldStop(4194304);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329163572",RemoteObject.createImmutable("REQUEST: "),0);
 BA.debugLineNum = 376;BA.debugLine="Log(json)";
Debug.ShouldStop(8388608);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329163573",_json,0);
 BA.debugLineNum = 378;BA.debugLine="Job.PostString(URL, json)";
Debug.ShouldStop(33554432);
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_url),(Object)(_json));
 BA.debugLineNum = 379;BA.debugLine="Job.GetRequest.SetContentType(\"application/json\")";
Debug.ShouldStop(67108864);
...
subdeck_module.mostCurrent._pickpdfbtn = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 39;BA.debugLine="Dim MyAPIKey As String = \"AIzaSyDvUpRQYW6yGQ8q7A5";
subdeck_module.mostCurrent._myapikey = BA.ObjectToString("AIzaSyDvUpRQYW6yGQ8q7A5ZsyZYTLwtAkfofg8");
 //BA.debugLineNum = 40;BA.debugLine="Dim AIGlobalText As String";
...
try {
		Debug.PushSubsStack("goback_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,177);
if (RapidSub.canDelegate("goback_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","goback_click");}
 BA.debugLineNum = 177;BA.debugLine="Private Sub goback_Click";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("JobDone (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,384);
...
Debug.locals.put("job", _job);
 BA.debugLineNum = 384;BA.debugLine="Sub JobDone (job As HttpJob)";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 385;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(1);
subdeck_module.mostCurrent.__c.runVoidMethod ("ProgressDialogHide");
 BA.debugLineNum = 386;BA.debugLine="If job.Success Then";
Debug.ShouldStop(2);
if (_job.getField(true,"_success" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 388;BA.debugLine="Dim response As String = job.GetString";
Debug.ShouldStop(8);
_response = _job.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ );Debug.locals.put("response", _response);Debug.locals.put("response", _response);
 BA.debugLineNum = 389;BA.debugLine="Log(response)";
Debug.ShouldStop(16);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329229061",_response,0);
 BA.debugLineNum = 391;BA.debugLine="Dim jp As JSONParser";
Debug.ShouldStop(64);
_jp = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("jp", _jp);
 BA.debugLineNum = 392;BA.debugLine="jp.Initialize(response)";
Debug.ShouldStop(128);
_jp.runVoidMethod ("Initialize",(Object)(_response));
 BA.debugLineNum = 394;BA.debugLine="Dim root As Map = jp.NextObject";
Debug.ShouldStop(512);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _jp.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 395;BA.debugLine="Dim candidates As List = root.Get(\"candidates\")";
Debug.ShouldStop(1024);
...
_candidates = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("candidates")))));Debug.locals.put("candidates", _candidates);Debug.locals.put("candidates", _candidates);
 BA.debugLineNum = 396;BA.debugLine="Dim candidate As Map = candidates.Get(0)";
Debug.ShouldStop(2048);
...
_candidate = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _candidates.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("candidate", _candidate);Debug.locals.put("candidate", _candidate);
 BA.debugLineNum = 397;BA.debugLine="Dim content As Map = candidate.Get(\"content\")";
Debug.ShouldStop(4096);
...
_content = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _candidate.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("content")))));Debug.locals.put("content", _content);Debug.locals.put("content", _content);
 BA.debugLineNum = 398;BA.debugLine="Dim parts As List = content.Get(\"parts\")";
Debug.ShouldStop(8192);
...
_parts = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _content.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("parts")))));Debug.locals.put("parts", _parts);Debug.locals.put("parts", _parts);
 BA.debugLineNum = 399;BA.debugLine="Dim firstPart As Map = parts.Get(0)";
Debug.ShouldStop(16384);
...
_firstpart = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _parts.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("firstPart", _firstpart);Debug.locals.put("firstPart", _firstpart);
 BA.debugLineNum = 401;BA.debugLine="Dim aiText As String = firstPart.Get(\"text\")";
Debug.ShouldStop(65536);
_aitext = BA.ObjectToString(_firstpart.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("text")))));Debug.locals.put("aiText", _aitext);Debug.locals.put("aiText", _aitext);
 BA.debugLineNum = 402;BA.debugLine="AIGlobalText = aiText";
Debug.ShouldStop(131072);
subdeck_module.mostCurrent._aiglobaltext = _aitext;
 BA.debugLineNum = 404;BA.debugLine="File.WriteString(File.DirInternal, \"cached_ai.tx";
Debug.ShouldStop(524288);
subdeck_module.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(subdeck_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("cached_ai.txt")),(Object)(_aitext));
 BA.debugLineNum = 406;BA.debugLine="Dim flashcards As List = ParseFlashcard(aiText)";
Debug.ShouldStop(2097152);
...
_flashcards = _parseflashcard(_aitext);Debug.locals.put("flashcards", _flashcards);Debug.locals.put("flashcards", _flashcards);
 BA.debugLineNum = 408;BA.debugLine="Dim tappeddeck As Map = FlashcardActivity.deck.G";
Debug.ShouldStop(8388608);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 410;BA.debugLine="LVSubdecks.AddSingleLine(topic_et.Text)";
Debug.ShouldStop(33554432);
subdeck_module.mostCurrent._lvsubdecks.runVoidMethod ("AddSingleLine",(Object)(BA.ObjectToCharSequence(subdeck_module.mostCurrent._topic_et.runMethod(true,"getText"))));
 BA.debugLineNum = 411;BA.debugLine="tappeddeck.Put(topic_et.Text, flashcards)";
Debug.ShouldStop(67108864);
_tappeddeck.runVoidMethod ("Put",(Object)((subdeck_module.mostCurrent._topic_et.runMethod(true,"getText"))),(Object)((_flashcards.getObject())));
 BA.debugLineNum = 412;BA.debugLine="topic_et.Text = \"\"";
Debug.ShouldStop(134217728);
subdeck_module.mostCurrent._topic_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 413;BA.debugLine="SaveDecks";
Debug.ShouldStop(268435456);
_savedecks();
 }else {
 BA.debugLineNum = 416;BA.debugLine="Log(job.ErrorMessage)";
Debug.ShouldStop(-2147483648);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329229088",_job.getField(true,"_errormessage" /*RemoteObject*/ ),0);
 BA.debugLineNum = 417;BA.debugLine="Msgbox(\"Error making your AI Flashcards\", \"Error";
Debug.ShouldStop(1);
subdeck_module.mostCurrent.__c.runVoidMethodAndSync ("Msgbox",(Object)(BA.ObjectToCharSequence("Error making your AI Flashcards")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),subdeck_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 420;BA.debugLine="job.Release";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("LVSubdecks_ItemClick (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,212);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 212;BA.debugLine="Private Sub LVSubdecks_ItemClick (Position As Int,";
Debug.ShouldStop(524288);
 BA.debugLineNum = 214;BA.debugLine="selectedsubdeck = Value 'gives the chsoen subdeck";
Debug.ShouldStop(2097152);
subdeck_module._selectedsubdeck = BA.ObjectToString(_value);
 BA.debugLineNum = 216;BA.debugLine="StartActivity(Card_Module)";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("LVSubdecks_ItemLongClick (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,237);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 237;BA.debugLine="Private Sub LVSubdecks_ItemLongClick (Position As";
Debug.ShouldStop(4096);
 BA.debugLineNum = 238;BA.debugLine="alterpanel.Visible = True";
Debug.ShouldStop(8192);
subdeck_module.mostCurrent._alterpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 239;BA.debugLine="selectedsubdeck = Value";
Debug.ShouldStop(16384);
subdeck_module._selectedsubdeck = BA.ObjectToString(_value);
...
try {
		Debug.PushSubsStack("ParseFlashcard (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,424);
...
Debug.locals.put("jsonText", _jsontext);
 BA.debugLineNum = 424;BA.debugLine="Sub ParseFlashcard (jsonText As String) As List";
Debug.ShouldStop(128);
 BA.debugLineNum = 426;BA.debugLine="Dim flashcard As List";
Debug.ShouldStop(512);
_flashcard = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("flashcard", _flashcard);
 BA.debugLineNum = 427;BA.debugLine="flashcard.Initialize";
Debug.ShouldStop(1024);
_flashcard.runVoidMethod ("Initialize");
 BA.debugLineNum = 428;BA.debugLine="Try";
Debug.ShouldStop(2048);
try { BA.debugLineNum = 430;BA.debugLine="Dim jp As JSONParser";
Debug.ShouldStop(8192);
_jp = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("jp", _jp);
 BA.debugLineNum = 431;BA.debugLine="jp.Initialize(jsonText)";
Debug.ShouldStop(16384);
_jp.runVoidMethod ("Initialize",(Object)(_jsontext));
 BA.debugLineNum = 433;BA.debugLine="Dim root As Map = jp.NextObject";
Debug.ShouldStop(65536);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _jp.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 435;BA.debugLine="Dim flashcards As List = root.Get(\"flashcards\")";
Debug.ShouldStop(262144);
_flashcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_flashcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("flashcards")))));Debug.locals.put("flashcards", _flashcards);Debug.locals.put("flashcards", _flashcards);
 BA.debugLineNum = 437;BA.debugLine="For Each card As Map In flashcards";
Debug.ShouldStop(1048576);
...
Debug.locals.put("card", _card);
 BA.debugLineNum = 439;BA.debugLine="Dim cards As Map";
Debug.ShouldStop(4194304);
_cards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("cards", _cards);
 BA.debugLineNum = 440;BA.debugLine="cards.initialize";
Debug.ShouldStop(8388608);
_cards.runVoidMethod ("Initialize");
 BA.debugLineNum = 442;BA.debugLine="Dim question As String = card.Get(\"question\")";
Debug.ShouldStop(33554432);
_question = BA.ObjectToString(_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("question")))));Debug.locals.put("question", _question);Debug.locals.put("question", _question);
 BA.debugLineNum = 444;BA.debugLine="Dim answer As String = card.Get(\"answer\")";
Debug.ShouldStop(134217728);
_answer = BA.ObjectToString(_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("answer")))));Debug.locals.put("answer", _answer);Debug.locals.put("answer", _answer);
 BA.debugLineNum = 446;BA.debugLine="cards.Put(\"Q\", question)";
Debug.ShouldStop(536870912);
_cards.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Q"))),(Object)((_question)));
 BA.debugLineNum = 447;BA.debugLine="cards.Put(\"A\", answer)";
Debug.ShouldStop(1073741824);
_cards.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("A"))),(Object)((_answer)));
 BA.debugLineNum = 448;BA.debugLine="flashcard.Add(cards)";
Debug.ShouldStop(-2147483648);
_flashcard.runVoidMethod ("Add",(Object)((_cards.getObject())));
 BA.debugLineNum = 450;BA.debugLine="Log(\"===================\")";
Debug.ShouldStop(2);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329294618",RemoteObject.createImmutable("==================="),0);
 BA.debugLineNum = 451;BA.debugLine="Log(\"QUESTION: \" & question)";
Debug.ShouldStop(4);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329294619",RemoteObject.concat(RemoteObject.createImmutable("QUESTION: "),_question),0);
 BA.debugLineNum = 452;BA.debugLine="Log(\"ANSWER: \" & answer)";
Debug.ShouldStop(8);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329294620",RemoteObject.concat(RemoteObject.createImmutable("ANSWER: "),_answer),0);
 }
}Debug.locals.put("card", _card);
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",subdeck_module.processBA, e21.toString()); BA.debugLineNum = 458;BA.debugLine="Log(\"INVALID JSON\")";
Debug.ShouldStop(512);
subdeck_module.mostCurrent.__c.runVoidMethod ("LogImpl","329294626",RemoteObject.createImmutable("INVALID JSON"),0);
 };
 BA.debugLineNum = 463;BA.debugLine="Return flashcard";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("Refresh (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,91);
if (RapidSub.canDelegate("refresh")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","refresh");}
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
RemoteObject _deckname = RemoteObject.createImmutable("");
 BA.debugLineNum = 91;BA.debugLine="Sub Refresh";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 92;BA.debugLine="LVSubdecks.clear";
Debug.ShouldStop(134217728);
subdeck_module.mostCurrent._lvsubdecks.runVoidMethod ("Clear");
 BA.debugLineNum = 94;BA.debugLine="Dim tappeddeck As Map = alldecks.Get(selecteddeck";
Debug.ShouldStop(536870912);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._alldecks.runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._selecteddeck))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 97;BA.debugLine="For Each deckName As String In tappeddeck.keys";
Debug.ShouldStop(1);
{
...
_deckname = BA.ObjectToString(group3.runMethod(false,"Get",index3));Debug.locals.put("deckName", _deckname);
Debug.locals.put("deckName", _deckname);
 BA.debugLineNum = 98;BA.debugLine="LVSubdecks.AddSingleLine(deckName)";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("renamesubdeck_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,228);
if (RapidSub.canDelegate("renamesubdeck_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","renamesubdeck_click");}
 BA.debugLineNum = 228;BA.debugLine="Private Sub renamesubdeck_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 229;BA.debugLine="alterpanel.Visible = False";
Debug.ShouldStop(16);
subdeck_module.mostCurrent._alterpanel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 230;BA.debugLine="renamepanel.visible = True";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("SaveDecks (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,87);
if (RapidSub.canDelegate("savedecks")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","savedecks");}
 BA.debugLineNum = 87;BA.debugLine="Sub SaveDecks";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 88;BA.debugLine="FlashcardActivity.kvs.Put(\"deck_data\", FlashcardA";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("startArbtn_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,198);
if (RapidSub.canDelegate("startarbtn_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","startarbtn_click");}
 BA.debugLineNum = 198;BA.debugLine="Private Sub startArbtn_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 200;BA.debugLine="If number_of_cards = 0 Then";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",subdeck_module._number_of_cards,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 201;BA.debugLine="MsgboxAsync(\"No cards available\", \"Error\")";
Debug.ShouldStop(256);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 204;BA.debugLine="StartActivity(all_active_recall)";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("topic_btn_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,300);
...
RemoteObject _tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
RemoteObject _names = RemoteObject.createImmutable("");
 BA.debugLineNum = 300;BA.debugLine="Private Sub topic_btn_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 301;BA.debugLine="If topic_et.Text = \"\" Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._topic_et.runMethod(true,"getText"),BA.ObjectToString(""))) { 
 BA.debugLineNum = 302;BA.debugLine="Msgbox(\"Invalid Subdeck Topic\", \"Error\")";
Debug.ShouldStop(8192);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 306;BA.debugLine="Dim getsubdeck As List";
Debug.ShouldStop(131072);
_getsubdeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 307;BA.debugLine="Dim tappeddeck As Map = FlashcardActivity.deck.Ge";
Debug.ShouldStop(262144);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), subdeck_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((subdeck_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappeddeck", _tappeddeck);Debug.locals.put("tappeddeck", _tappeddeck);
 BA.debugLineNum = 308;BA.debugLine="For Each names As String In tappeddeck.keys";
Debug.ShouldStop(524288);
{
final RemoteObject group7 = _tappeddeck.runMethod(false,"Keys");
final int groupLen7 = group7.runMethod(true,"getSize").<Integer>get()
...
_names = BA.ObjectToString(group7.runMethod(false,"Get",index7));Debug.locals.put("names", _names);
Debug.locals.put("names", _names);
 BA.debugLineNum = 309;BA.debugLine="getsubdeck = tappeddeck.Get(selectedsubdeck)";
Debug.ShouldStop(1048576);
_getsubdeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((subdeck_module._selectedsubdeck))));Debug.locals.put("getsubdeck", _getsubdeck);
 BA.debugLineNum = 310;BA.debugLine="If topic_et.Text = names Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("=",subdeck_module.mostCurrent._topic_et.runMethod(true,"getText"),_names)) { 
 BA.debugLineNum = 311;BA.debugLine="MsgboxAsync(\"Sub Deck Name Already Exist\", \"Err";
Debug.ShouldStop(4194304);
subdeck_module.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("Sub Deck Name Already Exist")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Error"))),subdeck_module.processBA);
...
;
 BA.debugLineNum = 316;BA.debugLine="ProgressDialogShow(\"Generating Flashcards...\")";
Debug.ShouldStop(134217728);
subdeck_module.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",subdeck_module.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Generating Flashcards..."))));
 BA.debugLineNum = 318;BA.debugLine="GenerateFlashCards(topic_et.Text)";
Debug.ShouldStop(536870912);
_generateflashcards(subdeck_module.mostCurrent._topic_et.runMethod(true,"getText"));
 BA.debugLineNum = 320;BA.debugLine="topic_panel.Visible = False";
Debug.ShouldStop(-2147483648);
subdeck_module.mostCurrent._topic_panel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("topic_cancel_Click (subdeck_module) ","subdeck_module",21,subdeck_module.mostCurrent.activityBA,subdeck_module.mostCurrent,295);
if (RapidSub.canDelegate("topic_cancel_click")) { return b4a.example.subdeck_module.remoteMe.runUserSub(false, "subdeck_module","topic_cancel_click");}
 BA.debugLineNum = 295;BA.debugLine="Private Sub topic_cancel_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 296;BA.debugLine="topic_panel.Visible = False";
Debug.ShouldStop(128);
subdeck_module.mostCurrent._topic_panel.runMethod(true,"setVisible",subdeck_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 297;BA.debugLine="topic_et.Text = \"\"";
Debug.ShouldStop(256);
subdeck_module.mostCurrent._topic_et.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
