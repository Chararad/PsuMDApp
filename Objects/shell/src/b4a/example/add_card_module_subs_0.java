...
try {
		Debug.PushSubsStack("Activity_Pause (add_card_module) ","add_card_module",10,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,60);
...
try {
		Debug.PushSubsStack("Activity_Resume (add_card_module) ","add_card_module",10,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,56);
...
try {
		Debug.PushSubsStack("backbtn_Click (add_card_module) ","add_card_module",10,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,105);
...
try {
		Debug.PushSubsStack("SaveCard_Click (add_card_module) ","add_card_module",10,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,68);
...
try {
		Debug.PushSubsStack("SaveDecks (add_card_module) ","add_card_module",10,add_card_module.mostCurrent.activityBA,add_card_module.mostCurrent,63);
