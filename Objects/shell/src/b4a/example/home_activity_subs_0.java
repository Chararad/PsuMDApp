...
try {
		Debug.PushSubsStack("Activity_Create (home_activity) ","home_activity",8,home_activity.mostCurrent.activityBA,home_activity.mostCurrent,16);
...
try {
		Debug.PushSubsStack("Activity_Pause (home_activity) ","home_activity",8,home_activity.mostCurrent.activityBA,home_activity.mostCurrent,24);
...
try {
		Debug.PushSubsStack("Activity_Resume (home_activity) ","home_activity",8,home_activity.mostCurrent.activityBA,home_activity.mostCurrent,20);
...
try {
		Debug.PushSubsStack("btnCreateAcc_Click (home_activity) ","home_activity",8,home_activity.mostCurrent.activityBA,home_activity.mostCurrent,33);
...
try {
		Debug.PushSubsStack("btnLogin_Click (home_activity) ","home_activity",8,home_activity.mostCurrent.activityBA,home_activity.mostCurrent,28);
