...
try {
		Debug.PushSubsStack("Activity_Create (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,26);
...
try {
		Debug.PushSubsStack("Activity_Pause (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,104);
...
try {
		Debug.PushSubsStack("Activity_Resume (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,100);
...
try {
		Debug.PushSubsStack("backbtn_Click (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,123);
...
try {
		Debug.PushSubsStack("goback_Click (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,150);
...
try {
		Debug.PushSubsStack("nextbtn_Click (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,134);
...
try {
		Debug.PushSubsStack("showAnswerbtn_Click (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,109);
...
try {
		Debug.PushSubsStack("Showcard (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,92);
...
try {
		Debug.PushSubsStack("ShowProgress (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,73);
...
try {
		Debug.PushSubsStack("ShuffleCards (all_active_recall) ","all_active_recall",7,all_active_recall.mostCurrent.activityBA,all_active_recall.mostCurrent,81);
