...
try {
		Debug.PushSubsStack("nextSong (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,101);
if (RapidSub.canDelegate("nextsong")) { return b4a.example.musicservice.remoteMe.runUserSub(false, "musicservice","nextsong");}
 BA.debugLineNum = 101;BA.debugLine="Sub nextSong";
Debug.ShouldStop(16);
 BA.debugLineNum = 102;BA.debugLine="currentSong = currentSong + 1";
Debug.ShouldStop(32);
musicservice._currentsong = RemoteObject.solve(new RemoteObject[] {musicservice._currentsong,RemoteObject.createImmutable(1)}, "+",1, 1);
 BA.debugLineNum = 103;BA.debugLine="If currentSong >= musicPlaylist.Size Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("g",musicservice._currentsong,BA.numberCast(double.class, musicservice._musicplaylist.runMethod(true,"getSize")))) { 
 BA.debugLineNum = 104;BA.debugLine="currentSong = 0";
Debug.ShouldStop(128);
musicservice._currentsong = BA.numberCast(int.class, 0);
 };
 BA.debugLineNum = 106;BA.debugLine="playSong";
...
try {
		Debug.PushSubsStack("pauseToggle (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,52);
...
try {
		Debug.PushSubsStack("playSong (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,65);
if (RapidSub.canDelegate("playsong")) { return b4a.example.musicservice.remoteMe.runUserSub(false, "musicservice","playsong");}
RemoteObject _trackpath = RemoteObject.createImmutable("");
RemoteObject _filename = RemoteObject.createImmutable("");
RemoteObject _uploaddir = RemoteObject.createImmutable("");
RemoteObject _uploadfile = RemoteObject.createImmutable("");
...
musicservice._mediaplayer.runVoidMethod ("Stop");
 ...
 BA.debugLineNum = 70;BA.debugLine="Dim trackPath As String";
Debug.ShouldStop(32);
_trackpath = RemoteObject.createImmutable("");Debug.locals.put("trackPath", _trackpath);
 BA.debugLineNum = 71;BA.debugLine="trackPath = musicPlaylist.Get(currentSong)";
Debug.ShouldStop(64);
_trackpath = BA.ObjectToString(musicservice._musicplaylist.runMethod(false,"Get",(Object)(musicservice._currentsong)));Debug.locals.put("trackPath", _trackpath);
 BA.debugLineNum = 73;BA.debugLine="If trackPath.StartsWith(\"tracks/\") Then";
Debug.ShouldStop(256);
if (_trackpath.runMethod(true,"startsWith",(Object)(RemoteObject.createImmutable("tracks/"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 75;BA.debugLine="Dim fileName As String";
Debug.ShouldStop(1024);
_filename = RemoteObject.createImmutable("");Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 76;BA.debugLine="fileName = trackPath.SubString(trackPath.LastInd";
Debug.ShouldStop(2048);
_filename = _trackpath.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_trackpath.runMethod(true,"lastIndexOf",(Object)(RemoteObject.createImmutable("/"))),RemoteObject.createImmutable(1)}, "+",1, 1)));Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 77;BA.debugLine="mediaPlayer.Load(File.DirInternal & \"/tracks\", f";
...
musicservice._mediaplayer.runVoidMethod ("Load",(Object)(RemoteObject.concat(musicservice.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal"),RemoteObject.createImmutable("/tracks"))),(Object)(_filename));
 ...
 BA.debugLineNum = 81;BA.debugLine="Dim uploadDir As String";
Debug.ShouldStop(65536);
_uploaddir = RemoteObject.createImmutable("");Debug.locals.put("uploadDir", _uploaddir);
 BA.debugLineNum = 82;BA.debugLine="Dim uploadFile As String";
Debug.ShouldStop(131072);
_uploadfile = RemoteObject.createImmutable("");Debug.locals.put("uploadFile", _uploadfile);
 BA.debugLineNum = 83;BA.debugLine="uploadDir = trackPath.SubString2(0, trackPath.La";
Debug.ShouldStop(262144);
_uploaddir = _trackpath.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(_trackpath.runMethod(true,"lastIndexOf",(Object)(RemoteObject.createImmutable("/")))));Debug.locals.put("uploadDir", _uploaddir);
 BA.debugLineNum = 84;BA.debugLine="uploadFile = trackPath.SubString(trackPath.LastI";
Debug.ShouldStop(524288);
_uploadfile = _trackpath.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_trackpath.runMethod(true,"lastIndexOf",(Object)(RemoteObject.createImmutable("/"))),RemoteObject.createImmutable(1)}, "+",1, 1)));Debug.locals.put("uploadFile", _uploadfile);
 BA.debugLineNum = 85;BA.debugLine="mediaPlayer.Load(uploadDir, uploadFile)";
Debug.ShouldStop(1048576);
musicservice._mediaplayer.runVoidMethod ("Load",(Object)(_uploaddir),(Object)(_uploadfile));
 };
 BA.debugLineNum = 88;BA.debugLine="mediaPlayer.Play";
Debug.ShouldStop(8388608);
musicservice._mediaplayer.runVoidMethod ("Play");
...
try {
		Debug.PushSubsStack("prevSong (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,109);
if (RapidSub.canDelegate("prevsong")) { return b4a.example.musicservice.remoteMe.runUserSub(false, "musicservice","prevsong");}
 BA.debugLineNum = 109;BA.debugLine="Sub prevSong";
Debug.ShouldStop(4096);
 BA.debugLineNum = 110;BA.debugLine="currentSong = currentSong - 1";
Debug.ShouldStop(8192);
musicservice._currentsong = RemoteObject.solve(new RemoteObject[] {musicservice._currentsong,RemoteObject.createImmutable(1)}, "-",1, 1);
 BA.debugLineNum = 111;BA.debugLine="If currentSong < 0 Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("<",musicservice._currentsong,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 112;BA.debugLine="currentSong = musicPlaylist.Size - 1";
...
musicservice._currentsong = RemoteObject.solve(new RemoteObject[] {musicservice._musicplaylist.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1);
 ...
 BA.debugLineNum = 114;BA.debugLine="playSong";
Debug.ShouldStop(131072);
_playsong();
...
try {
		Debug.PushSubsStack("Service_Create (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,13);
...
try {
		Debug.PushSubsStack("Service_Destroy (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,48);
...
try {
		Debug.PushSubsStack("Service_Start (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,43);
...
try {
		Debug.PushSubsStack("setSong (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,60);
...
try {
		Debug.PushSubsStack("songTimer_Tick (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,91);
if (RapidSub.canDelegate("songtimer_tick")) { return b4a.example.musicservice.remoteMe.runUserSub(false, "musicservice","songtimer_tick");}
 BA.debugLineNum = 91;BA.debugLine="Sub songTimer_Tick";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 92;BA.debugLine="If mediaPlayer.IsInitialized Then";
Debug.ShouldStop(134217728);
if (musicservice._mediaplayer.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 93;BA.debugLine="If mediaPlayer.IsPlaying = False And mediaPlayer";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",musicservice._mediaplayer.runMethod(true,"IsPlaying"),musicservice.mostCurrent.__c.getField(true,"False")) && RemoteObject.solveBoolean(">",musicservice._mediaplayer.runMethod(true,"getDuration"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 94;BA.debugLine="If mediaPlayer.Position >= mediaPlayer.Duration";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("g",musicservice._mediaplayer.runMethod(true,"getPosition"),BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {musicservice._mediaplayer.runMethod(true,"getDuration"),RemoteObject.createImmutable(100)}, "-",1, 1)))) { 
 BA.debugLineNum = 95;BA.debugLine="nextSong";
Debug.ShouldStop(1073741824);
_nextsong();
 };
 };
...
try {
		Debug.PushSubsStack("waitStarter (musicservice) ","musicservice",11,musicservice.processBA,musicservice.mostCurrent,117);
...
//C
this.state = 1;
 BA.debugLineNum = 118;BA.debugLine="Do While Starter.finishedInit = False";
Debug.ShouldStop(2097152);
if (true) break;
...
//C
this.state = 1;
 BA.debugLineNum = 119;BA.debugLine="Sleep(100)";
Debug.ShouldStop(4194304);
...
;
 if (true) break;
;
 BA.debugLineNum = 122;BA.debugLine="If mediaPlayer.IsPlaying = False Then";
Debug.ShouldStop(33554432);
...
//C
this.state = 7;
 BA.debugLineNum = 123;BA.debugLine="playSong";
Debug.ShouldStop(67108864);
_playsong();
 if (true) break;
