...
public class deck_all_cards_subs_1 {
...
try {
		Debug.PushSubsStack("Activity_Pause (deck_all_cards) ","deck_all_cards",17,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,105);
...
try {
		Debug.PushSubsStack("Activity_Resume (deck_all_cards) ","deck_all_cards",17,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,101);
...
try {
		Debug.PushSubsStack("addbtn_Click (deck_all_cards) ","deck_all_cards",17,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,110);
...
try {
		Debug.PushSubsStack("backbtn_Click (deck_all_cards) ","deck_all_cards",17,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,114);
...
try {
		Debug.PushSubsStack("ShowALLCards (deck_all_cards) ","deck_all_cards",17,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,62);
...
_p.runVoidMethod ("Initialize",deck_all_cards.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 73;BA.debugLine="p.Color = Colors.White";
Debug.ShouldStop(256);
