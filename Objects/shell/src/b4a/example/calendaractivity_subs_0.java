...
try {
		Debug.PushSubsStack("Activity_Create (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,49);
...
try {
		Debug.PushSubsStack("Activity_Pause (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,409);
...
try {
		Debug.PushSubsStack("Activity_Resume (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,405);
...
try {
		Debug.PushSubsStack("cell_click_click (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,354);
...
Debug.ShouldStop(256);
calendaractivity.mostCurrent.__c.runVoidMethod ("LogImpl","116384007",_datestr,0);
...
try {
		Debug.PushSubsStack("CleanDebugger (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,182);
...
try {
		Debug.PushSubsStack("Day_btn_Click (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,435);
...
Debug.ShouldStop(33554432);
calendaractivity.mostCurrent.__c.runVoidMethod ("LogImpl","116973831",calendaractivity.mostCurrent._day_module._currentdate /*RemoteObject*/ ,0);
 };
...
try {
		Debug.PushSubsStack("Daysinamonth (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,366);
...
try {
		Debug.PushSubsStack("DrawCalendar (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,187);
...
try {
		Debug.PushSubsStack("IdentifyColor (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,339);
...
try {
		Debug.PushSubsStack("menu_btn_Click (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,426);
...
try {
		Debug.PushSubsStack("Month_btn_Click (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,449);
...
try {
		Debug.PushSubsStack("MonthSp_ItemClick (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,414);
...
try {
		Debug.PushSubsStack("sched_btn_Click (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,430);
...
try {
		Debug.PushSubsStack("Weekday (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,387);
...
try {
		Debug.PushSubsStack("YearSP_ItemClick (calendaractivity) ","calendaractivity",14,calendaractivity.mostCurrent.activityBA,calendaractivity.mostCurrent,420);
