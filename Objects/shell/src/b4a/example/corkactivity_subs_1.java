...
public class corkactivity_subs_1 {
...
try {
		Debug.PushSubsStack("Activity_Pause (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,177);
...
try {
		Debug.PushSubsStack("Activity_Resume (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,171);
...
try {
		Debug.PushSubsStack("AddCanvas (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,251);
...
try {
		Debug.PushSubsStack("addcBtn_Click (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,360);
...
try {
		Debug.PushSubsStack("addnBtn_Click (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,349);
...
try {
		Debug.PushSubsStack("AddStickyNote (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,183);
...
Debug.ShouldStop(8388608);
corkactivity.mostCurrent.__c.runVoidMethod ("LogImpl","217170465",RemoteObject.concat(RemoteObject.createImmutable("deleteLbl initialized: "),(corkactivity.mostCurrent._deletelbl.runMethod(true,"IsInitialized"))),0);
...
try {
		Debug.PushSubsStack("canvaBtn_Click (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,382);
...
try {
		Debug.PushSubsStack("CanvasDrag_PlacedView (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,512);
...
try {
		Debug.PushSubsStack("CanvasPanel_Touch (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,286);
...
try {
		Debug.PushSubsStack("canvasWindow (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,329);
...
try {
		Debug.PushSubsStack("CC_Result (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,226);
...
try {
		Debug.PushSubsStack("colorsSpnr_ItemClick (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,416);
...
try {
		Debug.PushSubsStack("imgBtn_Click (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,378);
...
try {
		Debug.PushSubsStack("ImgDrag_PlacedView (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,488);
...
try {
		Debug.PushSubsStack("NoteDrag_PlacedView (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,464);
...
try {
		Debug.PushSubsStack("NoteText_TextChanged (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,219);
...
try {
		Debug.PushSubsStack("noteWindow (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,309);
...
try {
		Debug.PushSubsStack("penSpnr_ItemClick (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,433);
...
try {
		Debug.PushSubsStack("sizeSpnr_ItemClick (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,393);
...
try {
		Debug.PushSubsStack("stickyBtn_Click (corkactivity) ","corkactivity",16,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,370);
