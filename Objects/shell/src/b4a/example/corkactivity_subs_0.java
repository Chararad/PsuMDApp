...
try {
		Debug.PushSubsStack("Activity_Create (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,58);
...
try {
		Debug.PushSubsStack("Activity_Pause (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,180);
...
try {
		Debug.PushSubsStack("Activity_Resume (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,174);
...
try {
		Debug.PushSubsStack("AddCanvas (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,254);
...
try {
		Debug.PushSubsStack("addcBtn_Click (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,456);
if (RapidSub.canDelegate("addcbtn_click")) { return b4a.example.corkactivity.remoteMe.runUserSub(false, "corkactivity","addcbtn_click");}
 BA.debugLineNum = 456;BA.debugLine="Private Sub addcBtn_Click";
Debug.ShouldStop(128);
 BA.debugLineNum = 457;BA.debugLine="AddCanvas(150dip, 500dip)";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("addnBtn_Click (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,445);
if (RapidSub.canDelegate("addnbtn_click")) { return b4a.example.corkactivity.remoteMe.runUserSub(false, "corkactivity","addnbtn_click");}
 BA.debugLineNum = 445;BA.debugLine="Private Sub addnBtn_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 446;BA.debugLine="AddStickyNote(\"\", 150dip, 500dip)";
Debug.ShouldStop(536870912);
_addstickynote(BA.ObjectToString(""),corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 150))),corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 500))));
 BA.debugLineNum = 447;BA.debugLine="notePnl.Visible = False";
Debug.ShouldStop(1073741824);
corkactivity.mostCurrent._notepnl.runMethod(true,"setVisible",corkactivity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 448;BA.debugLine="R = 255";
Debug.ShouldStop(-2147483648);
corkactivity._r = BA.numberCast(int.class, 255);
 BA.debugLineNum = 449;BA.debugLine="G = 105";
Debug.ShouldStop(1);
corkactivity._g = BA.numberCast(int.class, 105);
 BA.debugLineNum = 450;BA.debugLine="B = 97";
Debug.ShouldStop(2);
corkactivity._b = BA.numberCast(int.class, 97);
 BA.debugLineNum = 451;BA.debugLine="stickyBtn.Enabled = True";
Debug.ShouldStop(4);
corkactivity.mostCurrent._stickybtn.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 452;BA.debugLine="canvaBtn.Enabled = True";
Debug.ShouldStop(8);
corkactivity.mostCurrent._canvabtn.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 453;BA.debugLine="imgBtn.Enabled = True";
Debug.ShouldStop(16);
corkactivity.mostCurrent._imgbtn.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"True"));
...
try {
		Debug.PushSubsStack("AddStickyNote (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,186);
...
Debug.ShouldStop(67108864);
corkactivity.mostCurrent.__c.runVoidMethod ("LogImpl","311075617",RemoteObject.concat(RemoteObject.createImmutable("deleteLbl initialized: "),(corkactivity.mostCurrent._deletelbl.runMethod(true,"IsInitialized"))),0);
...
try {
		Debug.PushSubsStack("canvaBtn_Click (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,478);
if (RapidSub.canDelegate("canvabtn_click")) { return b4a.example.corkactivity.remoteMe.runUserSub(false, "corkactivity","canvabtn_click");}
 BA.debugLineNum = 478;BA.debugLine="Private Sub canvaBtn_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 479;BA.debugLine="canvasWindow(250dip, 180dip)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("CanvasDrag_PlacedView (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,608);
...
Debug.locals.put("cPlaceView", _cplaceview);
 BA.debugLineNum = 609;BA.debugLine="If cPlaceView.Tag = \"delete\" Then";
Debug.ShouldStop(1);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 610;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete ca";
Debug.ShouldStop(2);
parent.mostCurrent.__c.runVoidMethod ("Msgbox2Async",(Object)(BA.ObjectToCharSequence("Are you sure you want to delete canvas?")),(Object)(BA.ObjectToCharSequence("Delete Canvas")),(Object)(BA.ObjectToString("No")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("Yes")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper"), parent.mostCurrent.__c.getField(false,"Null")),corkactivity.processBA,(Object)(parent.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 611;BA.debugLine="Wait For Msgbox_Result (res As Int)";
Debug.ShouldStop(4);
...
;
 BA.debugLineNum = 612;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
Debug.ShouldStop(8);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 613;BA.debugLine="Dim f As Panel = cDragView";
Debug.ShouldStop(16);
...
_f = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), _cdragview.getObject());Debug.locals.put("f", _f);Debug.locals.put("f", _f);
 BA.debugLineNum = 614;BA.debugLine="Dim key As String = f.Tag";
Debug.ShouldStop(32);
_key = BA.ObjectToString(_f.runMethod(false,"getTag"));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 615;BA.debugLine="File.Delete(File.DirInternal, key & \".png\")";
Debug.ShouldStop(64);
parent.mostCurrent.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(parent.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable(".png"))));
 BA.debugLineNum = 616;BA.debugLine="Main.kvs.Remove(key & \"_x\")";
Debug.ShouldStop(128);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_x"))));
 BA.debugLineNum = 617;BA.debugLine="Main.kvs.Remove(key & \"_y\")";
Debug.ShouldStop(256);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_y"))));
 BA.debugLineNum = 618;BA.debugLine="Main.kvs.Remove(key & \"_w\")";
Debug.ShouldStop(512);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_w"))));
 BA.debugLineNum = 619;BA.debugLine="Main.kvs.Remove(key & \"_h\")";
Debug.ShouldStop(1024);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_h"))));
 BA.debugLineNum = 620;BA.debugLine="Dim newCount As Int = Main.kvs.Get(\"cvs_count\")";
Debug.ShouldStop(2048);
_newcount = BA.numberCast(int.class, parent.mostCurrent._main._kvs /*RemoteObject*/ .runMethod(false,"_get",(Object)(RemoteObject.createImmutable("cvs_count"))));Debug.locals.put("newCount", _newcount);Debug.locals.put("newCount", _newcount);
 BA.debugLineNum = 621;BA.debugLine="Main.kvs.Put(\"cvs_count\", newCount - 1)";
Debug.ShouldStop(4096);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_put",(Object)(BA.ObjectToString("cvs_count")),(Object)((RemoteObject.solve(new RemoteObject[] {_newcount,RemoteObject.createImmutable(1)}, "-",1, 1))));
 BA.debugLineNum = 622;BA.debugLine="canvasCount = canvasCount - 1";
Debug.ShouldStop(8192);
parent._canvascount = RemoteObject.solve(new RemoteObject[] {parent._canvascount,RemoteObject.createImmutable(1)}, "-",1, 1);
 BA.debugLineNum = 623;BA.debugLine="f.Visible = False";
Debug.ShouldStop(16384);
_f.runMethod(true,"setVisible",parent.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 624;BA.debugLine="ToastMessageShow(\"Canvas Deleted\", False)";
Debug.ShouldStop(32768);
parent.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Canvas Deleted")),(Object)(parent.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 625;BA.debugLine="If canvasCount = 0 Then";
Debug.ShouldStop(65536);
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 626;BA.debugLine="penSpnr.Visible = False";
Debug.ShouldStop(131072);
parent.mostCurrent._penspnr.runMethod(true,"setVisible",parent.mostCurrent.__c.getField(true,"False"));
 if (true) break;
...
//C
this.state = 14;
 BA.debugLineNum = 630;BA.debugLine="Dim f As Panel = cDragView";
Debug.ShouldStop(2097152);
_f = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
_f = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), _cdragview.getObject());Debug.locals.put("f", _f);Debug.locals.put("f", _f);
 BA.debugLineNum = 631;BA.debugLine="Dim key As String = f.Tag";
Debug.ShouldStop(4194304);
_key = BA.ObjectToString(_f.runMethod(false,"getTag"));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 632;BA.debugLine="Main.kvs.Put(key & \"_x\", f.Left)";
Debug.ShouldStop(8388608);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_put",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_x"))),(Object)((_f.runMethod(true,"getLeft"))));
 BA.debugLineNum = 633;BA.debugLine="Main.kvs.Put(key & \"_y\", f.Top)";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("CanvasPanel_Touch (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,289);
...
try {
		Debug.PushSubsStack("canvasWindow (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,378);
...
Debug.locals.put("pH", _ph);
 BA.debugLineNum = 378;BA.debugLine="Private Sub canvasWindow(pW As Int, pH As Int)";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 379;BA.debugLine="canvasPnl = xui.CreatePanel(\"canvasPanel\")";
Debug.ShouldStop(67108864);
corkactivity.mostCurrent._canvaspnl = corkactivity._xui.runMethod(false,"CreatePanel",corkactivity.processBA,(Object)(RemoteObject.createImmutable("canvasPanel")));
 BA.debugLineNum = 380;BA.debugLine="Activity.AddView(canvasPnl, 100dip, 225dip, pW, p";
Debug.ShouldStop(134217728);
corkactivity.mostCurrent._activity.runVoidMethod ("AddView",(Object)((corkactivity.mostCurrent._canvaspnl.getObject())),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 225)))),(Object)(_pw),(Object)(_ph));
 BA.debugLineNum = 384;BA.debugLine="sizeSpnr.Initialize(\"sizeSpnr\")";
Debug.ShouldStop(-2147483648);
corkactivity.mostCurrent._sizespnr.runVoidMethod ("Initialize",corkactivity.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("sizeSpnr")));
 BA.debugLineNum = 385;BA.debugLine="sizeSpnr.AddAll(Array As String(\"1x1\", \"2x1\", \"1x";
Debug.ShouldStop(1);
corkactivity.mostCurrent._sizespnr.runVoidMethod ("AddAll",(Object)(corkactivity.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("String",new int[] {6},new Object[] {BA.ObjectToString("1x1"),BA.ObjectToString("2x1"),BA.ObjectToString("1x2"),BA.ObjectToString("2x2"),BA.ObjectToString("3x2"),RemoteObject.createImmutable("2x3")})))));
 BA.debugLineNum = 386;BA.debugLine="canvasPnl.AddView(sizeSpnr, 10dip, 10dip, pW - 20";
Debug.ShouldStop(2);
...
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("AddView",(Object)((_addcbtn.getObject())),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 60)))),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_pw,RemoteObject.createImmutable(2)}, "/",0, 0)),corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 15)))}, "-",1, 0))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 50)))));
 BA.debugLineNum = 393;BA.debugLine="canvasPnl.Enabled = False";
Debug.ShouldStop(256);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 394;BA.debugLine="canvasPnl.Visible = False";
Debug.ShouldStop(512);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setVisible",corkactivity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 396;BA.debugLine="Dim bd As BitmapDrawable";
Debug.ShouldStop(2048);
_bd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.BitmapDrawable");Debug.locals.put("bd", _bd);
 BA.debugLineNum = 397;BA.debugLine="Select Starter.themeNumber";
Debug.ShouldStop(4096);
...
case 0: {
 BA.debugLineNum = 399;BA.debugLine="If Starter.darkMode Then";
Debug.ShouldStop(16384);
if (corkactivity.mostCurrent._starter._darkmode /*RemoteObject*/ .<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 400;BA.debugLine="canvasPnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(32768);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 401;BA.debugLine="canvasPnl.SetColorAndBorder(xui.Color_White, 2";
Debug.ShouldStop(65536);
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 402;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(131072);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 403;BA.debugLine="addcBtn.Background = bd";
Debug.ShouldStop(262144);
_addcbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 404;BA.debugLine="addcBtn.TextColor = Colors.White";
Debug.ShouldStop(524288);
_addcbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 406;BA.debugLine="canvasPnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(2097152);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 407;BA.debugLine="canvasPnl.SetColorAndBorder(xui.Color_White, 2";
Debug.ShouldStop(4194304);
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 408;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(8388608);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 409;BA.debugLine="addcBtn.Background = bd";
Debug.ShouldStop(16777216);
_addcbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 410;BA.debugLine="addcBtn.TextColor = Colors.White";
Debug.ShouldStop(33554432);
_addcbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 break; }
case 1: {
 BA.debugLineNum = 413;BA.debugLine="If Starter.darkMode Then";
Debug.ShouldStop(268435456);
if (corkactivity.mostCurrent._starter._darkmode /*RemoteObject*/ .<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 414;BA.debugLine="canvasPnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(536870912);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 415;BA.debugLine="canvasPnl.SetColorAndBorder(xui.Color_White, 2";
Debug.ShouldStop(1073741824);
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 416;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(-2147483648);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 417;BA.debugLine="addcBtn.Background = bd";
Debug.ShouldStop(1);
_addcbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 418;BA.debugLine="addcBtn.TextColor = Colors.White";
Debug.ShouldStop(2);
_addcbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 420;BA.debugLine="canvasPnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(8);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 421;BA.debugLine="canvasPnl.SetColorAndBorder(xui.Color_White, 2";
Debug.ShouldStop(16);
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 422;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(32);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 423;BA.debugLine="addcBtn.Background = bd";
Debug.ShouldStop(64);
_addcbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 424;BA.debugLine="addcBtn.TextColor = Colors.White";
Debug.ShouldStop(128);
_addcbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 break; }
case 2: {
 BA.debugLineNum = 427;BA.debugLine="addcBtn.Typeface = pixeltf";
Debug.ShouldStop(1024);
_addcbtn.runMethod(false,"setTypeface",(corkactivity.mostCurrent._pixeltf.getObject()));
 BA.debugLineNum = 428;BA.debugLine="If Starter.darkMode Then";
Debug.ShouldStop(2048);
if (corkactivity.mostCurrent._starter._darkmode /*RemoteObject*/ .<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 429;BA.debugLine="canvasPnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(4096);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 430;BA.debugLine="canvasPnl.SetColorAndBorder(xui.Color_RGB(37,";
Debug.ShouldStop(8192);
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 37)),(Object)(BA.numberCast(int.class, 57)),(Object)(BA.numberCast(int.class, 94)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 431;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(16384);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 432;BA.debugLine="addcBtn.Background = bd";
Debug.ShouldStop(32768);
_addcbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 433;BA.debugLine="addcBtn.TextColor = Colors.White";
Debug.ShouldStop(65536);
_addcbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 435;BA.debugLine="canvasPnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(262144);
corkactivity.mostCurrent._canvaspnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 436;BA.debugLine="canvasPnl.SetColorAndBorder(xui.Color_RGB(234,";
Debug.ShouldStop(524288);
corkactivity.mostCurrent._canvaspnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 234)),(Object)(BA.numberCast(int.class, 212)),(Object)(BA.numberCast(int.class, 179)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 79)),(Object)(BA.numberCast(int.class, 46)),(Object)(BA.numberCast(int.class, 46)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 437;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(1048576);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 438;BA.debugLine="addcBtn.Background = bd";
Debug.ShouldStop(2097152);
_addcbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 439;BA.debugLine="addcBtn.TextColor = Colors.White";
Debug.ShouldStop(4194304);
_addcbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 break; }
...
try {
		Debug.PushSubsStack("CC_Result (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,229);
...
try {
		Debug.PushSubsStack("colorsSpnr_ItemClick (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,512);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 512;BA.debugLine="Private Sub colorsSpnr_ItemClick (Position As Int,";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 513;BA.debugLine="Select Position";
Debug.ShouldStop(1);
switch (BA.switchObjectToInt(_position,BA.numberCast(int.class, 0),BA.numberCast(int.class, 1),BA.numberCast(int.class, 2))) {
case 0: {
 BA.debugLineNum = 515;BA.debugLine="R = 255";
Debug.ShouldStop(4);
corkactivity._r = BA.numberCast(int.class, 255);
 BA.debugLineNum = 516;BA.debugLine="G = 105";
Debug.ShouldStop(8);
corkactivity._g = BA.numberCast(int.class, 105);
 BA.debugLineNum = 517;BA.debugLine="B = 97";
Debug.ShouldStop(16);
corkactivity._b = BA.numberCast(int.class, 97);
 break; }
case 1: {
 BA.debugLineNum = 519;BA.debugLine="R = 155";
Debug.ShouldStop(64);
corkactivity._r = BA.numberCast(int.class, 155);
 BA.debugLineNum = 520;BA.debugLine="G = 190";
Debug.ShouldStop(128);
corkactivity._g = BA.numberCast(int.class, 190);
 BA.debugLineNum = 521;BA.debugLine="B = 237";
Debug.ShouldStop(256);
corkactivity._b = BA.numberCast(int.class, 237);
 break; }
case 2: {
 BA.debugLineNum = 523;BA.debugLine="R = 248";
Debug.ShouldStop(1024);
corkactivity._r = BA.numberCast(int.class, 248);
 BA.debugLineNum = 524;BA.debugLine="G = 241";
Debug.ShouldStop(2048);
corkactivity._g = BA.numberCast(int.class, 241);
 BA.debugLineNum = 525;BA.debugLine="B = 174";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("imgBtn_Click (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,474);
if (RapidSub.canDelegate("imgbtn_click")) { return b4a.example.corkactivity.remoteMe.runUserSub(false, "corkactivity","imgbtn_click");}
 BA.debugLineNum = 474;BA.debugLine="Private Sub imgBtn_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 475;BA.debugLine="imgPicker.Show(\"image/*\", \"Select a Photo\")";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("ImgDrag_PlacedView (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,584);
...
Debug.locals.put("iPlaceView", _iplaceview);
 BA.debugLineNum = 585;BA.debugLine="If iPlaceView.Tag = \"delete\" Then";
Debug.ShouldStop(256);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 586;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete im";
Debug.ShouldStop(512);
parent.mostCurrent.__c.runVoidMethod ("Msgbox2Async",(Object)(BA.ObjectToCharSequence("Are you sure you want to delete image?")),(Object)(BA.ObjectToCharSequence("Delete Image")),(Object)(BA.ObjectToString("No")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("Yes")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper"), parent.mostCurrent.__c.getField(false,"Null")),corkactivity.processBA,(Object)(parent.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 587;BA.debugLine="Wait For Msgbox_Result (res As Int)";
Debug.ShouldStop(1024);
...
_res = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(0));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 588;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
Debug.ShouldStop(2048);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 589;BA.debugLine="Dim iv As ImageView = iDragView";
Debug.ShouldStop(4096);
...
_iv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ImageViewWrapper"), _idragview.getObject());Debug.locals.put("iv", _iv);Debug.locals.put("iv", _iv);
 BA.debugLineNum = 590;BA.debugLine="Dim key As String = iv.Tag";
Debug.ShouldStop(8192);
_key = BA.ObjectToString(_iv.runMethod(false,"getTag"));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 591;BA.debugLine="File.Delete(File.DirInternal, key & \".png\")";
Debug.ShouldStop(16384);
parent.mostCurrent.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(parent.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable(".png"))));
 BA.debugLineNum = 592;BA.debugLine="Main.kvs.Remove(key & \"_file\")";
Debug.ShouldStop(32768);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_file"))));
 BA.debugLineNum = 593;BA.debugLine="Main.kvs.Remove(key & \"_x\")";
Debug.ShouldStop(65536);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_x"))));
 BA.debugLineNum = 594;BA.debugLine="Main.kvs.Remove(key & \"_y\")";
Debug.ShouldStop(131072);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_y"))));
 BA.debugLineNum = 595;BA.debugLine="Dim newCount As Int = Main.kvs.Get(\"img_count\")";
Debug.ShouldStop(262144);
_newcount = BA.numberCast(int.class, parent.mostCurrent._main._kvs /*RemoteObject*/ .runMethod(false,"_get",(Object)(RemoteObject.createImmutable("img_count"))));Debug.locals.put("newCount", _newcount);Debug.locals.put("newCount", _newcount);
 BA.debugLineNum = 596;BA.debugLine="Main.kvs.Put(\"img_count\", newCount - 1)";
Debug.ShouldStop(524288);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_put",(Object)(BA.ObjectToString("img_count")),(Object)((RemoteObject.solve(new RemoteObject[] {_newcount,RemoteObject.createImmutable(1)}, "-",1, 1))));
 BA.debugLineNum = 597;BA.debugLine="iv.Visible = False";
Debug.ShouldStop(1048576);
_iv.runMethod(true,"setVisible",parent.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 598;BA.debugLine="ToastMessageShow(\"Image Deleted\", False)";
Debug.ShouldStop(2097152);
...
//C
this.state = 10;
 BA.debugLineNum = 601;BA.debugLine="Dim iv As ImageView = iDragView";
Debug.ShouldStop(16777216);
_iv = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");
_iv = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ImageViewWrapper"), _idragview.getObject());Debug.locals.put("iv", _iv);Debug.locals.put("iv", _iv);
 BA.debugLineNum = 602;BA.debugLine="Dim key As String = iv.Tag";
Debug.ShouldStop(33554432);
_key = BA.ObjectToString(_iv.runMethod(false,"getTag"));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 603;BA.debugLine="Main.kvs.Put(key & \"_x\", iv.Left)";
Debug.ShouldStop(67108864);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_put",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_x"))),(Object)((_iv.runMethod(true,"getLeft"))));
 BA.debugLineNum = 604;BA.debugLine="Main.kvs.Put(key & \"_y\", iv.Top)";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("NoteDrag_PlacedView (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,560);
...
Debug.locals.put("nPlaceView", _nplaceview);
 BA.debugLineNum = 561;BA.debugLine="If nPlaceView.Tag = \"delete\" Then";
Debug.ShouldStop(65536);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 562;BA.debugLine="Msgbox2Async(\"Are you sure you want to delete no";
Debug.ShouldStop(131072);
parent.mostCurrent.__c.runVoidMethod ("Msgbox2Async",(Object)(BA.ObjectToCharSequence("Are you sure you want to delete note?")),(Object)(BA.ObjectToCharSequence("Delete Note")),(Object)(BA.ObjectToString("No")),(Object)(BA.ObjectToString("")),(Object)(BA.ObjectToString("Yes")),RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper"), parent.mostCurrent.__c.getField(false,"Null")),corkactivity.processBA,(Object)(parent.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 563;BA.debugLine="Wait For Msgbox_Result (res As Int)";
Debug.ShouldStop(262144);
...
_res = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(0));Debug.locals.put("res", _res);
;
 BA.debugLineNum = 564;BA.debugLine="If res = DialogResponse.NEGATIVE Then";
Debug.ShouldStop(524288);
if (true) break;
...
//C
this.state = 7;
 BA.debugLineNum = 565;BA.debugLine="Dim p As Panel = nDragView";
Debug.ShouldStop(1048576);
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
_p = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), _ndragview.getObject());Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 566;BA.debugLine="Dim key As String = p.Tag";
Debug.ShouldStop(2097152);
_key = BA.ObjectToString(_p.runMethod(false,"getTag"));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 567;BA.debugLine="Main.kvs.Remove(key & \"_text\")";
Debug.ShouldStop(4194304);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_text"))));
 BA.debugLineNum = 568;BA.debugLine="Main.kvs.Remove(key & \"_color\")";
Debug.ShouldStop(8388608);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_color"))));
 BA.debugLineNum = 569;BA.debugLine="Main.kvs.Remove(key & \"_x\")";
Debug.ShouldStop(16777216);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_x"))));
 BA.debugLineNum = 570;BA.debugLine="Main.kvs.Remove(key & \"_y\")";
Debug.ShouldStop(33554432);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_remove",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_y"))));
 BA.debugLineNum = 571;BA.debugLine="Dim newCount As Int = Main.kvs.Get(\"note_count\"";
Debug.ShouldStop(67108864);
_newcount = BA.numberCast(int.class, parent.mostCurrent._main._kvs /*RemoteObject*/ .runMethod(false,"_get",(Object)(RemoteObject.createImmutable("note_count"))));Debug.locals.put("newCount", _newcount);Debug.locals.put("newCount", _newcount);
 BA.debugLineNum = 572;BA.debugLine="Main.kvs.Put(\"note_count\", newCount - 1)";
Debug.ShouldStop(134217728);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_put",(Object)(BA.ObjectToString("note_count")),(Object)((RemoteObject.solve(new RemoteObject[] {_newcount,RemoteObject.createImmutable(1)}, "-",1, 1))));
 BA.debugLineNum = 573;BA.debugLine="p.Visible = False";
Debug.ShouldStop(268435456);
_p.runMethod(true,"setVisible",parent.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 574;BA.debugLine="ToastMessageShow(\"Note Deleted\", False)";
Debug.ShouldStop(536870912);
...
//C
this.state = 10;
 BA.debugLineNum = 577;BA.debugLine="Dim p As Panel = nDragView";
Debug.ShouldStop(1);
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");
_p = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), _ndragview.getObject());Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 578;BA.debugLine="Dim key As String = p.Tag";
Debug.ShouldStop(2);
_key = BA.ObjectToString(_p.runMethod(false,"getTag"));Debug.locals.put("key", _key);Debug.locals.put("key", _key);
 BA.debugLineNum = 579;BA.debugLine="Main.kvs.Put(key & \"_x\", p.Left)";
Debug.ShouldStop(4);
parent.mostCurrent._main._kvs /*RemoteObject*/ .runVoidMethod ("_put",(Object)(RemoteObject.concat(_key,RemoteObject.createImmutable("_x"))),(Object)((_p.runMethod(true,"getLeft"))));
 BA.debugLineNum = 580;BA.debugLine="Main.kvs.Put(key & \"_y\", p.Top)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("NoteText_TextChanged (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,222);
...
try {
		Debug.PushSubsStack("noteWindow (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,312);
...
Debug.ShouldStop(512);
_bd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.BitmapDrawable");Debug.locals.put("bd", _bd);
 BA.debugLineNum = 331;BA.debugLine="Select Starter.themeNumber";
Debug.ShouldStop(1024);
switch (BA.switchObjectToInt(corkactivity.mostCurrent._starter._themenumber /*RemoteObject*/ ,BA.numberCast(int.class, 0),BA.numberCast(int.class, 1),BA.numberCast(int.class, 2))) {
case 0: {
 BA.debugLineNum = 333;BA.debugLine="If Starter.darkMode Then";
Debug.ShouldStop(4096);
if (corkactivity.mostCurrent._starter._darkmode /*RemoteObject*/ .<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 334;BA.debugLine="notePnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(8192);
corkactivity.mostCurrent._notepnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 335;BA.debugLine="notePnl.SetColorAndBorder(xui.Color_White, 2di";
Debug.ShouldStop(16384);
corkactivity.mostCurrent._notepnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 336;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(32768);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 337;BA.debugLine="addnBtn.Background = bd";
Debug.ShouldStop(65536);
_addnbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 338;BA.debugLine="addnBtn.TextColor = Colors.White";
Debug.ShouldStop(131072);
_addnbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 340;BA.debugLine="notePnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(524288);
corkactivity.mostCurrent._notepnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 341;BA.debugLine="notePnl.SetColorAndBorder(xui.Color_White, 2di";
Debug.ShouldStop(1048576);
corkactivity.mostCurrent._notepnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 342;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(2097152);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 343;BA.debugLine="addnBtn.Background = bd";
Debug.ShouldStop(4194304);
_addnbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 344;BA.debugLine="addnBtn.TextColor = Colors.White";
Debug.ShouldStop(8388608);
_addnbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 break; }
case 1: {
 BA.debugLineNum = 347;BA.debugLine="If Starter.darkMode Then";
Debug.ShouldStop(67108864);
if (corkactivity.mostCurrent._starter._darkmode /*RemoteObject*/ .<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 348;BA.debugLine="notePnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(134217728);
corkactivity.mostCurrent._notepnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 349;BA.debugLine="notePnl.SetColorAndBorder(xui.Color_White, 2di";
Debug.ShouldStop(268435456);
corkactivity.mostCurrent._notepnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 350;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(536870912);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 351;BA.debugLine="addnBtn.Background = bd";
Debug.ShouldStop(1073741824);
_addnbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 352;BA.debugLine="addnBtn.TextColor = Colors.White";
Debug.ShouldStop(-2147483648);
_addnbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 354;BA.debugLine="notePnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(2);
corkactivity.mostCurrent._notepnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 355;BA.debugLine="notePnl.SetColorAndBorder(xui.Color_White, 2di";
Debug.ShouldStop(4);
corkactivity.mostCurrent._notepnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.getField(true,"Color_White")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 356;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(8);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 357;BA.debugLine="addnBtn.Background = bd";
Debug.ShouldStop(16);
_addnbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 358;BA.debugLine="addnBtn.TextColor = Colors.White";
Debug.ShouldStop(32);
_addnbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 break; }
case 2: {
 BA.debugLineNum = 361;BA.debugLine="addnBtn.Typeface = pixeltf";
Debug.ShouldStop(256);
_addnbtn.runMethod(false,"setTypeface",(corkactivity.mostCurrent._pixeltf.getObject()));
 BA.debugLineNum = 362;BA.debugLine="If Starter.darkMode Then";
Debug.ShouldStop(512);
if (corkactivity.mostCurrent._starter._darkmode /*RemoteObject*/ .<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 363;BA.debugLine="notePnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(1024);
corkactivity.mostCurrent._notepnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 364;BA.debugLine="notePnl.SetColorAndBorder(xui.Color_RGB(37, 57";
Debug.ShouldStop(2048);
corkactivity.mostCurrent._notepnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 37)),(Object)(BA.numberCast(int.class, 57)),(Object)(BA.numberCast(int.class, 94)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.getField(true,"Color_Black")),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 365;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(4096);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 366;BA.debugLine="addnBtn.Background = bd";
Debug.ShouldStop(8192);
_addnbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 367;BA.debugLine="addnBtn.TextColor = Colors.White";
Debug.ShouldStop(16384);
_addnbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 369;BA.debugLine="notePnl.Color = xui.Color_RGB(50, 50, 50)";
Debug.ShouldStop(65536);
corkactivity.mostCurrent._notepnl.runMethod(true,"setColor",corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50)),(Object)(BA.numberCast(int.class, 50))));
 BA.debugLineNum = 370;BA.debugLine="notePnl.SetColorAndBorder(xui.Color_RGB(234, 2";
Debug.ShouldStop(131072);
corkactivity.mostCurrent._notepnl.runVoidMethod ("SetColorAndBorder",(Object)(corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 234)),(Object)(BA.numberCast(int.class, 212)),(Object)(BA.numberCast(int.class, 179)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(corkactivity._xui.runMethod(true,"Color_RGB",(Object)(BA.numberCast(int.class, 79)),(Object)(BA.numberCast(int.class, 46)),(Object)(BA.numberCast(int.class, 46)))),(Object)(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 3)))));
 BA.debugLineNum = 371;BA.debugLine="bd.Initialize(LoadBitmap(File.DirAssets, \"cale";
Debug.ShouldStop(262144);
_bd.runVoidMethod ("Initialize",(Object)((corkactivity.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(corkactivity.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("calendarpbtn.png"))).getObject())));
 BA.debugLineNum = 372;BA.debugLine="addnBtn.Background = bd";
Debug.ShouldStop(524288);
_addnbtn.runMethod(false,"setBackground",(_bd.getObject()));
 BA.debugLineNum = 373;BA.debugLine="addnBtn.TextColor = Colors.White";
Debug.ShouldStop(1048576);
_addnbtn.runMethod(true,"setTextColor",corkactivity.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 break; }
...
try {
		Debug.PushSubsStack("penSpnr_ItemClick (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,529);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 529;BA.debugLine="Private Sub penSpnr_ItemClick (Position As Int, Va";
Debug.ShouldStop(65536);
 BA.debugLineNum = 530;BA.debugLine="Select Position";
Debug.ShouldStop(131072);
...
case 0: {
 BA.debugLineNum = 532;BA.debugLine="R2 = 0";
Debug.ShouldStop(524288);
corkactivity._r2 = BA.numberCast(int.class, 0);
 BA.debugLineNum = 533;BA.debugLine="G2 = 0";
Debug.ShouldStop(1048576);
corkactivity._g2 = BA.numberCast(int.class, 0);
 BA.debugLineNum = 534;BA.debugLine="B2 = 0";
Debug.ShouldStop(2097152);
corkactivity._b2 = BA.numberCast(int.class, 0);
 break; }
case 1: {
 BA.debugLineNum = 536;BA.debugLine="R2 = 0";
Debug.ShouldStop(8388608);
corkactivity._r2 = BA.numberCast(int.class, 0);
 BA.debugLineNum = 537;BA.debugLine="G2 = 0";
Debug.ShouldStop(16777216);
corkactivity._g2 = BA.numberCast(int.class, 0);
 BA.debugLineNum = 538;BA.debugLine="B2 = 255";
Debug.ShouldStop(33554432);
corkactivity._b2 = BA.numberCast(int.class, 255);
 break; }
case 2: {
 BA.debugLineNum = 540;BA.debugLine="R2 = 0";
Debug.ShouldStop(134217728);
corkactivity._r2 = BA.numberCast(int.class, 0);
 BA.debugLineNum = 541;BA.debugLine="G2 = 255";
Debug.ShouldStop(268435456);
corkactivity._g2 = BA.numberCast(int.class, 255);
 BA.debugLineNum = 542;BA.debugLine="B2 = 0";
Debug.ShouldStop(536870912);
corkactivity._b2 = BA.numberCast(int.class, 0);
 break; }
case 3: {
 BA.debugLineNum = 544;BA.debugLine="R2 = 255";
Debug.ShouldStop(-2147483648);
corkactivity._r2 = BA.numberCast(int.class, 255);
 BA.debugLineNum = 545;BA.debugLine="G2 = 0";
Debug.ShouldStop(1);
corkactivity._g2 = BA.numberCast(int.class, 0);
 BA.debugLineNum = 546;BA.debugLine="B2 = 0";
Debug.ShouldStop(2);
corkactivity._b2 = BA.numberCast(int.class, 0);
 break; }
case 4: {
 BA.debugLineNum = 548;BA.debugLine="R2 = 255";
Debug.ShouldStop(8);
corkactivity._r2 = BA.numberCast(int.class, 255);
 BA.debugLineNum = 549;BA.debugLine="G2 = 255";
Debug.ShouldStop(16);
corkactivity._g2 = BA.numberCast(int.class, 255);
 BA.debugLineNum = 550;BA.debugLine="B2 = 0";
Debug.ShouldStop(32);
corkactivity._b2 = BA.numberCast(int.class, 0);
 break; }
case 5: {
 BA.debugLineNum = 552;BA.debugLine="R2 = 255";
Debug.ShouldStop(128);
corkactivity._r2 = BA.numberCast(int.class, 255);
 BA.debugLineNum = 553;BA.debugLine="G2 = 255";
Debug.ShouldStop(256);
corkactivity._g2 = BA.numberCast(int.class, 255);
 BA.debugLineNum = 554;BA.debugLine="B2 = 255";
Debug.ShouldStop(512);
corkactivity._b2 = BA.numberCast(int.class, 255);
 break; }
}
...
try {
		Debug.PushSubsStack("sizeSpnr_ItemClick (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,489);
...
Debug.locals.put("Position", _position);
Debug.locals.put("Value", _value);
 BA.debugLineNum = 489;BA.debugLine="Private Sub sizeSpnr_ItemClick (Position As Int, V";
Debug.ShouldStop(256);
 BA.debugLineNum = 490;BA.debugLine="Select Position";
Debug.ShouldStop(512);
switch (BA.switchObjectToInt(_position,BA.numberCast(int.class, 0),BA.numberCast(int.class, 1),BA.numberCast(int.class, 2),BA.numberCast(int.class, 3),BA.numberCast(int.class, 4),BA.numberCast(int.class, 5))) {
case 0: {
 BA.debugLineNum = 492;BA.debugLine="Width = 80dip";
Debug.ShouldStop(2048);
corkactivity._width = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 80)));
 BA.debugLineNum = 493;BA.debugLine="Height = 60dip";
Debug.ShouldStop(4096);
corkactivity._height = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 60)));
 break; }
case 1: {
 BA.debugLineNum = 495;BA.debugLine="Width = 205dip";
Debug.ShouldStop(16384);
corkactivity._width = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 205)));
 BA.debugLineNum = 496;BA.debugLine="Height = 60dip";
Debug.ShouldStop(32768);
corkactivity._height = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 60)));
 break; }
case 2: {
 BA.debugLineNum = 498;BA.debugLine="Width = 80dip";
Debug.ShouldStop(131072);
corkactivity._width = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 80)));
 BA.debugLineNum = 499;BA.debugLine="Height = 185dip";
Debug.ShouldStop(262144);
corkactivity._height = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 185)));
 break; }
case 3: {
 BA.debugLineNum = 501;BA.debugLine="Width = 205dip";
Debug.ShouldStop(1048576);
corkactivity._width = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 205)));
 BA.debugLineNum = 502;BA.debugLine="Height = 185dip";
Debug.ShouldStop(2097152);
corkactivity._height = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 185)));
 break; }
case 4: {
 BA.debugLineNum = 504;BA.debugLine="Width = 330dip";
Debug.ShouldStop(8388608);
corkactivity._width = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 330)));
 BA.debugLineNum = 505;BA.debugLine="Height = 185dip";
Debug.ShouldStop(16777216);
corkactivity._height = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 185)));
 break; }
case 5: {
 BA.debugLineNum = 507;BA.debugLine="Width = 205dip";
Debug.ShouldStop(67108864);
corkactivity._width = corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 205)));
 BA.debugLineNum = 508;BA.debugLine="Height = 310dip";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("stickyBtn_Click (corkactivity) ","corkactivity",8,corkactivity.mostCurrent.activityBA,corkactivity.mostCurrent,466);
if (RapidSub.canDelegate("stickybtn_click")) { return b4a.example.corkactivity.remoteMe.runUserSub(false, "corkactivity","stickybtn_click");}
 BA.debugLineNum = 466;BA.debugLine="Private Sub stickyBtn_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 467;BA.debugLine="noteWindow(250dip, 180dip)";
Debug.ShouldStop(262144);
_notewindow(corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 250))),corkactivity.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 180))));
 BA.debugLineNum = 468;BA.debugLine="notePnl.Visible = True";
Debug.ShouldStop(524288);
corkactivity.mostCurrent._notepnl.runMethod(true,"setVisible",corkactivity.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 469;BA.debugLine="stickyBtn.Enabled = False";
Debug.ShouldStop(1048576);
corkactivity.mostCurrent._stickybtn.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 470;BA.debugLine="canvaBtn.Enabled = False";
Debug.ShouldStop(2097152);
corkactivity.mostCurrent._canvabtn.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 471;BA.debugLine="imgBtn.Enabled = False";
Debug.ShouldStop(4194304);
corkactivity.mostCurrent._imgbtn.runMethod(true,"setEnabled",corkactivity.mostCurrent.__c.getField(true,"False"));
