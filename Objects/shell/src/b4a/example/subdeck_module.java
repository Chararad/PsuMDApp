...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"active_recall",Debug.moduleToString(b4a.example.active_recall.class),"Activity",subdeck_module.mostCurrent._activity,"Add_card_module",Debug.moduleToString(b4a.example.add_card_module.class),"add_card_module2",Debug.moduleToString(b4a.example.add_card_module2.class),"add_events_module",Debug.moduleToString(b4a.example.add_events_module.class),"Addbtn",subdeck_module.mostCurrent._addbtn,"addpanel",subdeck_module.mostCurrent._addpanel,"addpanel2",subdeck_module.mostCurrent._addpanel2,"AIGlobalText",subdeck_module.mostCurrent._aiglobaltext,"all_active_recall",Debug.moduleToString(b4a.example.all_active_recall.class),"alldecks",subdeck_module.mostCurrent._alldecks,"alterpanel",subdeck_module.mostCurrent._alterpanel,"AR_confirmationpanel",subdeck_module.mostCurrent._ar_confirmationpanel,"CalendarActivity",Debug.moduleToString(b4a.example.calendaractivity.class),"Card_Module",Debug.moduleToString(b4a.example.card_module.class),"cc",subdeck_module.mostCurrent._cc,"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"confirmlabel",subdeck_module.mostCurrent._confirmlabel,"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"day_module",Debug.moduleToString(b4a.example.day_module.class),"deck_all_cards",Debug.moduleToString(b4a.example.deck_all_cards.class),"decknamelabel",subdeck_module.mostCurrent._decknamelabel,"deleteconfirmation",subdeck_module.mostCurrent._deleteconfirmation,"editnote",Debug.moduleToString(b4a.example.editnote.class),"et1",subdeck_module.mostCurrent._et1,"FlashcardActivity",Debug.moduleToString(b4a.example.flashcardactivity.class),"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"j",subdeck_module.mostCurrent._j,"LVSubdecks",subdeck_module.mostCurrent._lvsubdecks,"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"musicActivity",Debug.moduleToString(b4a.example.musicactivity.class),"musicService",Debug.moduleToString(b4a.example.musicservice.class),"MyAPIKey",subdeck_module.mostCurrent._myapikey,"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"number_of_cards",subdeck_module._number_of_cards,"pickPDFBtn",subdeck_module.mostCurrent._pickpdfbtn,"renameet",subdeck_module.mostCurrent._renameet,"renamepanel",subdeck_module.mostCurrent._renamepanel,"Schedule_module",Debug.moduleToString(b4a.example.schedule_module.class),"selecteddeck",subdeck_module.mostCurrent._selecteddeck,"selectedsubdeck",subdeck_module._selectedsubdeck,"Starter",Debug.moduleToString(b4a.example.starter.class),"themeActivity",Debug.moduleToString(b4a.example.themeactivity.class),"todoActivity",Debug.moduleToString(b4a.example.todoactivity.class),"topic_et",subdeck_module.mostCurrent._topic_et,"topic_panel",subdeck_module.mostCurrent._topic_panel};
}
}