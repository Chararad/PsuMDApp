...
public class noteactivity_subs_1 {
...
try {
		Debug.PushSubsStack("Activity_Pause (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,49);
...
try {
		Debug.PushSubsStack("Activity_Resume (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,45);
...
try {
		Debug.PushSubsStack("addBtn_Click (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,108);
...
try {
		Debug.PushSubsStack("noteClv_ItemClick (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,53);
...
try {
		Debug.PushSubsStack("noteClv_ItemLongClick (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,63);
...
try {
		Debug.PushSubsStack("noteCvl_ItemClick (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,112);
...
try {
		Debug.PushSubsStack("RefreshList (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,75);
...
try {
		Debug.PushSubsStack("searchTxt_TextChanged (noteactivity) ","noteactivity",23,noteactivity.mostCurrent.activityBA,noteactivity.mostCurrent,104);
