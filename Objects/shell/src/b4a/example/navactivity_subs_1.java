...
public class navactivity_subs_1 {
...
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("=",navactivity.mostCurrent._starter._darkmode /*RemoteObject*/ ,navactivity.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 40;BA.debugLine="Activity.LoadLayout(\"navAct\")";
Debug.ShouldStop(128);
navactivity.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("navAct")),navactivity.mostCurrent.activityBA);
 }else {
 BA.debugLineNum = 42;BA.debugLine="Activity.LoadLayout(\"navActDark\")";
...
try {
		Debug.PushSubsStack("Activity_Pause (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,51);
...
try {
		Debug.PushSubsStack("Activity_Resume (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,47);
...
try {
		Debug.PushSubsStack("calendarBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,56);
if (RapidSub.canDelegate("calendarbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","calendarbtn_click");}
 BA.debugLineNum = 56;BA.debugLine="Private Sub calendarBtn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 57;BA.debugLine="StartActivity(CalendarActivity)";
...
try {
		Debug.PushSubsStack("clkBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,60);
if (RapidSub.canDelegate("clkbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","clkbtn_click");}
 BA.debugLineNum = 60;BA.debugLine="Private Sub clkBtn_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 61;BA.debugLine="StartActivity(clockActivity)";
...
try {
		Debug.PushSubsStack("corkpadBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,64);
if (RapidSub.canDelegate("corkpadbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","corkpadbtn_click");}
 BA.debugLineNum = 64;BA.debugLine="Private Sub corkpadBtn_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 65;BA.debugLine="StartActivity(corkActivity)";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("exitBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,92);
if (RapidSub.canDelegate("exitbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","exitbtn_click");}
 BA.debugLineNum = 92;BA.debugLine="Private Sub exitBtn_Click";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("flashBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,68);
if (RapidSub.canDelegate("flashbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","flashbtn_click");}
 BA.debugLineNum = 68;BA.debugLine="Private Sub flashBtn_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 69;BA.debugLine="StartActivity(FlashcardActivity)";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("helpBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,84);
if (RapidSub.canDelegate("helpbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","helpbtn_click");}
 BA.debugLineNum = 84;BA.debugLine="Private Sub helpBtn_Click";
Debug.ShouldStop(524288);
 BA.debugLineNum = 85;BA.debugLine="StartActivity(helpActivity)";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("musicBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,72);
if (RapidSub.canDelegate("musicbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","musicbtn_click");}
 BA.debugLineNum = 72;BA.debugLine="Private Sub musicBtn_Click";
Debug.ShouldStop(128);
 BA.debugLineNum = 73;BA.debugLine="StartActivity(musicActivity)";
...
try {
		Debug.PushSubsStack("ntpdBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,76);
if (RapidSub.canDelegate("ntpdbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","ntpdbtn_click");}
 BA.debugLineNum = 76;BA.debugLine="Private Sub ntpdBtn_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 77;BA.debugLine="StartActivity(noteActivity)";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("themeBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,88);
if (RapidSub.canDelegate("themebtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","themebtn_click");}
 BA.debugLineNum = 88;BA.debugLine="Private Sub themeBtn_Click";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 89;BA.debugLine="StartActivity(themeActivity)";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("todoBtn_Click (navactivity) ","navactivity",22,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,80);
if (RapidSub.canDelegate("todobtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","todobtn_click");}
 BA.debugLineNum = 80;BA.debugLine="Private Sub todoBtn_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 81;BA.debugLine="StartActivity(todoActivity)";
Debug.ShouldStop(65536);
