...
try {
		Debug.PushSubsStack("Activity_Pause (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,105);
...
try {
		Debug.PushSubsStack("Activity_Resume (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,101);
...
try {
		Debug.PushSubsStack("addbtn_Click (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,110);
...
try {
		Debug.PushSubsStack("backbtn_Click (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,114);
...
try {
		Debug.PushSubsStack("ShowALLCards (deck_all_cards) ","deck_all_cards",6,deck_all_cards.mostCurrent.activityBA,deck_all_cards.mostCurrent,62);
