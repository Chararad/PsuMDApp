...
try {
		Debug.PushSubsStack("Activity_Create (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,18);
...
try {
		Debug.PushSubsStack("Activity_Pause (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,46);
...
try {
		Debug.PushSubsStack("Activity_Resume (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,42);
...
try {
		Debug.PushSubsStack("calendarBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,51);
...
try {
		Debug.PushSubsStack("clkBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,55);
...
try {
		Debug.PushSubsStack("corkpadBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,59);
...
try {
		Debug.PushSubsStack("exitBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,91);
if (RapidSub.canDelegate("exitbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","exitbtn_click");}
 BA.debugLineNum = 91;BA.debugLine="Private Sub exitBtn_Click";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("flashBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,63);
...
try {
		Debug.PushSubsStack("helpBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,79);
...
public static RemoteObject  _lbbtn_click() throws Exception{
try {
		Debug.PushSubsStack("lbBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,87);
if (RapidSub.canDelegate("lbbtn_click")) { return b4a.example.navactivity.remoteMe.runUserSub(false, "navactivity","lbbtn_click");}
 BA.debugLineNum = 87;BA.debugLine="Private Sub lbBtn_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 88;BA.debugLine="StartActivity(Leaderboard)";
Debug.ShouldStop(8388608);
navactivity.mostCurrent.__c.runVoidMethod ("StartActivity",navactivity.processBA,(Object)((navactivity.mostCurrent._leaderboard.getObject())));
...
try {
		Debug.PushSubsStack("musicBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,67);
...
try {
		Debug.PushSubsStack("ntpdBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,71);
...
try {
		Debug.PushSubsStack("themeBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,83);
...
try {
		Debug.PushSubsStack("todoBtn_Click (navactivity) ","navactivity",7,navactivity.mostCurrent.activityBA,navactivity.mostCurrent,75);
