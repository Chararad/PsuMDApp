...
try {
		Debug.PushSubsStack("Activity_Create (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,25);
...
try {
		Debug.PushSubsStack("Activity_Pause (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,37);
...
try {
		Debug.PushSubsStack("Activity_Resume (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,33);
...
try {
		Debug.PushSubsStack("btnback_Click (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,109);
...
try {
		Debug.PushSubsStack("btnconfirm_pass_Click (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,113);
...
try {
		Debug.PushSubsStack("btneyes_regis_Click (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,93);
...
try {
		Debug.PushSubsStack("btnlogin_Click (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,88);
...
try {
		Debug.PushSubsStack("btnregister_Click (register) ","register",4,register.mostCurrent.activityBA,register.mostCurrent,42);
