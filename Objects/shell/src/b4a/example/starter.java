...
public static RemoteObject _currentuserid = RemoteObject.createImmutable("");
...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"active_recall",Debug.moduleToString(b4a.example.active_recall.class),"Add_card_module",Debug.moduleToString(b4a.example.add_card_module.class),"add_card_module2",Debug.moduleToString(b4a.example.add_card_module2.class),"add_events_module",Debug.moduleToString(b4a.example.add_events_module.class),"all_active_recall",Debug.moduleToString(b4a.example.all_active_recall.class),"CalendarActivity",Debug.moduleToString(b4a.example.calendaractivity.class),"calendarMap",starter._calendarmap,"calKvs",starter._calkvs,"Card_Module",Debug.moduleToString(b4a.example.card_module.class),"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"currentUserID",starter._currentuserid,"darkMode",starter._darkmode,"day_module",Debug.moduleToString(b4a.example.day_module.class),"deck",starter._deck,"deck_all_cards",Debug.moduleToString(b4a.example.deck_all_cards.class),"deckKvs",starter._deckkvs,"editnote",Debug.moduleToString(b4a.example.editnote.class),"finishedInit",starter._finishedinit,"FlashcardActivity",Debug.moduleToString(b4a.example.flashcardactivity.class),"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"Home_Activity",Debug.moduleToString(b4a.example.home_activity.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"Leaderboard",Debug.moduleToString(b4a.example.leaderboard.class),"LogIn",Debug.moduleToString(b4a.example.login.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"musicActivity",Debug.moduleToString(b4a.example.musicactivity.class),"musicService",Debug.moduleToString(b4a.example.musicservice.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"notesKvs",starter._noteskvs,"prefKvs",starter._prefkvs,"Register",Debug.moduleToString(b4a.example.register.class),"Schedule_module",Debug.moduleToString(b4a.example.schedule_module.class),"Service",starter.mostCurrent._service,"SQL1",starter._sql1,"Subdeck_Module",Debug.moduleToString(b4a.example.subdeck_module.class),"taskKvs",starter._taskkvs,"themeActivity",Debug.moduleToString(b4a.example.themeactivity.class),"themeChanged",starter._themechanged,"themeNumber",starter._themenumber,"todoActivity",Debug.moduleToString(b4a.example.todoactivity.class),"tutorialActivity",Debug.moduleToString(b4a.example.tutorialactivity.class)};
}
}