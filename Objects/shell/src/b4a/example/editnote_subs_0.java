...
Debug.ShouldStop(64);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","421299202",RemoteObject.concat(RemoteObject.createImmutable("Selected: "),_dir,RemoteObject.createImmutable(" / "),_filename),0);
...
Debug.ShouldStop(256);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","421299204",RemoteObject.createImmutable("PDF saved"),0);
...
Debug.ShouldStop(2048);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","421299207",RemoteObject.createImmutable("User Cancelled"),0);
 };
...
Debug.ShouldStop(256);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","421430292",RemoteObject.createImmutable("NOTES OUTPUT:"),0);
 BA.debugLineNum = 202;BA.debugLine="Log(notes)";
Debug.ShouldStop(512);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","421430293",_notes,0);
...
Debug.ShouldStop(16777216);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","421430308",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
