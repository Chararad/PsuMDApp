...
try {
		Debug.PushSubsStack("Activity_Create (editnote) ","editnote",15,editnote.mostCurrent.activityBA,editnote.mostCurrent,22);
...
try {
		Debug.PushSubsStack("Activity_Pause (editnote) ","editnote",15,editnote.mostCurrent.activityBA,editnote.mostCurrent,57);
...
try {
		Debug.PushSubsStack("Activity_Resume (editnote) ","editnote",15,editnote.mostCurrent.activityBA,editnote.mostCurrent,53);
...
try {
		Debug.PushSubsStack("saveBtn_Click (editnote) ","editnote",15,editnote.mostCurrent.activityBA,editnote.mostCurrent,61);
