...
try {
		Debug.PushSubsStack("Activity_Create (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,26);
...
try {
		Debug.PushSubsStack("Activity_Pause (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,63);
...
try {
		Debug.PushSubsStack("Activity_Resume (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,59);
...
try {
		Debug.PushSubsStack("AI_notes_Click (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,96);
...
try {
		Debug.PushSubsStack("CC_RESULT (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,101);
...
Debug.ShouldStop(64);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","124838146",RemoteObject.concat(RemoteObject.createImmutable("Selected: "),_dir,RemoteObject.createImmutable(" / "),_filename),0);
...
Debug.ShouldStop(256);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","124838148",RemoteObject.createImmutable("PDF saved"),0);
...
Debug.ShouldStop(2048);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","124838151",RemoteObject.createImmutable("User Cancelled"),0);
 };
...
try {
		Debug.PushSubsStack("GenerateNotesFromPDF (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,112);
...
try {
		Debug.PushSubsStack("JobDone (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,181);
...
Debug.ShouldStop(256);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","124969236",RemoteObject.createImmutable("NOTES OUTPUT:"),0);
 BA.debugLineNum = 202;BA.debugLine="Log(notes)";
Debug.ShouldStop(512);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","124969237",_notes,0);
...
Debug.ShouldStop(16777216);
editnote.mostCurrent.__c.runVoidMethod ("LogImpl","124969252",RemoteObject.concat(RemoteObject.createImmutable("ERROR: "),_job.getField(true,"_errormessage" /*RemoteObject*/ )),0);
 };
...
try {
		Debug.PushSubsStack("saveBtn_Click (editnote) ","editnote",20,editnote.mostCurrent.activityBA,editnote.mostCurrent,67);
