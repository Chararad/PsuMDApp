...
try {
		Debug.PushSubsStack("Activity_Create (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,21);
...
try {
		Debug.PushSubsStack("Activity_Pause (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,33);
...
try {
		Debug.PushSubsStack("Activity_Resume (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,29);
...
try {
		Debug.PushSubsStack("btnback_Click (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,92);
...
try {
		Debug.PushSubsStack("btneyes_Click (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,76);
...
try {
		Debug.PushSubsStack("btnlogin_Click (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,38);
...
try {
		Debug.PushSubsStack("btnSignUp_Click (login) ","login",8,login.mostCurrent.activityBA,login.mostCurrent,96);
