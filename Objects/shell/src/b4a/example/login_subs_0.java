...
try {
		Debug.PushSubsStack("Activity_Create (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,21);
...
try {
		Debug.PushSubsStack("Activity_Pause (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,33);
...
try {
		Debug.PushSubsStack("Activity_Resume (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,29);
...
try {
		Debug.PushSubsStack("btnback_Click (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,92);
if (RapidSub.canDelegate("btnback_click")) { return b4a.example.login.remoteMe.runUserSub(false, "login","btnback_click");}
 BA.debugLineNum = 92;BA.debugLine="Private Sub btnback_Click";
...
try {
		Debug.PushSubsStack("btneyes_Click (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,76);
if (RapidSub.canDelegate("btneyes_click")) { return b4a.example.login.remoteMe.runUserSub(false, "login","btneyes_click");}
 BA.debugLineNum = 76;BA.debugLine="Private Sub btneyes_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 77;BA.debugLine="btneyes.Height = 30dip";
...
login.mostCurrent._btneyes.runMethod(true,"setHeight",login.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30))));
 BA.debugLineNum = 78;BA.debugLine="btneyes.Width = 30dip";
...
login.mostCurrent._btneyes.runMethod(true,"setWidth",login.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30))));
 BA.debugLineNum = 80;BA.debugLine="If isPasswordHidden Then";
Debug.ShouldStop(32768);
if (login._ispasswordhidden.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 81;BA.debugLine="txtpassword.PasswordMode = False";
Debug.ShouldStop(65536);
login.mostCurrent._txtpassword.runVoidMethod ("setPasswordMode",login.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 82;BA.debugLine="btneyes.SetBackgroundImage(LoadBitmap(File.DirAs";
...
login.mostCurrent._btneyes.runVoidMethod ("SetBackgroundImageNew",(Object)((login.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(login.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("open-eye.png"))).getObject())));
 BA.debugLineNum = 83;BA.debugLine="isPasswordHidden = False";
...
login.mostCurrent._txtpassword.runVoidMethod ("setPasswordMode",login.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 87;BA.debugLine="btneyes.SetBackgroundImage(LoadBitmap(File.DirAs";
Debug.ShouldStop(4194304);
login.mostCurrent._btneyes.runVoidMethod ("SetBackgroundImageNew",(Object)((login.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(login.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("close-eye.png"))).getObject())));
 BA.debugLineNum = 88;BA.debugLine="isPasswordHidden = True";
...
try {
		Debug.PushSubsStack("btnlogin_Click (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,38);
...
login.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("Login successful")),(Object)(login.mostCurrent.__c.getField(true,"False")));
 BA.debugLineNum = 50;BA.debugLine="Starter.currentUserID = Starter.SQL1.ExecQuery2";
Debug.ShouldStop(131072);
login.mostCurrent._starter._currentuserid /*RemoteObject*/  = BA.ObjectToString(login.mostCurrent._starter._sql1 /*RemoteObject*/ .runMethod(false,"ExecQuery2",(Object)(BA.ObjectToString("SELECT id FROM users WHERE email=?")),(Object)(RemoteObject.createNewArray("String",new int[] {1},new Object[] {_email}))));
 BA.debugLineNum = 51;BA.debugLine="Cursor1.Close";
Debug.ShouldStop(262144);
_cursor1.runVoidMethod ("Close");
 BA.debugLineNum = 53;BA.debugLine="txtemail.Text = \"\"";
Debug.ShouldStop(1048576);
login.mostCurrent._txtemail.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 54;BA.debugLine="txtpassword.Text = \"\"";
Debug.ShouldStop(2097152);
login.mostCurrent._txtpassword.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 56;BA.debugLine="Dim skipTutorial As Boolean = False";
Debug.ShouldStop(8388608);
_skiptutorial = login.mostCurrent.__c.getField(true,"False");Debug.locals.put("skipTutorial", _skiptutorial);Debug.locals.put("skipTutorial", _skiptutorial);
 BA.debugLineNum = 57;BA.debugLine="If Starter.prefKvs.ContainsKey(\"skipTutorial\")";
Debug.ShouldStop(16777216);
if (login.mostCurrent._starter._prefkvs /*RemoteObject*/ .runMethod(true,"_containskey",(Object)(RemoteObject.createImmutable("skipTutorial"))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 58;BA.debugLine="skipTutorial = Starter.prefKvs.Get(\"skipTutori";
Debug.ShouldStop(33554432);
_skiptutorial = BA.ObjectToBoolean(login.mostCurrent._starter._prefkvs /*RemoteObject*/ .runMethod(false,"_get",(Object)(RemoteObject.createImmutable("skipTutorial"))));Debug.locals.put("skipTutorial", _skiptutorial);
 };
 BA.debugLineNum = 61;BA.debugLine="If skipTutorial Then";
Debug.ShouldStop(268435456);
if (_skiptutorial.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 62;BA.debugLine="StartActivity(MainActivity)";
Debug.ShouldStop(536870912);
login.mostCurrent.__c.runVoidMethod ("StartActivity",login.processBA,(Object)((login.mostCurrent._mainactivity.getObject())));
 }else {
 BA.debugLineNum = 64;BA.debugLine="StartActivity(tutorialActivity)";
...
login.mostCurrent.__c.runVoidMethod ("StartActivity",login.processBA,(Object)((login.mostCurrent._tutorialactivity.getObject())));
 ...
 BA.debugLineNum = 68;BA.debugLine="ToastMessageShow(\"Invalid email or password\", F";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("btnSignUp_Click (login) ","login",3,login.mostCurrent.activityBA,login.mostCurrent,96);
if (RapidSub.canDelegate("btnsignup_click")) { return b4a.example.login.remoteMe.runUserSub(false, "login","btnsignup_click");}
 BA.debugLineNum = 96;BA.debugLine="Private Sub btnSignUp_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 97;BA.debugLine="StartActivity(Register)";
Debug.ShouldStop(1);
