...
try {
		Debug.PushSubsStack("activerecall_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,158);
...
RemoteObject _number_of_cards = RemoteObject.createImmutable(0);
 BA.debugLineNum = 158;BA.debugLine="Private Sub activerecall_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 160;BA.debugLine="Dim tappedDeck As Map = FlashcardActivity.deck.Ge";
...
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 161;BA.debugLine="Dim subdeckcards As List = tappedDeck.Get(Subdeck";
Debug.ShouldStop(1);
...
_subdeckcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("subdeckcards", _subdeckcards);Debug.locals.put("subdeckcards", _subdeckcards);
 BA.debugLineNum = 162;BA.debugLine="Dim number_of_cards As Int = subdeckcards.size";
Debug.ShouldStop(2);
_number_of_cards = _subdeckcards.runMethod(true,"getSize");Debug.locals.put("number_of_cards", _number_of_cards);Debug.locals.put("number_of_cards", _number_of_cards);
 BA.debugLineNum = 164;BA.debugLine="If number_of_cards = 0 Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("=",_number_of_cards,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 165;BA.debugLine="MsgboxAsync(\"No cards available\", \"Error\")";
Debug.ShouldStop(16);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 168;BA.debugLine="StartActivity(active_recall)";
...
try {
		Debug.PushSubsStack("Activity_Create (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,29);
...
if (RemoteObject.solveBoolean("=",card_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,card_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 33;BA.debugLine="Activity.LoadLayout(\"Card_ModuleLayout\")";
Debug.ShouldStop(1);
card_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Card_ModuleLayout")),card_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 35;BA.debugLine="Activity.LoadLayout(\"Card_ModuleLayoutDark\")";
Debug.ShouldStop(4);
...
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",card_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,card_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 39;BA.debugLine="Activity.LoadLayout(\"Card_ModuleLayout2\")";
Debug.ShouldStop(64);
card_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Card_ModuleLayout2")),card_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 41;BA.debugLine="Activity.LoadLayout(\"Card_ModuleLayoutDark2\")";
Debug.ShouldStop(256);
...
if (RemoteObject.solveBoolean("=",card_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,card_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 45;BA.debugLine="Activity.LoadLayout(\"Card_ModuleLayout3\")";
...
card_module.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("Card_ModuleLayout3")),card_module.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 47;BA.debugLine="Activity.LoadLayout(\"Card_ModuleLayoutDark3\")";
...
card_module.mostCurrent._cc.runVoidMethod ("Initialize",(Object)(RemoteObject.createImmutable("CC")));
 BA.debugLineNum = 53;BA.debugLine="subdecklabel.Text = Subdeck_Module.selectedsubdec";
...
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 56;BA.debugLine="Dim subdeckcards As List = tappedDeck.Get(Subdeck";
Debug.ShouldStop(8388608);
_subdeckcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_subdeckcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("subdeckcards", _subdeckcards);Debug.locals.put("subdeckcards", _subdeckcards);
 BA.debugLineNum = 59;BA.debugLine="ShowSubdeckCards(subdeckcards)";
...
try {
		Debug.PushSubsStack("Activity_Pause (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,147);
...
try {
		Debug.PushSubsStack("Activity_Resume (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,135);
...
Debug.ShouldStop(64);
 BA.debugLineNum = 137;BA.debugLine="If active_recall.praise = True Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",card_module.mostCurrent._active_recall._praise /*RemoteObject*/ ,card_module.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 138;BA.debugLine="active_recall.praise = False";
Debug.ShouldStop(512);
card_module.mostCurrent._active_recall._praise /*RemoteObject*/  = card_module.mostCurrent.__c.getField(true,"False");
 BA.debugLineNum = 139;BA.debugLine="MsgboxAsync(\"You Finished Your Sub-Deck\", \"Congr";
...
card_module.mostCurrent.__c.runVoidMethod ("MsgboxAsync",(Object)(BA.ObjectToCharSequence("You Finished Your Sub-Deck")),(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Congratulations"))),card_module.processBA);
 ...
 BA.debugLineNum = 142;BA.debugLine="Dim tappedDeck As Map = FlashcardActivity.deck.Ge";
Debug.ShouldStop(8192);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 143;BA.debugLine="Dim subdeckcards As List = tappedDeck.Get(Subdeck";
Debug.ShouldStop(16384);
_subdeckcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_subdeckcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("subdeckcards", _subdeckcards);Debug.locals.put("subdeckcards", _subdeckcards);
 BA.debugLineNum = 144;BA.debugLine="ShowSubdeckCards(subdeckcards)";
...
try {
		Debug.PushSubsStack("addbtn_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,171);
if (RapidSub.canDelegate("addbtn_click")) { return b4a.example.card_module.remoteMe.runUserSub(false, "card_module","addbtn_click");}
 BA.debugLineNum = 171;BA.debugLine="Private Sub addbtn_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 173;BA.debugLine="subdeck = Subdeck_Module.selectedsubdeck";
Debug.ShouldStop(4096);
card_module._subdeck = card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ;
 BA.debugLineNum = 174;BA.debugLine="StartActivity(add_card_module2)";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("backbtn_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,153);
if (RapidSub.canDelegate("backbtn_click")) { return b4a.example.card_module.remoteMe.runUserSub(false, "card_module","backbtn_click");}
 BA.debugLineNum = 153;BA.debugLine="Private Sub backbtn_Click";
...
try {
		Debug.PushSubsStack("canceldelete_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,186);
if (RapidSub.canDelegate("canceldelete_click")) { return b4a.example.card_module.remoteMe.runUserSub(false, "card_module","canceldelete_click");}
 BA.debugLineNum = 186;BA.debugLine="Private Sub canceldelete_Click";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 187;BA.debugLine="deleteconfirmation.Visible = False";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("CC_RESULT (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,194);
...
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 194;BA.debugLine="Sub CC_RESULT (Success As Boolean, dir As String ,";
Debug.ShouldStop(2);
 BA.debugLineNum = 196;BA.debugLine="If Success Then";
Debug.ShouldStop(8);
if (_success.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 197;BA.debugLine="Log(\"Dir: \" & dir)";
Debug.ShouldStop(16);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329491203",RemoteObject.concat(RemoteObject.createImmutable("Dir: "),_dir),0);
 BA.debugLineNum = 198;BA.debugLine="Log(\"File: \" & fileName)";
Debug.ShouldStop(32);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329491204",RemoteObject.concat(RemoteObject.createImmutable("File: "),_filename),0);
 BA.debugLineNum = 200;BA.debugLine="File.Copy(dir, fileName, File.DirInternal, \"temp";
Debug.ShouldStop(128);
card_module.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(_dir),(Object)(_filename),(Object)(card_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("temp.pdf")));
 BA.debugLineNum = 201;BA.debugLine="Log(\"PDF saved as temp.pdf\")";
Debug.ShouldStop(256);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329491207",RemoteObject.createImmutable("PDF saved as temp.pdf"),0);
 BA.debugLineNum = 203;BA.debugLine="File.Copy(dir, fileName, File.DirInternal, \"temp";
Debug.ShouldStop(1024);
card_module.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(_dir),(Object)(_filename),(Object)(card_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("temp.pdf")));
 BA.debugLineNum = 204;BA.debugLine="GenerateFlashCardsFromPDF";
Debug.ShouldStop(2048);
_generateflashcardsfrompdf();
 }else {
 BA.debugLineNum = 207;BA.debugLine="Log(\"User Cancelled\")";
Debug.ShouldStop(16384);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329491213",RemoteObject.createImmutable("User Cancelled"),0);
 };
...
try {
		Debug.PushSubsStack("confirmdelete_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,177);
...
RemoteObject _cards = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 177;BA.debugLine="Private Sub confirmdelete_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 178;BA.debugLine="Dim tappedDeck As Map = FlashcardActivity.deck.Ge";
Debug.ShouldStop(131072);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 179;BA.debugLine="Dim cards As List = tappedDeck.Get(Subdeck_Module";
Debug.ShouldStop(262144);
...
_cards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("cards", _cards);Debug.locals.put("cards", _cards);
 BA.debugLineNum = 181;BA.debugLine="cards.RemoveAt(numtag)";
Debug.ShouldStop(1048576);
_cards.runVoidMethod ("RemoveAt",(Object)(card_module._numtag));
 BA.debugLineNum = 182;BA.debugLine="ShowSubdeckCards(cards)";
Debug.ShouldStop(2097152);
_showsubdeckcards(_cards);
 BA.debugLineNum = 183;BA.debugLine="deleteconfirmation.Visible = False";
Debug.ShouldStop(4194304);
card_module.mostCurrent._deleteconfirmation.runMethod(true,"setVisible",card_module.mostCurrent.__c.getField(true,"False"));
...
try {
		Debug.PushSubsStack("deletebtn_click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,126);
...
RemoteObject _index = RemoteObject.createImmutable(0);
 BA.debugLineNum = 126;BA.debugLine="Sub deletebtn_click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 128;BA.debugLine="Dim b As Button = Sender";
Debug.ShouldStop(-2147483648);
...
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ButtonWrapper"), card_module.mostCurrent.__c.runMethod(false,"Sender",card_module.mostCurrent.activityBA));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
 BA.debugLineNum = 129;BA.debugLine="Dim index As Int = b.Tag";
Debug.ShouldStop(1);
_index = BA.numberCast(int.class, _b.runMethod(false,"getTag"));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 130;BA.debugLine="numtag = index";
Debug.ShouldStop(2);
card_module._numtag = _index;
 BA.debugLineNum = 131;BA.debugLine="deleteconfirmation.Visible = True";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("editbtn_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,114);
if (RapidSub.canDelegate("editbtn_click")) { return b4a.example.card_module.remoteMe.runUserSub(false, "card_module","editbtn_click");}
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
RemoteObject _index = RemoteObject.createImmutable(0);
 BA.debugLineNum = 114;BA.debugLine="Sub editbtn_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 116;BA.debugLine="subdeck = Subdeck_Module.selectedsubdeck";
Debug.ShouldStop(524288);
card_module._subdeck = card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ;
 BA.debugLineNum = 117;BA.debugLine="Dim b As Button = Sender";
Debug.ShouldStop(1048576);
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
_b = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.ButtonWrapper"), card_module.mostCurrent.__c.runMethod(false,"Sender",card_module.mostCurrent.activityBA));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
 BA.debugLineNum = 118;BA.debugLine="Dim index As Int = b.Tag";
Debug.ShouldStop(2097152);
_index = BA.numberCast(int.class, _b.runMethod(false,"getTag"));Debug.locals.put("index", _index);Debug.locals.put("index", _index);
 BA.debugLineNum = 119;BA.debugLine="editindex = index";
Debug.ShouldStop(4194304);
card_module._editindex = _index;
 BA.debugLineNum = 120;BA.debugLine="isEdit = True";
Debug.ShouldStop(8388608);
card_module._isedit = card_module.mostCurrent.__c.getField(true,"True");
 BA.debugLineNum = 122;BA.debugLine="StartActivity(add_card_module2)";
Debug.ShouldStop(33554432);
card_module.mostCurrent.__c.runVoidMethod ("StartActivity",card_module.processBA,(Object)((card_module.mostCurrent._add_card_module2.getObject())));
...
try {
		Debug.PushSubsStack("ftf_btn_Click (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,190);
if (RapidSub.canDelegate("ftf_btn_click")) { return b4a.example.card_module.remoteMe.runUserSub(false, "card_module","ftf_btn_click");}
 BA.debugLineNum = 190;BA.debugLine="Private Sub ftf_btn_Click";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 191;BA.debugLine="cc.Show(\"application/pdf\", \"Select PDF\")";
...
try {
		Debug.PushSubsStack("GenerateFlashCardsFromPDF (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,211);
...
RemoteObject _job = RemoteObject.declareNull("b4a.example.httpjob");
 BA.debugLineNum = 211;BA.debugLine="Sub GenerateFlashCardsFromPDF";
Debug.ShouldStop(262144);
 BA.debugLineNum = 214;BA.debugLine="Dim In As InputStream = File.OpenInput(File.DirIn";
Debug.ShouldStop(2097152);
...
_in = card_module.mostCurrent.__c.getField(false,"File").runMethod(false,"OpenInput",(Object)(card_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("temp.pdf")));Debug.locals.put("In", _in);Debug.locals.put("In", _in);
 BA.debugLineNum = 215;BA.debugLine="Dim bytes() As Byte = Bit.InputStreamToBytes(In)";
Debug.ShouldStop(4194304);
...
_inline.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("mime_type"))),(Object)((RemoteObject.createImmutable("application/pdf"))));
 BA.debugLineNum = 260;BA.debugLine="inline.Put(\"data\", base64)";
Debug.ShouldStop(8);
_inline.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("data"))),(Object)((_base64)));
 BA.debugLineNum = 262;BA.debugLine="filePart.Put(\"inline_data\", inline)";
Debug.ShouldStop(32);
_filepart.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("inline_data"))),(Object)((_inline.getObject())));
 BA.debugLineNum = 263;BA.debugLine="parts.Add(filePart)";
Debug.ShouldStop(64);
_parts.runVoidMethod ("Add",(Object)((_filepart.getObject())));
 BA.debugLineNum = 266;BA.debugLine="Dim textPart As Map";
Debug.ShouldStop(512);
_textpart = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("textPart", _textpart);
 BA.debugLineNum = 267;BA.debugLine="textPart.Initialize";
Debug.ShouldStop(1024);
_textpart.runVoidMethod ("Initialize");
 BA.debugLineNum = 268;BA.debugLine="textPart.Put(\"text\", prompt)";
Debug.ShouldStop(2048);
_textpart.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("text"))),(Object)((_prompt)));
 BA.debugLineNum = 269;BA.debugLine="parts.Add(textPart)";
Debug.ShouldStop(4096);
_parts.runVoidMethod ("Add",(Object)((_textpart.getObject())));
 BA.debugLineNum = 271;BA.debugLine="contentItem.Put(\"parts\", parts)";
Debug.ShouldStop(16384);
_contentitem.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("parts"))),(Object)((_parts.getObject())));
 BA.debugLineNum = 272;BA.debugLine="contents.Add(contentItem)";
Debug.ShouldStop(32768);
_contents.runVoidMethod ("Add",(Object)((_contentitem.getObject())));
 BA.debugLineNum = 274;BA.debugLine="root.Put(\"contents\", contents)";
Debug.ShouldStop(131072);
_root.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("contents"))),(Object)((_contents.getObject())));
 BA.debugLineNum = 276;BA.debugLine="Dim gen As JSONGenerator";
Debug.ShouldStop(524288);
_gen = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator");Debug.locals.put("gen", _gen);
 BA.debugLineNum = 277;BA.debugLine="gen.Initialize(root)";
Debug.ShouldStop(1048576);
_gen.runVoidMethod ("Initialize",(Object)(_root));
 BA.debugLineNum = 279;BA.debugLine="Dim json As String = gen.ToString";
Debug.ShouldStop(4194304);
_json = _gen.runMethod(true,"ToString");Debug.locals.put("json", _json);Debug.locals.put("json", _json);
 BA.debugLineNum = 281;BA.debugLine="Log(\"AUTO PDF REQUEST: \")";
Debug.ShouldStop(16777216);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329556806",RemoteObject.createImmutable("AUTO PDF REQUEST: "),0);
 BA.debugLineNum = 282;BA.debugLine="Log(json)";
Debug.ShouldStop(33554432);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329556807",_json,0);
 BA.debugLineNum = 284;BA.debugLine="Dim URL As String = \"https://generativelanguage.g";
Debug.ShouldStop(134217728);
...
_job = RemoteObject.createNew ("b4a.example.httpjob");Debug.locals.put("Job", _job);
 BA.debugLineNum = 287;BA.debugLine="Job.Initialize(\"GeminiPDF\", Me)";
Debug.ShouldStop(1073741824);
_job.runClassMethod (b4a.example.httpjob.class, "_initialize" /*RemoteObject*/ ,card_module.processBA,(Object)(BA.ObjectToString("GeminiPDF")),(Object)(card_module.getObject()));
 BA.debugLineNum = 288;BA.debugLine="Job.PostString(URL, json)";
Debug.ShouldStop(-2147483648);
_job.runClassMethod (b4a.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_url),(Object)(_json));
 BA.debugLineNum = 289;BA.debugLine="Job.GetRequest.SetContentType(\"application/json\")";
Debug.ShouldStop(1);
...
card_module.mostCurrent._pickpdfbtn = RemoteObject.createNew ("anywheresoftware.b4a.objects.ButtonWrapper");
 //BA.debugLineNum = 25;BA.debugLine="Dim MyAPIKey As String = \"AIzaSyDvUpRQYW6yGQ8q7A5";
card_module.mostCurrent._myapikey = BA.ObjectToString("AIzaSyDvUpRQYW6yGQ8q7A5ZsyZYTLwtAkfofg8");
 //BA.debugLineNum = 26;BA.debugLine="Dim AIGlobalText As String";
...
try {
		Debug.PushSubsStack("JobDone (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,293);
...
Debug.locals.put("job", _job);
 BA.debugLineNum = 293;BA.debugLine="Sub JobDone (job As HttpJob)";
Debug.ShouldStop(16);
 BA.debugLineNum = 294;BA.debugLine="If job.Success Then";
Debug.ShouldStop(32);
if (_job.getField(true,"_success" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 295;BA.debugLine="Dim response As String";
Debug.ShouldStop(64);
_response = RemoteObject.createImmutable("");Debug.locals.put("response", _response);
 BA.debugLineNum = 296;BA.debugLine="response = job.GetString";
Debug.ShouldStop(128);
_response = _job.runClassMethod (b4a.example.httpjob.class, "_getstring" /*RemoteObject*/ );Debug.locals.put("response", _response);
 BA.debugLineNum = 297;BA.debugLine="Log(\"RAW RESPONSE: \")";
Debug.ShouldStop(256);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329622276",RemoteObject.createImmutable("RAW RESPONSE: "),0);
 BA.debugLineNum = 298;BA.debugLine="Log(response)";
Debug.ShouldStop(512);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329622277",_response,0);
 BA.debugLineNum = 300;BA.debugLine="Dim jp As JSONParser";
Debug.ShouldStop(2048);
_jp = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("jp", _jp);
 BA.debugLineNum = 301;BA.debugLine="jp.Initialize(response)";
Debug.ShouldStop(4096);
_jp.runVoidMethod ("Initialize",(Object)(_response));
 BA.debugLineNum = 303;BA.debugLine="Dim root As Map = jp.NextObject";
Debug.ShouldStop(16384);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _jp.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 305;BA.debugLine="Dim candidates As List = root.Get(\"candidates\")";
Debug.ShouldStop(65536);
...
_candidates = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("candidates")))));Debug.locals.put("candidates", _candidates);Debug.locals.put("candidates", _candidates);
 BA.debugLineNum = 307;BA.debugLine="Dim candidate As Map = candidates.Get(0)";
Debug.ShouldStop(262144);
...
_candidate = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _candidates.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("candidate", _candidate);Debug.locals.put("candidate", _candidate);
 BA.debugLineNum = 309;BA.debugLine="Dim content As Map = candidate.Get(\"content\")";
Debug.ShouldStop(1048576);
...
_content = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _candidate.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("content")))));Debug.locals.put("content", _content);Debug.locals.put("content", _content);
 BA.debugLineNum = 311;BA.debugLine="Dim parts As List = content.Get(\"parts\")";
Debug.ShouldStop(4194304);
...
_parts = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _content.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("parts")))));Debug.locals.put("parts", _parts);Debug.locals.put("parts", _parts);
 BA.debugLineNum = 313;BA.debugLine="Dim firstPart As Map = parts.Get(0)";
Debug.ShouldStop(16777216);
...
_firstpart = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _parts.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("firstPart", _firstpart);Debug.locals.put("firstPart", _firstpart);
 BA.debugLineNum = 315;BA.debugLine="Dim aiText As String = firstPart.Get(\"text\")";
Debug.ShouldStop(67108864);
_aitext = BA.ObjectToString(_firstpart.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("text")))));Debug.locals.put("aiText", _aitext);Debug.locals.put("aiText", _aitext);
 BA.debugLineNum = 317;BA.debugLine="Log(\"AI JSON:\")";
Debug.ShouldStop(268435456);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329622296",RemoteObject.createImmutable("AI JSON:"),0);
 BA.debugLineNum = 318;BA.debugLine="Log(aiText)";
Debug.ShouldStop(536870912);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329622297",_aitext,0);
 BA.debugLineNum = 319;BA.debugLine="File.WriteString(File.DirInternal, \"cached_ai.tx";
Debug.ShouldStop(1073741824);
card_module.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(card_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("cached_ai.txt")),(Object)(_aitext));
 BA.debugLineNum = 320;BA.debugLine="ParseFlashcard(aiText)";
Debug.ShouldStop(-2147483648);
_parseflashcard(_aitext);
 BA.debugLineNum = 322;BA.debugLine="Dim tappedDeck As Map = FlashcardActivity.deck.G";
Debug.ShouldStop(2);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 323;BA.debugLine="Dim subdeckcards As List = tappedDeck.Get(Subdec";
Debug.ShouldStop(4);
_subdeckcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_subdeckcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("subdeckcards", _subdeckcards);Debug.locals.put("subdeckcards", _subdeckcards);
 BA.debugLineNum = 326;BA.debugLine="ShowSubdeckCards(subdeckcards)";
Debug.ShouldStop(32);
_showsubdeckcards(_subdeckcards);
 }else {
 BA.debugLineNum = 329;BA.debugLine="Log(\"ERROR: \")";
Debug.ShouldStop(256);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329622308",RemoteObject.createImmutable("ERROR: "),0);
 BA.debugLineNum = 330;BA.debugLine="Log(job.ErrorMessage)";
Debug.ShouldStop(512);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329622309",_job.getField(true,"_errormessage" /*RemoteObject*/ ),0);
 BA.debugLineNum = 331;BA.debugLine="Msgbox(\"Error Parsing your PDF file\", \"Error\")";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("ParseFlashcard (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,337);
...
Debug.locals.put("jsonText", _jsontext);
 BA.debugLineNum = 337;BA.debugLine="Sub ParseFlashcard (jsonText As String)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 338;BA.debugLine="Dim tappedDeck As Map = FlashcardActivity.deck.Ge";
Debug.ShouldStop(131072);
_tappeddeck = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_tappeddeck = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), card_module.mostCurrent._flashcardactivity._deck /*RemoteObject*/ .runMethod(false,"Get",(Object)((card_module.mostCurrent._flashcardactivity._selecteddeck /*RemoteObject*/ ))));Debug.locals.put("tappedDeck", _tappeddeck);Debug.locals.put("tappedDeck", _tappeddeck);
 BA.debugLineNum = 339;BA.debugLine="Dim subdeckcards As List = tappedDeck.Get(Subdeck";
Debug.ShouldStop(262144);
_subdeckcards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_subdeckcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _tappeddeck.runMethod(false,"Get",(Object)((card_module.mostCurrent._subdeck_module._selectedsubdeck /*RemoteObject*/ ))));Debug.locals.put("subdeckcards", _subdeckcards);Debug.locals.put("subdeckcards", _subdeckcards);
 BA.debugLineNum = 341;BA.debugLine="Try";
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 343;BA.debugLine="Dim jp As JSONParser";
Debug.ShouldStop(4194304);
_jp = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.JSONParser");Debug.locals.put("jp", _jp);
 BA.debugLineNum = 344;BA.debugLine="jp.Initialize(jsonText)";
Debug.ShouldStop(8388608);
_jp.runVoidMethod ("Initialize",(Object)(_jsontext));
 BA.debugLineNum = 346;BA.debugLine="Dim root As Map = jp.NextObject";
Debug.ShouldStop(33554432);
_root = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_root = _jp.runMethod(false,"NextObject");Debug.locals.put("root", _root);Debug.locals.put("root", _root);
 BA.debugLineNum = 348;BA.debugLine="Dim flashcards As List = root.Get(\"flashcards\")";
Debug.ShouldStop(134217728);
...
_flashcards = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _root.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("flashcards")))));Debug.locals.put("flashcards", _flashcards);Debug.locals.put("flashcards", _flashcards);
 BA.debugLineNum = 350;BA.debugLine="For Each card As Map In flashcards";
Debug.ShouldStop(536870912);
...
Debug.locals.put("card", _card);
 BA.debugLineNum = 352;BA.debugLine="Dim cards As Map";
Debug.ShouldStop(-2147483648);
_cards = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("cards", _cards);
 BA.debugLineNum = 353;BA.debugLine="cards.Initialize";
Debug.ShouldStop(1);
_cards.runVoidMethod ("Initialize");
 BA.debugLineNum = 355;BA.debugLine="Dim question As String = card.Get(\"question\")";
Debug.ShouldStop(4);
_question = BA.ObjectToString(_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("question")))));Debug.locals.put("question", _question);Debug.locals.put("question", _question);
 BA.debugLineNum = 357;BA.debugLine="Dim answer As String = card.Get(\"answer\")";
Debug.ShouldStop(16);
_answer = BA.ObjectToString(_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("answer")))));Debug.locals.put("answer", _answer);Debug.locals.put("answer", _answer);
 BA.debugLineNum = 359;BA.debugLine="cards.Put(\"Q\", question)";
Debug.ShouldStop(64);
_cards.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("Q"))),(Object)((_question)));
 BA.debugLineNum = 360;BA.debugLine="cards.Put(\"A\", answer)";
Debug.ShouldStop(128);
_cards.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("A"))),(Object)((_answer)));
 BA.debugLineNum = 361;BA.debugLine="subdeckcards.Add(cards)";
Debug.ShouldStop(256);
_subdeckcards.runVoidMethod ("Add",(Object)((_cards.getObject())));
 BA.debugLineNum = 363;BA.debugLine="Log(\"===================\")";
Debug.ShouldStop(1024);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329687834",RemoteObject.createImmutable("==================="),0);
 BA.debugLineNum = 364;BA.debugLine="Log(\"QUESTION: \" & question)";
Debug.ShouldStop(2048);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329687835",RemoteObject.concat(RemoteObject.createImmutable("QUESTION: "),_question),0);
 BA.debugLineNum = 365;BA.debugLine="Log(\"ANSWER: \" & answer)";
Debug.ShouldStop(4096);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329687836",RemoteObject.concat(RemoteObject.createImmutable("ANSWER: "),_answer),0);
 }
}Debug.locals.put("card", _card);
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",card_module.processBA, e21.toString()); BA.debugLineNum = 371;BA.debugLine="Log(\"INVALID JSON\")";
Debug.ShouldStop(262144);
card_module.mostCurrent.__c.runVoidMethod ("LogImpl","329687842",RemoteObject.createImmutable("INVALID JSON"),0);
 };
...
try {
		Debug.PushSubsStack("ShowSubdeckCards (card_module) ","card_module",23,card_module.mostCurrent.activityBA,card_module.mostCurrent,63);
...
Debug.locals.put("cardsList", _cardslist);
 BA.debugLineNum = 63;BA.debugLine="Sub ShowSubdeckCards(cardsList As List)";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 65;BA.debugLine="ScrollView1.Panel.RemoveAllViews";
Debug.ShouldStop(1);
card_module.mostCurrent._scrollview1.runMethod(false,"getPanel").runVoidMethod ("RemoveAllViews");
 BA.debugLineNum = 67;BA.debugLine="Dim topPos As Int = 0";
Debug.ShouldStop(4);
_toppos = BA.numberCast(int.class, 0);Debug.locals.put("topPos", _toppos);Debug.locals.put("topPos", _toppos);
 BA.debugLineNum = 68;BA.debugLine="Dim cardHeight As Int = 150dip 'height";
Debug.ShouldStop(8);
_cardheight = card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 150)));Debug.locals.put("cardHeight", _cardheight);Debug.locals.put("cardHeight", _cardheight);
 BA.debugLineNum = 70;BA.debugLine="For i = 0 To cardsList.Size -1";
Debug.ShouldStop(32);
{
final int step4 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 71;BA.debugLine="Dim card As Map = cardsList.Get(i)";
Debug.ShouldStop(64);
_card = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
...
_p.runVoidMethod ("Initialize",card_module.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 74;BA.debugLine="If Starter.darkMode = False Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",card_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,card_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 75;BA.debugLine="p.Color = Colors.White";
Debug.ShouldStop(1024);
_p.runVoidMethod ("setColor",card_module.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 }else {
 BA.debugLineNum = 77;BA.debugLine="p.Color = Colors.Black";
Debug.ShouldStop(4096);
_p.runVoidMethod ("setColor",card_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 };
 BA.debugLineNum = 79;BA.debugLine="ScrollView1.Panel.AddView(p, 10dip, topPos, Scro";
Debug.ShouldStop(16384);
...
_lbl.runVoidMethod ("Initialize",card_module.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 83;BA.debugLine="lbl.Text = \"Q: \" & card.Get(\"Q\") & CRLF & \"A: \"";
Debug.ShouldStop(262144);
_lbl.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(RemoteObject.createImmutable("Q: "),_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Q")))),card_module.mostCurrent.__c.getField(true,"CRLF"),RemoteObject.createImmutable("A: "),_card.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("A")))))));
 BA.debugLineNum = 84;BA.debugLine="If Starter.darkMode = False Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",card_module.mostCurrent._starter._darkmode /*RemoteObject*/ ,card_module.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 85;BA.debugLine="lbl.TextColor = Colors.black";
Debug.ShouldStop(1048576);
_lbl.runMethod(true,"setTextColor",card_module.mostCurrent.__c.getField(false,"Colors").getField(true,"Black"));
 }else {
 BA.debugLineNum = 87;BA.debugLine="lbl.TextColor = Colors.White";
Debug.ShouldStop(4194304);
_lbl.runMethod(true,"setTextColor",card_module.mostCurrent.__c.getField(false,"Colors").getField(true,"White"));
 };
 BA.debugLineNum = 89;BA.debugLine="lbl.TextSize = 12";
Debug.ShouldStop(16777216);
_lbl.runMethod(true,"setTextSize",BA.numberCast(float.class, 12));
 BA.debugLineNum = 90;BA.debugLine="lbl.SingleLine = False";
Debug.ShouldStop(33554432);
_lbl.runVoidMethod ("setSingleLine",card_module.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 92;BA.debugLine="p.AddView(lbl, 10dip, 10dip, ScrollView1.Width -";
Debug.ShouldStop(134217728);
_p.runVoidMethod ("AddView",(Object)((_lbl.getObject())),(Object)(card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))),(Object)(card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))),(Object)(RemoteObject.solve(new RemoteObject[] {card_module.mostCurrent._scrollview1.runMethod(true,"getWidth"),card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 20)))}, "-",1, 1)),(Object)(card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))));
 BA.debugLineNum = 93;BA.debugLine="topPos = topPos + lbl.height + 10dip";
Debug.ShouldStop(268435456);
_toppos = RemoteObject.solve(new RemoteObject[] {_toppos,_lbl.runMethod(true,"getHeight"),card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "++",2, 1);Debug.locals.put("topPos", _toppos);
 BA.debugLineNum = 95;BA.debugLine="Dim btnwidth As Int = 100dip";
Debug.ShouldStop(1073741824);
...
_p.runVoidMethod ("AddView",(Object)((_deletebtn.getObject())),(Object)(card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 200)))),(Object)(card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 100)))),(Object)(_btnwidth),(Object)(card_module.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 40)))));
 BA.debugLineNum = 108;BA.debugLine="topPos = topPos + cardHeight + 10dip";
Debug.ShouldStop(2048);
...
;
 BA.debugLineNum = 110;BA.debugLine="ScrollView1.Panel.Height = topPos + 10dip";
Debug.ShouldStop(8192);
