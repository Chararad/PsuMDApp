...
public static RemoteObject _pixeltf = RemoteObject.declareNull("anywheresoftware.b4a.keywords.constants.TypefaceWrapper");
public static RemoteObject _tabhost1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.TabHostWrapper");
public static RemoteObject _grouplist = RemoteObject.declareNull("b4a.example3.customlistview");
public static RemoteObject _addtitletextareagrp = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _listslistgrp = RemoteObject.declareNull("b4a.example3.customlistview");
public static RemoteObject _newgroupbtn = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _newlistbtngrp = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _progressbargrp = RemoteObject.declareNull("anywheresoftware.b4a.objects.ProgressBarWrapper");
public static RemoteObject _progressnumbergrp = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _progresspercentgrp = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _taskslistgrp = RemoteObject.declareNull("b4a.example3.customlistview");
public static RemoteObject _groupet = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _currentgrplistname = RemoteObject.createImmutable("");
...
public static b4a.example.leaderboard _leaderboard = null;
...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"active_recall",Debug.moduleToString(b4a.example.active_recall.class),"Activity",todoactivity.mostCurrent._activity,"Add_card_module",Debug.moduleToString(b4a.example.add_card_module.class),"add_card_module2",Debug.moduleToString(b4a.example.add_card_module2.class),"add_events_module",Debug.moduleToString(b4a.example.add_events_module.class),"addTaskBtn",todoactivity.mostCurrent._addtaskbtn,"addTaskBtnPNL",todoactivity.mostCurrent._addtaskbtnpnl,"addTaskPanel",todoactivity.mostCurrent._addtaskpanel,"addTaskTextArea",todoactivity.mostCurrent._addtasktextarea,"addTitleTextArea",todoactivity.mostCurrent._addtitletextarea,"addTitleTextAreaGrp",todoactivity.mostCurrent._addtitletextareagrp,"all_active_recall",Debug.moduleToString(b4a.example.all_active_recall.class),"CalendarActivity",Debug.moduleToString(b4a.example.calendaractivity.class),"Card_Module",Debug.moduleToString(b4a.example.card_module.class),"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"currentGrpListName",todoactivity.mostCurrent._currentgrplistname,"currentList",todoactivity.mostCurrent._currentlist,"day_module",Debug.moduleToString(b4a.example.day_module.class),"deck_all_cards",Debug.moduleToString(b4a.example.deck_all_cards.class),"editnote",Debug.moduleToString(b4a.example.editnote.class),"enterTaskBtn",todoactivity.mostCurrent._entertaskbtn,"FlashcardActivity",Debug.moduleToString(b4a.example.flashcardactivity.class),"groupET",todoactivity.mostCurrent._groupet,"groupList",todoactivity.mostCurrent._grouplist,"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"Home_Activity",Debug.moduleToString(b4a.example.home_activity.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"isAddingList",todoactivity._isaddinglist,"kvs",todoactivity._kvs,"Leaderboard",Debug.moduleToString(b4a.example.leaderboard.class),"listsList",todoactivity.mostCurrent._listslist,"listsListGrp",todoactivity.mostCurrent._listslistgrp,"LogIn",Debug.moduleToString(b4a.example.login.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"musicActivity",Debug.moduleToString(b4a.example.musicactivity.class),"musicService",Debug.moduleToString(b4a.example.musicservice.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"newGroupBtn",todoactivity.mostCurrent._newgroupbtn,"newListBtn",todoactivity.mostCurrent._newlistbtn,"newListBtnGrp",todoactivity.mostCurrent._newlistbtngrp,"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"pixeltf",todoactivity.mostCurrent._pixeltf,"progressBar",todoactivity.mostCurrent._progressbar,"progressBarGrp",todoactivity.mostCurrent._progressbargrp,"progressNumber",todoactivity.mostCurrent._progressnumber,"progressNumberGrp",todoactivity.mostCurrent._progressnumbergrp,"progressPercent",todoactivity.mostCurrent._progresspercent,"progressPercentGrp",todoactivity.mostCurrent._progresspercentgrp,"Register",Debug.moduleToString(b4a.example.register.class),"Schedule_module",Debug.moduleToString(b4a.example.schedule_module.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Subdeck_Module",Debug.moduleToString(b4a.example.subdeck_module.class),"TabHost1",todoactivity.mostCurrent._tabhost1,"tasksList",todoactivity.mostCurrent._taskslist,"tasksListGrp",todoactivity.mostCurrent._taskslistgrp,"themeActivity",Debug.moduleToString(b4a.example.themeactivity.class),"tutorialActivity",Debug.moduleToString(b4a.example.tutorialactivity.class),"untitledNo",todoactivity._untitledno,"xui",todoactivity._xui};
}
}