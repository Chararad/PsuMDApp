...
public static b4a.example.httputils2service _httputils2service = null;
  public Object[] GetGlobals() {
		return new Object[] {"active_recall",Debug.moduleToString(b4a.example.active_recall.class),"Activity",todoactivity.mostCurrent._activity,"Add_card_module",Debug.moduleToString(b4a.example.add_card_module.class),"add_card_module2",Debug.moduleToString(b4a.example.add_card_module2.class),"add_events_module",Debug.moduleToString(b4a.example.add_events_module.class),"addTaskBtn",todoactivity.mostCurrent._addtaskbtn,"addTaskBtnPNL",todoactivity.mostCurrent._addtaskbtnpnl,"addTaskPanel",todoactivity.mostCurrent._addtaskpanel,"addTaskTextArea",todoactivity.mostCurrent._addtasktextarea,"addTitleTextArea",todoactivity.mostCurrent._addtitletextarea,"all_active_recall",Debug.moduleToString(b4a.example.all_active_recall.class),"CalendarActivity",Debug.moduleToString(b4a.example.calendaractivity.class),"Card_Module",Debug.moduleToString(b4a.example.card_module.class),"clockActivity",Debug.moduleToString(b4a.example.clockactivity.class),"corkActivity",Debug.moduleToString(b4a.example.corkactivity.class),"currentList",todoactivity.mostCurrent._currentlist,"day_module",Debug.moduleToString(b4a.example.day_module.class),"deck_all_cards",Debug.moduleToString(b4a.example.deck_all_cards.class),"editnote",Debug.moduleToString(b4a.example.editnote.class),"enterTaskBtn",todoactivity.mostCurrent._entertaskbtn,"FlashcardActivity",Debug.moduleToString(b4a.example.flashcardactivity.class),"helpActivity",Debug.moduleToString(b4a.example.helpactivity.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"isAddingList",todoactivity._isaddinglist,"kvs",todoactivity._kvs,"listsList",todoactivity.mostCurrent._listslist,"Main",Debug.moduleToString(b4a.example.main.class),"MainActivity",Debug.moduleToString(b4a.example.mainactivity.class),"musicActivity",Debug.moduleToString(b4a.example.musicactivity.class),"musicService",Debug.moduleToString(b4a.example.musicservice.class),"navActivity",Debug.moduleToString(b4a.example.navactivity.class),"newListBtn",todoactivity.mostCurrent._newlistbtn,"noteActivity",Debug.moduleToString(b4a.example.noteactivity.class),"pixeltf",todoactivity.mostCurrent._pixeltf,"progressBar",todoactivity.mostCurrent._progressbar,"progressNumber",todoactivity.mostCurrent._progressnumber,"progressPercent",todoactivity.mostCurrent._progresspercent,"Schedule_module",Debug.moduleToString(b4a.example.schedule_module.class),"Starter",Debug.moduleToString(b4a.example.starter.class),"Subdeck_Module",Debug.moduleToString(b4a.example.subdeck_module.class),"tasksList",todoactivity.mostCurrent._taskslist,"themeActivity",Debug.moduleToString(b4a.example.themeactivity.class),"untitledNo",todoactivity._untitledno,"xui",todoactivity._xui};
}
}