...
try {
		Debug.PushSubsStack("Activity_Create (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,55);
...
try {
		Debug.PushSubsStack("addTaskBtn_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,389);
...
try {
		Debug.PushSubsStack("addTaskBtnGrp_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1341);
...
try {
		Debug.PushSubsStack("addTitleTextArea_EnterPressed (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,177);
...
try {
		Debug.PushSubsStack("deleteGroup (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1027);
...
try {
		Debug.PushSubsStack("enterTaskBtn_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,460);
...
try {
		Debug.PushSubsStack("enterTaskBtnGrp_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1383);
...
try {
		Debug.PushSubsStack("generateGroupCode (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,857);
...
try {
		Debug.PushSubsStack("getCurrentGrpList (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1606);
...
try {
		Debug.PushSubsStack("groupET_EnterPressed (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,805);
...
try {
		Debug.PushSubsStack("groupList_ItemClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,945);
...
try {
		Debug.PushSubsStack("groupList_ItemLongClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,973);
...
try {
		Debug.PushSubsStack("isCodeUnique (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,866);
...
try {
		Debug.PushSubsStack("joinBtn_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,904);
...
try {
		Debug.PushSubsStack("listsList_ItemClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,304);
...
try {
		Debug.PushSubsStack("listsList_ItemLongClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,332);
...
try {
		Debug.PushSubsStack("listsListGrp_ItemClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1126);
...
try {
		Debug.PushSubsStack("listsListGrp_ItemLongClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1146);
...
try {
		Debug.PushSubsStack("loadMyGroups (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,752);
...
try {
		Debug.PushSubsStack("newAddTaskBtn (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,101);
...
try {
		Debug.PushSubsStack("newAddTaskBtnGrp (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1315);
...
try {
		Debug.PushSubsStack("newGroupBtn_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,783);
...
try {
		Debug.PushSubsStack("newListBtn_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,153);
...
try {
		Debug.PushSubsStack("newListBtnGrp_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1057);
...
try {
		Debug.PushSubsStack("newListConfirmBtnGrp_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1093);
...
try {
		Debug.PushSubsStack("renameListBtnGrp_Click (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1259);
...
try {
		Debug.PushSubsStack("showCreateGroupPanel (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,796);
...
try {
		Debug.PushSubsStack("showJoinGroupPanel (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,875);
...
try {
		Debug.PushSubsStack("showRenameGroupPanel (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1013);
...
try {
		Debug.PushSubsStack("showRenameListPanel (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,374);
...
try {
		Debug.PushSubsStack("showRenameListPanelGrp (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1226);
...
try {
		Debug.PushSubsStack("showRenameTaskPanel (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,561);
...
try {
		Debug.PushSubsStack("showRenameTaskPanelGrp (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1472);
...
try {
		Debug.PushSubsStack("taskCheckbox_CheckedChange (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,635);
...
try {
		Debug.PushSubsStack("taskCheckboxGrp_CheckedChange (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1550);
...
try {
		Debug.PushSubsStack("tasksList_ItemLongClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,538);
...
try {
		Debug.PushSubsStack("tasksListGrp_ItemLongClick (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1446);
...
try {
		Debug.PushSubsStack("tasksListGrpUI (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1507);
...
try {
		Debug.PushSubsStack("tasksListUI (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,661);
...
try {
		Debug.PushSubsStack("updateProgress (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,706);
...
try {
		Debug.PushSubsStack("updateProgressGrp (todoactivity) ","todoactivity",3,todoactivity.mostCurrent.activityBA,todoactivity.mostCurrent,1572);
