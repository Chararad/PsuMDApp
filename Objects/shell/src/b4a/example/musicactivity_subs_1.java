...
public class musicactivity_subs_1 {
...
try {
		Debug.PushSubsStack("Activity_Pause (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,63);
...
try {
		Debug.PushSubsStack("Activity_Resume (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,59);
...
try {
		Debug.PushSubsStack("formatSongDur (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,67);
...
try {
		Debug.PushSubsStack("ListView1_ItemClick (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,113);
...
try {
		Debug.PushSubsStack("nextBtn_Click (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,101);
...
try {
		Debug.PushSubsStack("pauseBtn_Click (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,109);
...
try {
		Debug.PushSubsStack("prevBtn_Click (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,105);
...
try {
		Debug.PushSubsStack("SeekBar1_ValueChanged (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,95);
...
try {
		Debug.PushSubsStack("uiTimer_Tick (musicactivity) ","musicactivity",20,musicactivity.mostCurrent.activityBA,musicactivity.mostCurrent,75);
