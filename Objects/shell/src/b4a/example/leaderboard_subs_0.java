...
try {
		Debug.PushSubsStack("Activity_Create (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,45);
...
leaderboard.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("leaderboard")),leaderboard.mostCurrent.activityBA);
 ...
 BA.debugLineNum = 51;BA.debugLine="Activity.LoadLayout(\"leaderboarddark\")";
Debug.ShouldStop(262144);
leaderboard.mostCurrent._activity.runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("leaderboarddark")),leaderboard.mostCurrent.activityBA);
 };
 break; }
case 1: {
...
try {
		Debug.PushSubsStack("Activity_Pause (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,79);
...
try {
		Debug.PushSubsStack("Activity_Resume (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,76);
...
try {
		Debug.PushSubsStack("AddUserScore (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,154);
...
try {
		Debug.PushSubsStack("AddUserToMode (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,146);
...
try {
		Debug.PushSubsStack("btnAllTime_Click (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,330);
...
try {
		Debug.PushSubsStack("btnDaily_Click (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,322);
...
try {
		Debug.PushSubsStack("btnInsert_Click (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,334);
...
RemoteObject _correctrate = RemoteObject.createImmutable(0);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 356;BA.debugLine="Dim correctRate As Int = Min(Min((xp * 0.05), 80)";
Debug.ShouldStop(8);
_correctrate = BA.numberCast(int.class, leaderboard.mostCurrent.__c.runMethod(true,"Min",(Object)(RemoteObject.solve(new RemoteObject[] {leaderboard.mostCurrent.__c.runMethod(true,"Min",(Object)((RemoteObject.solve(new RemoteObject[] {_xp,RemoteObject.createImmutable(0.05)}, "*",0, 0))),(Object)(BA.numberCast(double.class, 80))),(RemoteObject.solve(new RemoteObject[] {_st,RemoteObject.createImmutable(0.5)}, "*",0, 0))}, "+",1, 0)),(Object)(BA.numberCast(double.class, 100))));Debug.locals.put("correctRate", _correctrate);Debug.locals.put("correctRate", _correctrate);
 BA.debugLineNum = 357;BA.debugLine="AddUserScore(CurrentMode, n, xp, st, correctRate)";
Debug.ShouldStop(16);
_adduserscore(leaderboard.mostCurrent._currentmode,_n,_xp,_st,_correctrate);
...
try {
		Debug.PushSubsStack("btnWeekly_Click (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,326);
...
try {
		Debug.PushSubsStack("CreateUser (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,135);
...
try {
		Debug.PushSubsStack("EnsureSeedData (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,170);
...
try {
		Debug.PushSubsStack("GetModeList (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,193);
...
try {
		Debug.PushSubsStack("InitDB (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,159);
...
try {
		Debug.PushSubsStack("InsertUserToDB (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,175);
...
try {
		Debug.PushSubsStack("LoadBoardFromDB (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,180);
...
try {
		Debug.PushSubsStack("SetupInsertControls (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,82);
...
try {
		Debug.PushSubsStack("SetupMockData (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,112);
...
Debug.ShouldStop(32768);
 BA.debugLineNum = 114;BA.debugLine="InsertUserToDB(\"DAILY\", \"Mika\", 320, 7, 57)";
Debug.ShouldStop(131072);
_insertusertodb(BA.ObjectToString("DAILY"),BA.ObjectToString("Mika"),BA.numberCast(int.class, 320),BA.numberCast(int.class, 7),BA.numberCast(int.class, 57));
 BA.debugLineNum = 115;BA.debugLine="InsertUserToDB(\"DAILY\", \"Rei\", 295, 5, 55)";
Debug.ShouldStop(262144);
_insertusertodb(BA.ObjectToString("DAILY"),BA.ObjectToString("Rei"),BA.numberCast(int.class, 295),BA.numberCast(int.class, 5),BA.numberCast(int.class, 55));
 BA.debugLineNum = 116;BA.debugLine="InsertUserToDB(\"DAILY\", \"Noah\", 280, 4, 54)";
Debug.ShouldStop(524288);
_insertusertodb(BA.ObjectToString("DAILY"),BA.ObjectToString("Noah"),BA.numberCast(int.class, 280),BA.numberCast(int.class, 4),BA.numberCast(int.class, 54));
 BA.debugLineNum = 117;BA.debugLine="InsertUserToDB(\"DAILY\", \"Ava\", 250, 3, 49)";
Debug.ShouldStop(1048576);
_insertusertodb(BA.ObjectToString("DAILY"),BA.ObjectToString("Ava"),BA.numberCast(int.class, 250),BA.numberCast(int.class, 3),BA.numberCast(int.class, 49));
 BA.debugLineNum = 118;BA.debugLine="InsertUserToDB(\"DAILY\", \"Luna\", 220, 2, 47)";
Debug.ShouldStop(2097152);
_insertusertodb(BA.ObjectToString("DAILY"),BA.ObjectToString("Luna"),BA.numberCast(int.class, 220),BA.numberCast(int.class, 2),BA.numberCast(int.class, 47));
 BA.debugLineNum = 121;BA.debugLine="InsertUserToDB(\"WEEKLY\", \"Mika\", 1760, 19, 76)";
Debug.ShouldStop(16777216);
_insertusertodb(BA.ObjectToString("WEEKLY"),BA.ObjectToString("Mika"),BA.numberCast(int.class, 1760),BA.numberCast(int.class, 19),BA.numberCast(int.class, 76));
 BA.debugLineNum = 122;BA.debugLine="InsertUserToDB(\"WEEKLY\", \"Ava\", 1690, 13, 74)";
Debug.ShouldStop(33554432);
_insertusertodb(BA.ObjectToString("WEEKLY"),BA.ObjectToString("Ava"),BA.numberCast(int.class, 1690),BA.numberCast(int.class, 13),BA.numberCast(int.class, 74));
 BA.debugLineNum = 123;BA.debugLine="InsertUserToDB(\"WEEKLY\", \"Rei\", 1610, 11, 71)";
Debug.ShouldStop(67108864);
_insertusertodb(BA.ObjectToString("WEEKLY"),BA.ObjectToString("Rei"),BA.numberCast(int.class, 1610),BA.numberCast(int.class, 11),BA.numberCast(int.class, 71));
 BA.debugLineNum = 124;BA.debugLine="InsertUserToDB(\"WEEKLY\", \"Noah\", 1495, 9, 67)";
Debug.ShouldStop(134217728);
_insertusertodb(BA.ObjectToString("WEEKLY"),BA.ObjectToString("Noah"),BA.numberCast(int.class, 1495),BA.numberCast(int.class, 9),BA.numberCast(int.class, 67));
 BA.debugLineNum = 125;BA.debugLine="InsertUserToDB(\"WEEKLY\", \"Luna\", 1420, 8, 66)";
Debug.ShouldStop(268435456);
_insertusertodb(BA.ObjectToString("WEEKLY"),BA.ObjectToString("Luna"),BA.numberCast(int.class, 1420),BA.numberCast(int.class, 8),BA.numberCast(int.class, 66));
 BA.debugLineNum = 128;BA.debugLine="InsertUserToDB(\"ALLTIME\", \"Ava\", 12850, 41, 94)";
Debug.ShouldStop(-2147483648);
_insertusertodb(BA.ObjectToString("ALLTIME"),BA.ObjectToString("Ava"),BA.numberCast(int.class, 12850),BA.numberCast(int.class, 41),BA.numberCast(int.class, 94));
 BA.debugLineNum = 129;BA.debugLine="InsertUserToDB(\"ALLTIME\", \"Mika\", 12110, 37, 90)";
Debug.ShouldStop(1);
_insertusertodb(BA.ObjectToString("ALLTIME"),BA.ObjectToString("Mika"),BA.numberCast(int.class, 12110),BA.numberCast(int.class, 37),BA.numberCast(int.class, 90));
 BA.debugLineNum = 130;BA.debugLine="InsertUserToDB(\"ALLTIME\", \"Noah\", 11680, 29, 86)";
Debug.ShouldStop(2);
_insertusertodb(BA.ObjectToString("ALLTIME"),BA.ObjectToString("Noah"),BA.numberCast(int.class, 11680),BA.numberCast(int.class, 29),BA.numberCast(int.class, 86));
 BA.debugLineNum = 131;BA.debugLine="InsertUserToDB(\"ALLTIME\", \"Rei\", 11300, 24, 83)";
Debug.ShouldStop(4);
_insertusertodb(BA.ObjectToString("ALLTIME"),BA.ObjectToString("Rei"),BA.numberCast(int.class, 11300),BA.numberCast(int.class, 24),BA.numberCast(int.class, 83));
 BA.debugLineNum = 132;BA.debugLine="InsertUserToDB(\"ALLTIME\", \"Luna\", 10950, 22, 81)";
Debug.ShouldStop(8);
_insertusertodb(BA.ObjectToString("ALLTIME"),BA.ObjectToString("Luna"),BA.numberCast(int.class, 10950),BA.numberCast(int.class, 22),BA.numberCast(int.class, 81));
...
try {
		Debug.PushSubsStack("ShouldSwapForRanking (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,217);
...
try {
		Debug.PushSubsStack("ShowBoard (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,224);
...
try {
		Debug.PushSubsStack("SortBoard (leaderboard) ","leaderboard",6,leaderboard.mostCurrent.activityBA,leaderboard.mostCurrent,204);
