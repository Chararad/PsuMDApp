...
try {
		Debug.PushSubsStack("Activity_Create (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,29);
...
try {
		Debug.PushSubsStack("Activity_Pause (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,102);
...
try {
		Debug.PushSubsStack("Activity_Resume (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,98);
...
try {
		Debug.PushSubsStack("backbtn_Click (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,148);
...
try {
		Debug.PushSubsStack("goback_Click (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,143);
...
try {
		Debug.PushSubsStack("nextbtn_Click (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,126);
...
try {
		Debug.PushSubsStack("showAnswerbtn_Click (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,107);
...
try {
		Debug.PushSubsStack("ShowCard (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,88);
...
try {
		Debug.PushSubsStack("ShowProgress (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,69);
...
try {
		Debug.PushSubsStack("ShuffleCards (active_recall) ","active_recall",12,active_recall.mostCurrent.activityBA,active_recall.mostCurrent,77);
