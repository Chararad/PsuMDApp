...
try {
		Debug.PushSubsStack("Activity_Create (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,53);
...
_cd.runVoidMethod ("Initialize",(Object)(day_module.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 125)),(Object)(BA.numberCast(int.class, 98)),(Object)(BA.numberCast(int.class, 43)),(Object)(BA.numberCast(int.class, 20)))),(Object)(BA.numberCast(int.class, 200)));
 BA.debugLineNum = 62;BA.debugLine="Day_btn.Background = cd";
Debug.ShouldStop(536870912);
day_module.mostCurrent._day_btn.runMethod(false,"setBackground",(_cd.getObject()));
...
Debug.ShouldStop(2);
_cd.runVoidMethod ("Initialize",(Object)(day_module.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(BA.numberCast(int.class, 125)),(Object)(BA.numberCast(int.class, 59)),(Object)(BA.numberCast(int.class, 117)),(Object)(BA.numberCast(int.class, 151)))),(Object)(BA.numberCast(int.class, 200)));
...
_bd.runVoidMethod ("Initialize",(Object)((day_module.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(day_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("Skeumorphic Pink .png"))).getObject())));
...
_bd.runVoidMethod ("Initialize",(Object)((day_module.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(day_module.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("pink Skeumorphic Button DARK.png"))).getObject())));
...
Debug.ShouldStop(32768);
day_module.mostCurrent.__c.runVoidMethod ("LogImpl","121168187",day_module._currentdate,0);
...
try {
		Debug.PushSubsStack("Activity_Pause (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,465);
...
try {
		Debug.PushSubsStack("Activity_Resume (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,457);
...
try {
		Debug.PushSubsStack("Addevent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,488);
...
try {
		Debug.PushSubsStack("addnew_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,494);
...
try {
		Debug.PushSubsStack("Addtask_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,505);
...
try {
		Debug.PushSubsStack("birthday_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,511);
...
try {
		Debug.PushSubsStack("birthdayrb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,616);
...
try {
		Debug.PushSubsStack("cancelDelete_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,565);
...
try {
		Debug.PushSubsStack("cancelEdit_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,538);
...
try {
		Debug.PushSubsStack("cancelTLdelete_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,588);
...
try {
		Debug.PushSubsStack("confirmdelete_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,569);
...
try {
		Debug.PushSubsStack("Day_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,479);
...
try {
		Debug.PushSubsStack("DeleteEvent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,534);
...
try {
		Debug.PushSubsStack("deleteTLconfirm_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,592);
...
try {
		Debug.PushSubsStack("deleteTLevent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,584);
...
try {
		Debug.PushSubsStack("DrawHourLabels (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,193);
...
try {
		Debug.PushSubsStack("DrawMainEvents (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,130);
...
try {
		Debug.PushSubsStack("DrawTimelineEvents (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,260);
...
try {
		Debug.PushSubsStack("editeventinfo_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,523);
...
try {
		Debug.PushSubsStack("eventrb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,620);
...
try {
		Debug.PushSubsStack("GetTimeString (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,235);
...
{ BA.debugLineNum = 241;BA.debugLine="Else if h = 12 Then";
Debug.ShouldStop(65536);
...
{ BA.debugLineNum = 244;BA.debugLine="Else if h > 12 Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean(">",_h,BA.numberCast(double.class, 12))) { 
...
try {
		Debug.PushSubsStack("hour_click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,321);
...
try {
		Debug.PushSubsStack("IdentifyColor (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,173);
...
{ BA.debugLineNum = 177;BA.debugLine="Else if typeofevent = \"Event\" Then";
Debug.ShouldStop(65536);
...
{ BA.debugLineNum = 179;BA.debugLine="Else if typeofevent = \"Birthday\" Then";
Debug.ShouldStop(262144);
...
{ BA.debugLineNum = 181;BA.debugLine="Else if typeofevent = \"OOO\" Then";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("mainEvent_click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,157);
...
try {
		Debug.PushSubsStack("MapInitializer (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,352);
...
try {
		Debug.PushSubsStack("menu_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,470);
...
try {
		Debug.PushSubsStack("Month_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,483);
...
try {
		Debug.PushSubsStack("ooo_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,517);
...
try {
		Debug.PushSubsStack("ooorb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,612);
...
try {
		Debug.PushSubsStack("SaveCalendar (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,126);
...
try {
		Debug.PushSubsStack("saveEdit_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,542);
...
try {
		Debug.PushSubsStack("saveTL_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,370);
...
try {
		Debug.PushSubsStack("sched_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,474);
...
try {
		Debug.PushSubsStack("SetDate (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,418);
...
try {
		Debug.PushSubsStack("SetUpSpinners (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,116);
...
try {
		Debug.PushSubsStack("taskrb_CheckedChange (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,624);
...
try {
		Debug.PushSubsStack("timelineEvent_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,298);
...
try {
		Debug.PushSubsStack("UpdateTimeLine (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,187);
...
try {
		Debug.PushSubsStack("x_EventInfo_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,529);
...
try {
		Debug.PushSubsStack("x_TLevent_btn_Click (day_module) ","day_module",18,day_module.mostCurrent.activityBA,day_module.mostCurrent,579);
