...
try {
		Debug.PushSubsStack("Activity_Create (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,23);
...
try {
		Debug.PushSubsStack("Activity_Pause (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,53);
...
try {
		Debug.PushSubsStack("Activity_Resume (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,49);
...
try {
		Debug.PushSubsStack("applyBtn_Click (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,95);
...
try {
		Debug.PushSubsStack("backBtn_Click (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,85);
...
try {
		Debug.PushSubsStack("closeHelp_Click (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,91);
...
try {
		Debug.PushSubsStack("nextBtn_Click (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,79);
...
try {
		Debug.PushSubsStack("showThemePage (themeactivity) ","themeactivity",29,themeactivity.mostCurrent.activityBA,themeactivity.mostCurrent,57);
