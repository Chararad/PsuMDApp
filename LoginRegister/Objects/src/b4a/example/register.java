...
RDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="Activity.LoadLayout(\"Register_layout\")";
mostCurrent._activity.LoadLayout("Register_layout",mostCurrent.activityBA);
RDebugUtils.currentLine=1572868;
 //BA.debugLineNum = 1572868;BA.debugLine="txtpassword_regis.PasswordMode = True";
mostCurrent._txtpassword_regis.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=1572869;
 //BA.debugLineNum = 1572869;BA.debugLine="btneyes_regis.SetBackgroundImage(LoadBitmap(File.";
...
RDebugUtils.currentLine=2031616;
 //BA.debugLineNum = 2031616;BA.debugLine="Private Sub btnconfirm_pass_Click";
RDebugUtils.currentLine=2031617;
 //BA.debugLineNum = 2031617;BA.debugLine="btnconfirm_pass.Height = 30dip";
mostCurrent._btnconfirm_pass.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=2031618;
 //BA.debugLineNum = 2031618;BA.debugLine="btnconfirm_pass.Width = 30dip";
mostCurrent._btnconfirm_pass.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=2031620;
 //BA.debugLineNum = 2031620;BA.debugLine="If isPasswordHidden Then";
if (_ispasswordhidden) { 
RDebugUtils.currentLine=2031621;
 //BA.debugLineNum = 2031621;BA.debugLine="txtconfirm_password.PasswordMode = False";
mostCurrent._txtconfirm_password.setPasswordMode(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=2031622;
 //BA.debugLineNum = 2031622;BA.debugLine="btnconfirm_pass.SetBackgroundImage(LoadBitmap(Fi";
...
RDebugUtils.currentLine=2031623;
 //BA.debugLineNum = 2031623;BA.debugLine="isPasswordHidden = False";
_ispasswordhidden = anywheresoftware.b4a.keywords.Common.False;
 }else {
RDebugUtils.currentLine=2031626;
 //BA.debugLineNum = 2031626;BA.debugLine="txtconfirm_password.PasswordMode = True";
mostCurrent._txtconfirm_password.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=2031627;
 //BA.debugLineNum = 2031627;BA.debugLine="btnconfirm_pass.SetBackgroundImage(LoadBitmap(Fi";
...
RDebugUtils.currentLine=2031628;
 //BA.debugLineNum = 2031628;BA.debugLine="isPasswordHidden = True";
...
RDebugUtils.currentLine=1900544;
 //BA.debugLineNum = 1900544;BA.debugLine="Private Sub btneyes_regis_Click";
RDebugUtils.currentLine=1900545;
 //BA.debugLineNum = 1900545;BA.debugLine="btneyes_regis.Height = 30dip";
mostCurrent._btneyes_regis.setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=1900546;
 //BA.debugLineNum = 1900546;BA.debugLine="btneyes_regis.Width = 30dip";
mostCurrent._btneyes_regis.setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
RDebugUtils.currentLine=1900548;
 //BA.debugLineNum = 1900548;BA.debugLine="If isPasswordHidden Then";
if (_ispasswordhidden) { 
RDebugUtils.currentLine=1900549;
 //BA.debugLineNum = 1900549;BA.debugLine="txtpassword_regis.PasswordMode = False";
mostCurrent._txtpassword_regis.setPasswordMode(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=1900550;
 //BA.debugLineNum = 1900550;BA.debugLine="btneyes_regis.SetBackgroundImage(LoadBitmap(File";
...
RDebugUtils.currentLine=1900551;
 //BA.debugLineNum = 1900551;BA.debugLine="isPasswordHidden = False";
_ispasswordhidden = anywheresoftware.b4a.keywords.Common.False;
 }else {
RDebugUtils.currentLine=1900554;
 //BA.debugLineNum = 1900554;BA.debugLine="txtpassword_regis.PasswordMode = True";
mostCurrent._txtpassword_regis.setPasswordMode(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=1900555;
 //BA.debugLineNum = 1900555;BA.debugLine="btneyes_regis.SetBackgroundImage(LoadBitmap(File";
mostCurrent._btneyes_regis.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"close-eye.png").getObject()));
RDebugUtils.currentLine=1900556;
 //BA.debugLineNum = 1900556;BA.debugLine="isPasswordHidden = True";
_ispasswordhidden = anywheresoftware.b4a.keywords.Common.True;
 };
...
RDebugUtils.currentLine=1835009;
 //BA.debugLineNum = 1835009;BA.debugLine="StartActivity(LogIn)";
...
RDebugUtils.currentLine=1769472;
 //BA.debugLineNum = 1769472;BA.debugLine="Private Sub btnregister_Click";
RDebugUtils.currentLine=1769473;
 //BA.debugLineNum = 1769473;BA.debugLine="Dim email As String = txtemail.Text.Trim";
_email = mostCurrent._txtemail.getText().trim();
RDebugUtils.currentLine=1769474;
 //BA.debugLineNum = 1769474;BA.debugLine="Dim password As String = txtpassword_regis.Text.T";
_password = mostCurrent._txtpassword_regis.getText().trim();
RDebugUtils.currentLine=1769475;
 //BA.debugLineNum = 1769475;BA.debugLine="Dim name As String = txtname.Text.Trim";
_name = mostCurrent._txtname.getText().trim();
RDebugUtils.currentLine=1769476;
 //BA.debugLineNum = 1769476;BA.debugLine="Dim confirm As String = txtconfirm_password.Text.";
_confirm = mostCurrent._txtconfirm_password.getText().trim();
RDebugUtils.currentLine=1769478;
 //BA.debugLineNum = 1769478;BA.debugLine="If email = \"\" Or password = \"\" Or name = \"\" Or co";
if ((_email).equals("") || (_password).equals("") || (_name).equals("") || (_confirm).equals("")) { 
RDebugUtils.currentLine=1769479;
 //BA.debugLineNum = 1769479;BA.debugLine="ToastMessageShow(\"Please enter all fields\", Fals";
...
{RDebugUtils.currentLine=1769481;
 //BA.debugLineNum = 1769481;BA.debugLine="Else If email.EndsWith(\"@gmail.com\") = False Then";
if (_email.endsWith("@gmail.com")==anywheresoftware.b4a.keywords.Common.False) { 
RDebugUtils.currentLine=1769482;
 //BA.debugLineNum = 1769482;BA.debugLine="ToastMessageShow(\"Email must be a Gmail address\"";
...
{RDebugUtils.currentLine=1769484;
 //BA.debugLineNum = 1769484;BA.debugLine="Else If password.Length < 8 Then";
if (_password.length()<8) { 
RDebugUtils.currentLine=1769485;
 //BA.debugLineNum = 1769485;BA.debugLine="ToastMessageShow(\"Password must be at least 8 ch";
...
{RDebugUtils.currentLine=1769487;
 //BA.debugLineNum = 1769487;BA.debugLine="Else If password <> confirm Then";
if ((_password).equals(_confirm) == false) { 
RDebugUtils.currentLine=1769488;
 //BA.debugLineNum = 1769488;BA.debugLine="ToastMessageShow(\"Passwords do not match\", False";
...
RDebugUtils.currentLine=1769491;
 //BA.debugLineNum = 1769491;BA.debugLine="Try";
try {RDebugUtils.currentLine=1769492;
 //BA.debugLineNum = 1769492;BA.debugLine="Starter.SQL1.ExecNonQuery2(\"INSERT INTO users (";
...
RDebugUtils.currentLine=1769494;
 //BA.debugLineNum = 1769494;BA.debugLine="ToastMessageShow(\"Registration successful\", Fal";
...
RDebugUtils.currentLine=1769507;
 //BA.debugLineNum = 1769507;BA.debugLine="End Sub";
return "";
}
}