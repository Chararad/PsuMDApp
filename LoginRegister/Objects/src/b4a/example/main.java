...
vis = vis | (confirmed_entry.mostCurrent != null);
return vis;}
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, starter.class));
 ...
 {
            Activity __a = null;
            if (confirmed_entry.previousOne != null) {
				__a = confirmed_entry.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(confirmed_entry.mostCurrent == null ? null : confirmed_entry.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
RDebugUtils.currentLine=393216;
 //BA.debugLineNum = 393216;BA.debugLine="Private Sub btnCreateAcc_Click";
...
RDebugUtils.currentLine=327681;
 //BA.debugLineNum = 327681;BA.debugLine="StartActivity(LogIn)";
