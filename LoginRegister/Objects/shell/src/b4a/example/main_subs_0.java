...
try {
		Debug.PushSubsStack("btnCreateAcc_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,41);
if (RapidSub.canDelegate("btncreateacc_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btncreateacc_click");}
 BA.debugLineNum = 41;BA.debugLine="Private Sub btnCreateAcc_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 42;BA.debugLine="StartActivity(Register)";
...
if (RapidSub.canDelegate("btnlogin_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnlogin_click");}
 BA.debugLineNum = 37;BA.debugLine="Private Sub btnLogin_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="StartActivity(LogIn)";
Debug.ShouldStop(32);
...
confirmed_entry_subs_0._process_globals();
...
confirmed_entry.myClass = BA.getDeviceClass ("b4a.example.confirmed_entry");
