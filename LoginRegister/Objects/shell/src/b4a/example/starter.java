...
public static b4a.example.confirmed_entry _confirmed_entry = null;
  public Object[] GetGlobals() {
		return new Object[] {"Confirmed_entry",Debug.moduleToString(b4a.example.confirmed_entry.class),"LogIn",Debug.moduleToString(b4a.example.login.class),"Main",Debug.moduleToString(b4a.example.main.class),"Register",Debug.moduleToString(b4a.example.register.class),"Service",starter.mostCurrent._service,"SQL1",starter._sql1};
}
}