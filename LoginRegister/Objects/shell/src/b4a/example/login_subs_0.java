...
try {
		Debug.PushSubsStack("Activity_Create (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,21);
...
try {
		Debug.PushSubsStack("Activity_Pause (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,33);
...
try {
		Debug.PushSubsStack("Activity_Resume (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,29);
...
try {
		Debug.PushSubsStack("btnback_Click (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,80);
...
login.mostCurrent.__c.runVoidMethod ("StartActivity",login.processBA,(Object)((login.mostCurrent._main.getObject())));
...
try {
		Debug.PushSubsStack("btneyes_Click (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,64);
...
try {
		Debug.PushSubsStack("btnlogin_Click (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,38);
...
login.mostCurrent._txtpassword.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 54;BA.debugLine="StartActivity(Confirmed_entry)";
Debug.ShouldStop(2097152);
login.mostCurrent.__c.runVoidMethod ("StartActivity",login.processBA,(Object)((login.mostCurrent._confirmed_entry.getObject())));
 }else {
...
try {
		Debug.PushSubsStack("btnSignUp_Click (login) ","login",2,login.mostCurrent.activityBA,login.mostCurrent,84);
